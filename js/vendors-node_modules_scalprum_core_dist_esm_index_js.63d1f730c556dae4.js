...
var getSharedScope = function () {
    ...
    return __webpack_require__.S[SHARED_SCOPE_NAME];
};
...
var initialize = function (_a) {
    ...
    var pluginLoader = new _openshift_dynamic_plugin_sdk__WEBPACK_IMPORTED_MODULE_0__.PluginLoader(__assign({ sharedScope: getSharedScope(), getPluginEntryModule: function (_a) {
            var name = _a.name;
            return window[name];
        } }, pluginLoaderOptions));
            ...
            switch (_a.label) {
                ...
                case 3:
                    pendingInjection = new Promise(function (res, rej) { return __awaiter(_this, void 0, void 0, function () {
                        var headers, manifestPromise, response, error, resClone, _a, manifest, loadScripts, injectionScript, exposedModule, error_1;

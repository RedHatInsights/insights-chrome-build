...
var Table = function Table(_ref) {
    ...
    return _react2.default.createElement(
        ...
        (0, _extends3.default)({}, props, {
            className: (0, _classnames2.default)('pf-c-table', props.variant !== TableVariant.large && 'pf-m-compact', className),
    ...
    function RemediationWizard(props) {
                        ...
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                return Promise.all(issues.map(function (issue) {
                                    return api.getResolutions(issue.id).catch(function (e) {
                                        if (e.statusCode === 404) {
        ...
        _this.closeWizard = function (submitted) {
            ...
            if (submitted) {
                ...
                var issues = _this.state.open.data.issues.map(function (_ref4) {
                    var id = _ref4.id;
                    return {
                        id: id,
        ...
        _this.createRemediation = function (add, resolver) {
            ...
            return api.createRemediation({ name: name, add: add, auto_reboot: _this.state.autoRebootSwitch }, _this.state.open.basePath).then(function (_ref5) {
                var id = _ref5.id;
            ...
            return function (id, name, isNewSwitch) {
                deferred.resolve({
                    ...
                    getNotification: function getNotification() {
                        return createNotification(name, isNewSwitch);
                    }
                });
            };
        };
...
exports.getResolutions = getResolutions;
...
function getResolutions(id) {
    ...
    var uri = new _urijs2.default(API_BASE).segment('resolutions').segment(id).toString();
    return fetch(uri).then(json);
}
...
//# sourceMappingURL=/insightsbeta/static/chrome/js/Remediations.c32ae27f.map
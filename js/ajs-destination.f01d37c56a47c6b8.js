...
/* harmony import */ var _segment_analytics_core__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @segment/analytics-core */ "./node_modules/@segment/analytics-core/dist/esm/validation/helpers.js");
...
function ajsDestinations(settings, globalIntegrations, options, routingMiddleware, legacyIntegrationSources) {
    ...
    var installableIntegrations = new Set((0,tslib__WEBPACK_IMPORTED_MODULE_1__.__spreadArray)((0,tslib__WEBPACK_IMPORTED_MODULE_1__.__spreadArray)([], Object.keys(remoteIntegrationsConfig).filter(function (name) {
        ...
        return (0,_segment_analytics_core__WEBPACK_IMPORTED_MODULE_14__.isPlainObject)(remoteIntegrationsConfig[name]) ||
            (0,_segment_analytics_core__WEBPACK_IMPORTED_MODULE_14__.isPlainObject)(localIntegrationsConfig === null || localIntegrationsConfig === void 0 ? void 0 : localIntegrationsConfig[name]);
    }), true));

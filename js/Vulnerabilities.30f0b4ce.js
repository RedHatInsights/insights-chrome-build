        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactCore.Dropdown, (0, _extends3.default)({}, props, {
                ...
                toggle: _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactIcons.DownloadIcon, { size: _reactIcons.IconSize.lg })
                ),
                isOpen: isOpen,
                isPlain: true,
            ...
            data: data.map(function (row) {
                return {
                    ...
                    cells: [_react2.default.createElement(
                        ...
                        '...'
                    ), row.attributes.cvss3_score || row.attributes.cvss2_score && row.attributes.cvss2_score + ' (v2)' || 'N/A', new Date(row.attributes.public_date).toLocaleString()]
                };
            }),
            meta: meta,
            isLoading: isLoading
...
var header = [{ title: 'Impact', key: 'impact', width: 5 }, { title: 'Name', key: 'synopsis', width: 10 }, { title: 'Description', key: 'description', width: 60, hasSort: false }, { title: 'CVSS Base Score', key: 'cvss_score', width: 5 }, { title: 'Publish date', key: 'public_date', width: 10 }];
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_VulnerabilitiesCves2.default, {
                        ...
                        fetchResource: function fetchResource(params) {
                            return (0, _applications.fetchCveListBySystem)((0, _extends3.default)({}, params, { system: entity.insights_id }));
                        },
    ...
    function VulnerabilitiesCveTable() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = VulnerabilitiesCveTable.__proto__ || Object.getPrototypeOf(VulnerabilitiesCveTable)).call.apply(_ref, [this].concat(args))), _this), _this.handleRedirect = function (key) {
            if (location.href.indexOf('vulnerability') !== -1) {
                _this.props.history.push('/cves/' + key);
            } else {
        ...
        }, _this.sortColumn = function (key, direction) {
            var columnName = _this.props.header[key].key;
            if (direction === _Table.SortDirection.down) {
            ...
            if (value) {
                var direction = value[0] === '+' ? _Table.SortDirection.up : _Table.SortDirection.down;
                value = value.replace(/^(-|\+)/, '');
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'b',
                    null,
                    cves.meta.filter ? 'None of your systems are currently exposed to any CVE matching filter " ' + cves.meta.filter + '"' : 'You are not exposed to any CVEs.'
                )
            );
        }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Table.Table, {
                    header: header,
                    rows: cves.isLoading ? [].concat((0, _toConsumableArray3.default)(Array(3))).map(function () {
                        return {
                            cells: [{
                    ...
                    onRowClick: function onRowClick(_event, key) {
                        return _this2.handleRedirect(key);
                    },
                    sortBy: this.createSortBy(cves.meta.sort),
                    onSort: function onSort(_event, colKey, direction) {
                        return _this2.sortColumn(colKey, direction);
                    }
                }),
    ...
    (0, _createClass3.default)(VulnerabilitiesCveTableToolbar, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactCore.Toolbar,
                    { className: 'cvetable-toolbar ' },
                    _react2.default.createElement(
                        _reactCore.ToolbarGroup,
                        { className: 'filterCVES space-between-toolbar-items' },
                        _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        CVSSOptions.map(function (option, index) {
                                            return _react2.default.createElement(_reactCore.SelectOption, {
                    ...
                    _react2.default.createElement(
                        _reactCore.ToolbarGroup,
                        { className: 'space-between-toolbar-items' },
                        _react2.default.createElement(
                            _reactCore.ToolbarItem,
                            null,
...
var VulnerabilitiesCves = function (_Component) {
    ...
    function VulnerabilitiesCves() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = VulnerabilitiesCves.__proto__ || Object.getPrototypeOf(VulnerabilitiesCves)).call.apply(_ref, [this].concat(args))), _this), _this.apply = function (config) {
...
},{"@patternfly/react-icons":"k73M","classnames":"kpqe","react-router-dom":"dYXq","patternfly-react":"OgYW","react-redux":"oeDu","react":"ccIB","@patternfly/react-core":"Tk4w","buffer":"8fe9"}]},{},[], null)
//# sourceMappingURL=/insightsbeta/static/chrome/js/Vulnerabilities.30f0b4ce.map
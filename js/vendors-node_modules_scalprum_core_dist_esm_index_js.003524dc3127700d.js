...
var initialize = function (_a) {
    ...
    var pluginStore = new _openshift_dynamic_plugin_sdk__WEBPACK_IMPORTED_MODULE_0__.PluginStore(__assign(__assign({}, pluginStoreOptions), { loaderOptions: __assign({ sharedScope: getSharedScope(defaultOptions.enableScopeWarning), getPluginEntryModule: function (_a) {
                var name = _a.name;
                return window[name];
            } }, pluginLoaderOptions) }));

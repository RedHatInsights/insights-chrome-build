(self["webpackChunkinsights_chrome"] = self["webpackChunkinsights_chrome"] || []).push([["vendors-node_modules_openshift_dynamic-plugin-sdk_dist_index_esm_js"],{

/***/ "./node_modules/@openshift/dynamic-plugin-sdk/dist/index.esm.js":
/*!**********************************************************************!*\
  !*** ./node_modules/@openshift/dynamic-plugin-sdk/dist/index.esm.js ***!
  \**********************************************************************/
...
/* harmony import */ var lodash_forOwn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/forOwn */ "./node_modules/lodash/forOwn.js");
...
/* harmony import */ var semver__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! semver */ "./node_modules/@openshift/dynamic-plugin-sdk/node_modules/semver/index.js");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?dc4e");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var lodash_isEqualWith__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! lodash/isEqualWith */ "./node_modules/lodash/isEqualWith.js");
/* harmony import */ var lodash_isEqualWith__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(lodash_isEqualWith__WEBPACK_IMPORTED_MODULE_13__);
...
const consoleLogger = {
    ...
    info: isProdEnv ? (lodash_noop__WEBPACK_IMPORTED_MODULE_0___default()) : console.info,
    warn: console.warn,
    error: console.error,
 ...
 */
const applyDefaults = (obj, defaults) => lodash_defaultsDeep__WEBPACK_IMPORTED_MODULE_1___default()({}, obj, defaults);
/**
 * Create new object by recursively assigning property overrides to `obj`.
 */
const applyOverrides = (obj, overrides) => lodash_defaultsDeep__WEBPACK_IMPORTED_MODULE_1___default()({}, overrides, obj);
/**
 * Recursive equivalent of Lodash `forOwn` function that traverses objects and arrays.
 */
const visitDeep = (obj, predicate, valueCallback, isObject = (o) => lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_3___default()(o)) => {
    lodash_forOwn__WEBPACK_IMPORTED_MODULE_2___default()(obj, (value, key, container) => {
        if (predicate(value)) {
...
const isEncodedCodeRef = (obj) => lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_3___default()(obj) &&
    lodash_isEqual__WEBPACK_IMPORTED_MODULE_6___default()(Object.getOwnPropertyNames(obj), ['$codeRef']) &&
    typeof obj.$codeRef === 'string';
const isCodeRef = (obj) => typeof obj === 'function' &&
    lodash_isEqual__WEBPACK_IMPORTED_MODULE_6___default()(Object.getOwnPropertySymbols(obj), [codeRefSymbol]) &&
...
const getPluginModule = async (moduleName, entryModule, formatErrorMessage = (lodash_identity__WEBPACK_IMPORTED_MODULE_9___default())) => {
    try {
 ...
 */
const createCodeRef = (encodedCodeRef, entryModule, formatErrorMessage = (lodash_identity__WEBPACK_IMPORTED_MODULE_9___default())) => async () => {
    ...
    if (!lodash_has__WEBPACK_IMPORTED_MODULE_8___default()(referencedModule, exportName)) {
...
const resolveCodeRefValues = async (extension) => {
    const clonedProperties = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(extension.properties);
    const resolutions = [];
 ...
 */
const resolveURL = (base, to, processURL = (lodash_identity__WEBPACK_IMPORTED_MODULE_9___default()), getDocumentOrigin = () => window.location.origin) => processURL(new URL(to, isAbsoluteURL(base) ? base : new URL(base, getDocumentOrigin()))).toString();
 ...
 */
const semverStringSchema = yup__WEBPACK_IMPORTED_MODULE_11__.string()
    .required()
 ...
 * ```
 */
const pluginNameSchema = yup__WEBPACK_IMPORTED_MODULE_11__.string()
    .required()
 ...
 * ```
 */
const extensionTypeSchema = yup__WEBPACK_IMPORTED_MODULE_11__.string()
    .required()
 ...
 * ```
 */
const featureFlagNameSchema = yup__WEBPACK_IMPORTED_MODULE_11__.string()
    .required()
    .matches(/^[A-Z]+[A-Z0-9_]*$/);
/**
 * Schema for `Extension` objects.
 */
const extensionSchema = yup__WEBPACK_IMPORTED_MODULE_11__.object()
    .required()
    .shape({
    type: extensionTypeSchema,
    properties: yup__WEBPACK_IMPORTED_MODULE_11__.object().required(),
    flags: yup__WEBPACK_IMPORTED_MODULE_11__.object().shape({
        required: yup__WEBPACK_IMPORTED_MODULE_11__.array().of(featureFlagNameSchema),
        disallowed: yup__WEBPACK_IMPORTED_MODULE_11__.array().of(featureFlagNameSchema),
    }),
});
/**
 * Schema for an array of `Extension` objects.
 */
const extensionArraySchema = yup__WEBPACK_IMPORTED_MODULE_11__.array().of(extensionSchema).required();
/**
 * Schema for `PluginRegistrationMethod` objects.
 */
const pluginRegistrationMethodSchema = yup__WEBPACK_IMPORTED_MODULE_11__.mixed()
    .oneOf(['callback', 'custom'])
    .required();
/**
 * Schema for `PluginRuntimeMetadata` objects.
 */
const pluginRuntimeMetadataSchema = yup__WEBPACK_IMPORTED_MODULE_11__.object().required().shape({
    name: pluginNameSchema,
    version: semverStringSchema,
    // TODO(vojtech): Yup lacks native support for map-like structures with arbitrary keys
    dependencies: yup__WEBPACK_IMPORTED_MODULE_11__.object(),
    customProperties: yup__WEBPACK_IMPORTED_MODULE_11__.object(),
});
/**
 * Schema for `PluginManifest` objects.
 */
const pluginManifestSchema = pluginRuntimeMetadataSchema.shape({
    baseURL: yup__WEBPACK_IMPORTED_MODULE_11__.string().required(),
    extensions: extensionArraySchema,
    loadScripts: yup__WEBPACK_IMPORTED_MODULE_11__.array().of(yup__WEBPACK_IMPORTED_MODULE_11__.string().required()).required(),
    registrationMethod: pluginRegistrationMethodSchema,
    buildHash: yup__WEBPACK_IMPORTED_MODULE_11__.string(),
});
...
class PluginLoader {
    constructor(options = {}) {
        ...
        this.options = {
            ...
            postProcessManifest: options.postProcessManifest ?? (lodash_identity__WEBPACK_IMPORTED_MODULE_9___default()),
            getPluginEntryModule: options.getPluginEntryModule ?? (lodash_noop__WEBPACK_IMPORTED_MODULE_0___default()),
        };
     ...
     */
    processPluginManifest(manifest) {
    ...
    async loadPluginScripts(manifest, data) {
        ...
        const [, rejectedReasons] = await settleAllPromises(manifest.loadScripts.map((scriptName) => {
            ...
            return injectScriptElement(resolveURL(manifest.baseURL, scriptName, (url) => {
                url.searchParams.set('cacheBuster', (0,uuid__WEBPACK_IMPORTED_MODULE_15__["default"])());
                return url;
            }), scriptID);
        }));
    ...
    getCurrentDependencyResolutions() {
        ...
        Object.entries(this.options.fixedPluginDependencyResolutions).forEach(([depName, version]) => {
            if (semver__WEBPACK_IMPORTED_MODULE_10__.valid(version)) {
            ...
            const tryResolveDependencies = () => {
                ...
                Object.entries(dependencies).forEach(([depName, versionRange]) => {
                    if (resolutions.has(depName)) {
                        ...
                        if (res.success && !semver__WEBPACK_IMPORTED_MODULE_10__.satisfies(res.version, versionRange, semverRangeOptions)) {
...
class PluginStore {
    ...
    setFeatureFlags(newFlags) {
        ...
        this.featureFlags = {
            ...this.featureFlags,
            ...lodash_pickBy__WEBPACK_IMPORTED_MODULE_7___default()(newFlags, (value) => typeof value === 'boolean'),
        };
        if (!lodash_isEqual__WEBPACK_IMPORTED_MODULE_6___default()(prevFeatureFlags, this.featureFlags)) {
    ...
    updateExtensions() {
        ...
        if (!lodash_isEqual__WEBPACK_IMPORTED_MODULE_6___default()(prevExtensions, this.extensions)) {
    ...
    addLoadedPlugin(manifest, entryModule) {
        const pluginName = manifest.name;
        const buildHash = manifest.buildHash ?? (0,uuid__WEBPACK_IMPORTED_MODULE_15__["default"])();
        const loadedExtensions = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(manifest.extensions).map((e, index) => decodeCodeRefs({
            ...e,
            pluginName,
    ...
    addFailedPlugin(manifest, errorMessage, errorCause) {
        ...
        consoleLogger.error(...lodash_compact__WEBPACK_IMPORTED_MODULE_5___default()([errorMessage, errorCause]));
    }
...
const PluginStoreContext = react__WEBPACK_IMPORTED_MODULE_12__.createContext(undefined);
/**
 * React Context provider for passing the {@link PluginStore} down the component tree.
 */
const PluginStoreProvider = ({ store, children }) => (react__WEBPACK_IMPORTED_MODULE_12__.createElement(PluginStoreContext.Provider, { value: store }, children));
/**
 * React hook that provides access to the {@link PluginStore} functionality.
 */
const usePluginStore = () => {
    const store = react__WEBPACK_IMPORTED_MODULE_12__.useContext(PluginStoreContext);
    if (store === undefined) {
...
const usePluginSubscription = (eventTypes, getData, isSameData = isSameReference) => {
    ...
    const getDataRef = react__WEBPACK_IMPORTED_MODULE_12__.useRef(getData);
    getDataRef.current = getData;
    const isSameDataRef = react__WEBPACK_IMPORTED_MODULE_12__.useRef(isSameData);
    isSameDataRef.current = isSameData;
    const [hookResult, setHookResult] = react__WEBPACK_IMPORTED_MODULE_12__.useState(() => getData(pluginStore));
    const updateResult = react__WEBPACK_IMPORTED_MODULE_12__.useCallback(() => {
    ...
    react__WEBPACK_IMPORTED_MODULE_12__.useEffect(() => updateResult(), [getData, isSameData, updateResult]);
    react__WEBPACK_IMPORTED_MODULE_12__.useEffect(() => pluginStore.subscribe(eventTypes, updateResult), [pluginStore, eventTypes, updateResult]);
    return hookResult;
};

const eventTypes$2 = [PluginEventType.ExtensionsChanged];
const getData$1 = (pluginStore) => pluginStore.getExtensions();
const isSameData$1 = (prevData, nextData) => lodash_isEqualWith__WEBPACK_IMPORTED_MODULE_13___default()(prevData, nextData, (a, b) => a === b);
/**
...
const useExtensions = (predicate) => {
    ...
    return react__WEBPACK_IMPORTED_MODULE_12__.useMemo(() => extensions.reduce((acc, e) => ((predicate ?? (() => true))(e) ? [...acc, e] : acc), []), [extensions, predicate]);
};
...
const useResolvedExtensions = (predicate) => {
    ...
    const pluginStore = usePluginStore();
    const [resolvedExtensions, setResolvedExtensions] = react__WEBPACK_IMPORTED_MODULE_12__.useState([]);
    const [resolved, setResolved] = react__WEBPACK_IMPORTED_MODULE_12__.useState(false);
    const [errors, setErrors] = react__WEBPACK_IMPORTED_MODULE_12__.useState([]);
    react__WEBPACK_IMPORTED_MODULE_12__.useEffect(() => {
        ...
        settleAllPromises(extensions.map(resolveCodeRefValues)).then(([fulfilledValues, rejectedReasons]) => {
            ...
            if (rejectedReasons.length > 0) {
                ...
                const failedPluginNames = lodash_uniq__WEBPACK_IMPORTED_MODULE_14___default()(rejectedReasons
...
const useFeatureFlag = (name) => {
    const getData = react__WEBPACK_IMPORTED_MODULE_12__.useCallback((pluginStore) => pluginStore.getFeatureFlags()[name], [name]);
    const currentValue = usePluginSubscription(eventTypes$1, getData, isSameData);
    const pluginStore = usePluginStore();
    const setValue = react__WEBPACK_IMPORTED_MODULE_12__.useCallback((value) => {
 ...
 */
const usePluginInfo = () => {
    return usePluginSubscription(eventTypes, getData, (lodash_isEqual__WEBPACK_IMPORTED_MODULE_6___default()));
};

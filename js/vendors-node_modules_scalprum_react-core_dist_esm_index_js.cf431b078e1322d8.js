...
function loadComponent(scope, module) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_0__.asyncLoader)(scope, module)];
                case 1:
                    mod = _a.sent();
                    return [2, {
...
var LoadModule = function (_a) {
    ...
    var _d = (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.getAppData)(scope), scriptLocation = _d.scriptLocation, manifestLocation = _d.manifestLocation;
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        ...
        var _a = (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.getCachedModule)(scope, module, skipCache), cachedModule = _a.cachedModule, prefetchPromise = _a.prefetchPromise;
        ...
        if (!cachedModule && pendingLoading) {
            ...
            if (!cachedModule) {
                if (scriptLocation) {
                    var injectionPromise = (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.injectScript)(scope, scriptLocation)
                        .then(function () {
                    ...
                    (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.setPendingLoading)(scope, module, injectionPromise);
                }
                else if (manifestLocation) {
                    var processPromise = (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.processManifest)(manifestLocation, scope, processor)
                        .then(function () {
                        pref = setComponentFromModule(scope, module, isMounted, setComponent);
                        pref.then(function (result) {
                            if (result) {
...
function useLoadModule(_a, defaultState, options) {
    ...
    var _b = (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.getAppData)(scope), scriptLocation = _b.scriptLocation, manifestLocation = _b.manifestLocation;
    ...
    var cachedModule = (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.getCachedModule)(scope, module, defaultOptions.skipCache).cachedModule;
    var isMounted = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(true);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        if (isMounted.current) {
            if (!cachedModule) {
                if (scriptLocation) {
                    (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.injectScript)(scope, scriptLocation)
                    ...
                    (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.processManifest)(manifestLocation, scope, processor)
                        .then(function () { return __awaiter(_this, void 0, void 0, function () {
                        var Module;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
...
function useModule(scope, module, defaultState, options) {
    ...
    var fetchModule = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    cachedModule = (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.getCachedModule)(scope, module, defaultOptions.skipCache).cachedModule;

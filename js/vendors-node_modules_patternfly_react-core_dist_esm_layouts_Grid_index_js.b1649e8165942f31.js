...
/* harmony import */ var _patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @patternfly/react-styles/css/layouts/Grid/grid */ "./node_modules/@patternfly/react-styles/css/layouts/Grid/grid.js");
...
const Grid = (_a) => {
    ...
    const classes = [_patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].grid, span && _patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`all_${span}Col`]];
    const Component = component;
    Object.entries(_styles_sizes__WEBPACK_IMPORTED_MODULE_3__.DeviceSizes).forEach(([propKey, gridSpanModifier]) => {
        const key = propKey;
        const propValue = props[key];
        if (propValue) {
            classes.push(_patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`all_${propValue}ColOn${gridSpanModifier}`]);
        }
        delete props[key];
    });
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Component, Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_4__.css)(...classes, hasGutter && _patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers.gutter, className), style: style || order ? Object.assign(Object.assign({}, style), (0,_helpers_util__WEBPACK_IMPORTED_MODULE_5__.setBreakpointCssVars)(order, _patternfly_react_tokens_dist_esm_l_grid_item_Order__WEBPACK_IMPORTED_MODULE_6__.l_grid_item_Order.name)) : undefined }, props), children));
};
...
const GridItem = (_a) => {
    ...
    const classes = [
        _patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].gridItem,
        span && _patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`${span}Col`],
        rowSpan && _patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`${rowSpan}Row`],
        offset && _patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`offset_${offset}Col`]
    ];
    const Component = component;
    Object.entries(_styles_sizes__WEBPACK_IMPORTED_MODULE_3__.DeviceSizes).forEach(([propKey, classModifier]) => {
        ...
        if (spanValue) {
            classes.push(_patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`${spanValue}ColOn${classModifier}`]);
        }
        if (rowSpanValue) {
            classes.push(_patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`${rowSpanValue}RowOn${classModifier}`]);
        }
        if (offsetValue) {
            classes.push(_patternfly_react_styles_css_layouts_Grid_grid__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers[`offset_${offsetValue}ColOn${classModifier}`]);
        }
        delete props[key];
...
__webpack_require__(/*! ./grid.css */ "?8a00");
exports["default"] = {
  "grid": "pf-v5-l-grid",

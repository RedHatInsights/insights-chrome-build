...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@patternfly/react-icons"), require("classnames"), require("react"), require("@patternfly/react-core"));
	else if(typeof define === 'function' && define.amd)
		define("InsightsComponentsRegistery-components/Remediations", ["@patternfly/react-icons", "classnames", "react", "@patternfly/react-core"], factory);
	else if(typeof exports === 'object')
		exports["InsightsComponentsRegistery-components/Remediations"] = factory(require("@patternfly/react-icons"), require("classnames"), require("react"), require("@patternfly/react-core"));
	else
		root["InsightsComponentsRegistery-components/Remediations"] = factory(root["PFReactIcons"], root["classnames"], root["React"], root["PFReactCore"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__patternfly_react_icons__, __WEBPACK_EXTERNAL_MODULE_classnames__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE__patternfly_react_core__) {
...
var Wizard = function (_Component) {
    ...
    function Wizard() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (Wizard.__proto__ || Object.getPrototypeOf(Wizard)).call(this));

        _this.state = {
            currentStep: 0
        };
        _this.handlePreviousModalStep = _this.handlePreviousModalStep.bind(_this);
        _this.handleNextModalStep = _this.handleNextModalStep.bind(_this);
        _this.handleOnClose = _this.handleOnClose.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(Wizard, [{
        key: 'handleNextModalStep',
        value: function handleNextModalStep() {
        ...
        key: 'handlePreviousModalStep',
        value: function handlePreviousModalStep() {
        ...
        value: function handleOnClose() {
            ...
            var result = this.props.onClose(submit);
        ...
        value: function render() {
            ...
            var renderModalActions = [_react2.default.createElement(
                _reactCore.Button,
                { key: 'cancel', variant: 'secondary', onClick: function onClick() {
            ...
            this.state.currentStep !== 0 && _react2.default.createElement(
                _reactCore.Button,
                { key: 'back', variant: 'secondary', onClick: this.handlePreviousModalStep },
                ' Back '
            ),
            ...
            this.state.currentStep < this.props.content.length - 1 ? _react2.default.createElement(
                _reactCore.Button,
                { key: 'Next', variant: 'primary', onClick: this.handleNextModalStep },
                ' Next '
            ) : _react2.default.createElement(
                _reactCore.Button,
                { key: 'confirm', variant: 'primary', onClick: function onClick() {
                        ...
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                return Promise.all(issues.map(function (issue) {
                                    return api.getResolutions(issue.id);
                                }));

                            case 2:
                                resolutions = _context2.sent;

                                _this.setState({ resolutions: resolutions });
...
},{"@patternfly/react-icons":"k73M","classnames":"kpqe","react":"ccIB","@patternfly/react-core":"Tk4w","process":"rH1J"}]},{},[], null)
//# sourceMappingURL=/insightsbeta/static/chrome/js/Remediations.ccc0e577.map
...
const DrawerContent = (_a) => {
    var { className = '', children, panelContent, colorVariant = _Drawer__WEBPACK_IMPORTED_MODULE_1__.DrawerColorVariant.default } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__rest)(_a, ["className", "children", "panelContent", "colorVariant"]);
...
const DrawerContentBody = (_a) => {
    var { className = '', children, hasPadding = false } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["className", "children", "hasPadding"]);

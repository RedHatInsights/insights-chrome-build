...
/* harmony export */ });
/* harmony import */ var _sentry_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @sentry/browser */ "./node_modules/@sentry/minimal/esm/index.js");
...
async function createSupportCase(userInfo, libjwt, fields) {
    ...
    fetch(caseUrl, {
        ...
        .catch((err) => _sentry_browser__WEBPACK_IMPORTED_MODULE_5__.captureException(err));
}
function createSupportSentry(session, fields) {
    if (window.insights.chrome.isProd) {
        ...
        _sentry_browser__WEBPACK_IMPORTED_MODULE_5__.captureException(new Error('Support case created'), {
            tags: {
                caseId: session,

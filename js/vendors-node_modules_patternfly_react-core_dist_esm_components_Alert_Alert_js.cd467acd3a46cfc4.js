"use strict";
(self["webpackChunkinsights_chrome"] = self["webpackChunkinsights_chrome"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_components_Alert_Alert_js"],{
...
/* harmony import */ var _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Alert/alert.mjs */ "./node_modules/@patternfly/react-styles/css/components/Alert/alert.mjs");
/* harmony import */ var _AlertIcon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./AlertIcon */ "./node_modules/@patternfly/react-core/dist/esm/components/Alert/AlertIcon.js");
...
/* harmony import */ var _AlertContext__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./AlertContext */ "./node_modules/@patternfly/react-core/dist/esm/components/Alert/AlertContext.js");
/* harmony import */ var _patternfly_react_tokens_dist_esm_c_alert_title_max_lines__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-tokens/dist/esm/c_alert__title_max_lines */ "./node_modules/@patternfly/react-tokens/dist/esm/c_alert__title_max_lines.js");
...
/* harmony import */ var _AlertToggleExpandButton__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./AlertToggleExpandButton */ "./node_modules/@patternfly/react-core/dist/esm/components/Alert/AlertToggleExpandButton.js");
...
const Alert = (_a) => {
    var { variant = AlertVariant.custom, isInline = false, isPlain = false, isLiveRegion = false, variantLabel = `${(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.capitalize)(variant)} alert:`, actionClose, actionLinks, title, component = 'h4', children = '', className = '', ouiaId, ouiaSafe = true, timeout = false, timeoutAnimation = 3000, onTimeout = () => { }, truncateTitle = 0, tooltipPosition, customIcon, isExpandable = false, toggleAriaLabel = `${(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.capitalize)(variant)} alert details`, onMouseEnter = () => { }, onMouseLeave = () => { }, id } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__rest)(_a, ["variant", "isInline", "isPlain", "isLiveRegion", "variantLabel", "actionClose", "actionLinks", "title", "component", "children", "className", "ouiaId", "ouiaSafe", "timeout", "timeoutAnimation", "onTimeout", "truncateTitle", "tooltipPosition", "customIcon", "isExpandable", "toggleAriaLabel", "onMouseEnter", "onMouseLeave", "id"]);
    ...
    const getHeadingContent = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "pf-v5-screen-reader" }, variantLabel),
        title));
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        ...
        titleRef.current.style.setProperty(_patternfly_react_tokens_dist_esm_c_alert_title_max_lines__WEBPACK_IMPORTED_MODULE_4__["default"].name, truncateTitle.toString());
    ...
    const Title = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(TitleComponent, Object.assign({}, (isTooltipVisible && { tabIndex: 0 }), { ref: titleRef, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].alertTitle, truncateTitle && _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].modifiers.truncate) }), getHeadingContent));
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({ ref: divRef, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].alert, isInline && _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].modifiers.inline, isPlain && _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].modifiers.plain, isExpandable && _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].modifiers.expandable, isExpanded && _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].modifiers.expanded, _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].modifiers[variant], className) }, ouiaProps, (isLiveRegion && {
        'aria-live': 'polite',
        'aria-atomic': 'false'
    }), { onMouseEnter: myOnMouseEnter, onMouseLeave: myOnMouseLeave, id: id }, props),
        isExpandable && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AlertContext__WEBPACK_IMPORTED_MODULE_7__.AlertContext.Provider, { value: { title, variantLabel } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].alertToggle) },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AlertToggleExpandButton__WEBPACK_IMPORTED_MODULE_8__.AlertToggleExpandButton, { isExpanded: isExpanded, onToggleExpand: onToggleExpand, "aria-label": toggleAriaLabel })))),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AlertIcon__WEBPACK_IMPORTED_MODULE_9__.AlertIcon, { variant: variant, customIcon: customIcon }),
        isTooltipVisible ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Tooltip__WEBPACK_IMPORTED_MODULE_10__.Tooltip, { content: getHeadingContent, position: tooltipPosition }, Title)) : (Title),
        actionClose && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AlertContext__WEBPACK_IMPORTED_MODULE_7__.AlertContext.Provider, { value: { title, variantLabel } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].alertAction) }, actionClose))),
        children && (!isExpandable || (isExpandable && isExpanded)) && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].alertDescription) }, children)),
        actionLinks && react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_6__["default"].alertActionGroup) }, actionLinks)));
};
...
/* harmony import */ var _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Alert/alert.mjs */ "./node_modules/@patternfly/react-styles/css/components/Alert/alert.mjs");
...
const AlertIcon = (_a) => {
    ...
    return Icon ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({}, props, { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_7__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_8__["default"].alertIcon, className) }), customIcon || react__WEBPACK_IMPORTED_MODULE_0__.createElement(Icon, null))) : null;
};
...
/* harmony import */ var _patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Alert/alert.mjs */ "./node_modules/@patternfly/react-styles/css/components/Alert/alert.mjs");
...
const AlertToggleExpandButton = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Button__WEBPACK_IMPORTED_MODULE_3__.Button, Object.assign({ variant: _Button__WEBPACK_IMPORTED_MODULE_3__.ButtonVariant.plain, onClick: onToggleExpand, "aria-expanded": isExpanded, "aria-label": ariaLabel === '' ? `Toggle ${variantLabel || alertVariantLabel} alert: ${title}` : ariaLabel }, props),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_4__.css)(_patternfly_react_styles_css_components_Alert_alert_mjs__WEBPACK_IMPORTED_MODULE_5__["default"].alertToggleIcon) },
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _alert_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./alert.css */ "?2900");

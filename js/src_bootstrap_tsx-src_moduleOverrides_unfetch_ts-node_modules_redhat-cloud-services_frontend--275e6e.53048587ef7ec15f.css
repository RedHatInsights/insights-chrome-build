...
.chr-c-allservices__link-wrapper {
  position: relative;
}
.chr-c-allservices__link-wrapper .chr-c-allservices__favourite {
  position: absolute;
}
.chr-c-allservices__link-wrapper .chr-c-allservices__favourite.chr-c-allservices__favourite_not {
  display: none;
}
.chr-c-allservices__link-wrapper:hover .chr-c-allservices__favourite {
  display: inline-block;
}

.chr-l-stack-allservices .chr-c-all-services-filter {
  margin-left: auto;
  margin-right: auto;
  max-width: 300px;
}
.chr-l-stack-allservices .pf-l-gallery {
  display: block;
  column-count: auto;
  column-width: 330px;
}
.chr-l-stack-allservices .pf-c-card {
  display: block;
  overflow: hidden;
  break-inside: avoid-column;
}
.chr-l-stack-allservices .pf-c-card__title svg {
  margin-right: var(--pf-global--spacer--xs);
}
.chr-l-stack-allservices .pf-c-card__body {
  padding-bottom: var(--pf-global--spacer--sm);
}
.chr-l-stack-allservices .pf-c-card__body .pf-c-content {
  --pf-c-content--FontSize: var(--pf-global--FontSize--sm);
  --pf-c-content--LineHeight: var(--pf-global--LineHeight--sm);
}
.chr-l-stack-allservices .pf-c-card__body .pf-c-content a svg {
  font-size: var(--pf-global--icon--FontSize--sm);
  margin-bottom: 2px;
  margin-left: var(--pf-global--spacer--xs);
}
.chr-l-stack-allservices .pf-c-card__body .pf-c-content .subtitle {
  font-weight: var(--pf-global--FontWeight--semi-bold);
  padding-top: var(--pf-global--spacer--form-element);
}
@media screen and (max-width: 768px) {
  .chr-l-stack-allservices .sticky {
    position: sticky;
    top: 0;
  }
  .chr-l-stack-allservices .pf-c-search-input {
    margin: auto;
    width: 100%;
  }
}
...
.chr-l-stack-favoritedservices .chr-l-stack__item-centered, .chr-l-stack-favoritedservices .chr-c-card-centered {
  display: flex;
  justify-content: center;
  text-align: center;
}
...
footer#hcc-footer li {
  border: none;
}
footer#hcc-footer li a {
  color: var(--pf-global--active-color--100);
  margin: 0;
}

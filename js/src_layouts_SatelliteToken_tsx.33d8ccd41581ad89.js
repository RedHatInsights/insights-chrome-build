...
var IPWhitelistTable = function() {
    ...
    var ipTable = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_table__WEBPACK_IMPORTED_MODULE_24__.OuterScrollContainer, {
        ...
        }, ipBlock.created_at), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_table__WEBPACK_IMPORTED_MODULE_19__.Td, {
...
/* harmony import */ var _auth_ChromeAuthContext__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../auth/ChromeAuthContext */ "./src/auth/ChromeAuthContext.ts");
/* harmony import */ var _components_NotFoundRoute__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/NotFoundRoute */ "./src/components/NotFoundRoute/index.ts");
function _array_like_to_array(arr, len) {
    if (len == null || len > arr.length) len = arr.length;
    for(var i = 0, arr2 = new Array(len); i < len; i++)arr2[i] = arr[i];
    return arr2;
...
var SatelliteToken = function() {
    ...
    var user = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_auth_ChromeAuthContext__WEBPACK_IMPORTED_MODULE_11__["default"]).user;
    var isITLess = (0,_unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_2__.useFlag)('platform.chrome.itless');
    if (!isITLess) {
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_NotFoundRoute__WEBPACK_IMPORTED_MODULE_12__["default"], null);
    }

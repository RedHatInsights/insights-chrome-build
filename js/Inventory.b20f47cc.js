                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            null,
                            _this.getFact('fqdn') || _this.getFact('facts.hostname') || 'Unknown'
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            null,
                            _this.getFact('facts.os_release') || _this.getFact('facts.inventory.release') || _this.getFact('facts.qpc.os_release') || 'Unknown'
                        )
                    )
                ),
                _react2.default.createElement(
...
exports.mapData = exports.defaultState = undefined;
...
// eslint-disable-next-line camelcase
function entitiesLoaded(state, _ref2) {
    var _ref2$payload = _ref2.payload,
        results = _ref2$payload.results,
        perPage = _ref2$payload.per_page,
        page = _ref2$payload.page,
        count = _ref2$payload.count,
        total = _ref2$payload.total,
        loaded = _ref2$payload.loaded;
...
function selectEntity(state, _ref3) {
...
function changeSort(state, _ref4) {
...
function selectFilter(state, _ref5) {
    var _ref5$payload = _ref5.payload,
        _ref5$payload$item = _ref5$payload.item,
        items = _ref5$payload$item.items,
        item = (0, _objectWithoutProperties3.default)(_ref5$payload$item, ['items']),
...
var _entities = __webpack_require__(/*! ./entities */ "./src/redux/reducers/inventory/entities.js");
...
function entityDetailLoaded(state, _ref) {
    ...
    return (0, _extends3.default)({}, state, {
        loaded: true,
        entity: payload.results.map(_entities.mapData)[0]
    });
}
...
//# sourceMappingURL=/insightsbeta/static/chrome/js/Inventory.b20f47cc.map
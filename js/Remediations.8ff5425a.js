...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"mkKs":[function(require,module,exports) {
var define;
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@patternfly/react-core"), require("@patternfly/react-icons"), require("classnames"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define("InsightsComponentsRegistery-components/Remediations", ["@patternfly/react-core", "@patternfly/react-icons", "classnames", "react"], factory);
	else if(typeof exports === 'object')
		exports["InsightsComponentsRegistery-components/Remediations"] = factory(require("@patternfly/react-core"), require("@patternfly/react-icons"), require("classnames"), require("react"));
	else
		root["InsightsComponentsRegistery-components/Remediations"] = factory(root["PFReactCore"], root["PFReactIcons"], root["classnames"], root["React"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__patternfly_react_core__, __WEBPACK_EXTERNAL_MODULE__patternfly_react_icons__, __WEBPACK_EXTERNAL_MODULE_classnames__, __WEBPACK_EXTERNAL_MODULE_react__) {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/SmartComponents/Remediations/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/index.js");
  ...
  _createClass(ContextBody, [{
    ...
    value: function render() {
      ...
      var mappedRows = headerData.length !== 0 && rows.map(function (oneRow, oneRowKey) {
        return _extends({}, oneRow, oneRow && (oneRow.cells || oneRow).reduce(function (acc, curr, key) {
          return _extends({}, acc, _defineProperty({}, headerData[shiftKey + key].property, {
            title: curr.title || curr,
            props: curr.props
          }));
        }, { id: oneRowKey }), oneRow.parent !== undefined ? {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment,
        null,
        mappedRows && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactabular_table__WEBPACK_IMPORTED_MODULE_1__["Body"], _extends({}, props, { rows: mappedRows, onRow: this.onRow, rowKey: rowKey, className: className }))
      );
    }
  }]);
...
var BodyCell = function BodyCell(_ref) {
  var dataLabel = _ref['data-label'],
      ...
      props = _objectWithoutProperties(_ref, ['data-label', 'parentId', 'component', 'colSpan']);

  var mappedProps = _extends({}, dataLabel ? { 'data-label': dataLabel } : {}, props);
  return parentId !== undefined && colSpan === undefined ? null : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, _extends({}, mappedProps, { colSpan: colSpan }));
};
...
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/index.js");
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var BodyWrapper = function BodyWrapper(rows) {
  var TableBody = function (_Component) {
    ...
    _createClass(TableBody, [{
      key: 'render',
      value: function render() {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('tbody', _extends({}, this.props, { className: Object(_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__["css"])(rows.some(function (row) {
            return row.isOpen && !row.hasOwnProperty('parent');
          }) && _patternfly_patternfly_components_Table_table_css_js__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.expanded) }));
      }
    }]);
...
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/index.js");
...
/* harmony import */ var _patternfly_patternfly_components_Table_table_css_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../@patternfly/patternfly/components/Table/table.css.js */ "./node_modules/@patternfly/react-table/dist/esm/@patternfly/patternfly/components/Table/table.css.js");
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var CollapseColumn = function CollapseColumn(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    ...
    isOpen !== undefined && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      _patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__["Button"],
      _extends({ className: Object(_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_3__["css"])(className, isOpen && _patternfly_patternfly_components_Table_table_css_js__WEBPACK_IMPORTED_MODULE_5__["default"].modifiers.expanded) }, props, { variant: 'plain', 'aria-label': 'Details', onClick: onToggle, 'aria-expanded': isOpen }),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_icons_dist_esm_icons_angle_down_icon__WEBPACK_IMPORTED_MODULE_2__["default"], null)
    ),
    children
  );
};
...
var HeaderCell = function HeaderCell(_ref) {
  var dataLabel = _ref['data-label'],
      scope = _ref.scope,
      Component = _ref.component,
      props = _objectWithoutProperties(_ref, ['data-label', 'scope', 'component']);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _patternfly_react_icons_dist_esm_icons_angle_up_icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @patternfly/react-icons/dist/esm/icons/angle-up-icon */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/angle-up-icon.js");
/* harmony import */ var _patternfly_react_icons_dist_esm_icons_angle_down_icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @patternfly/react-icons/dist/esm/icons/angle-down-icon */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/angle-down-icon.js");
/* harmony import */ var _patternfly_react_icons_dist_esm_icons_sort_icon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-icons/dist/esm/icons/sort-icon */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/sort-icon.js");
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/index.js");
...
var SortColumn = function SortColumn(_ref) {
  ...
  var SortedByIcon = isSortedBy ? sortDirection === 'asc' ? _patternfly_react_icons_dist_esm_icons_angle_up_icon__WEBPACK_IMPORTED_MODULE_2__["default"] : _patternfly_react_icons_dist_esm_icons_angle_down_icon__WEBPACK_IMPORTED_MODULE_3__["default"] : _patternfly_react_icons_dist_esm_icons_sort_icon__WEBPACK_IMPORTED_MODULE_4__["default"];
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    'button',
...
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/index.js");
...
var propTypes = {
  ...
  rows: prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.shape({
    cells: prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.node),
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          ...
          _extends({}, props, {
            renderers: {
              body: {
                wrapper: Object(_BodyWrapper__WEBPACK_IMPORTED_MODULE_10__["default"])(rows),
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/index.js");
/* harmony import */ var _patternfly_patternfly_components_Table_table_css_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../@patternfly/patternfly/components/Table/table.css.js */ "./node_modules/@patternfly/react-table/dist/esm/@patternfly/patternfly/components/Table/table.css.js");
...
/*!*********************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-table/dist/esm/components/Table/utils/headerUtils.js ***!
  \*********************************************************************************************/
/*! exports provided: calculateColumns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-table/dist/esm/components/Table/utils/index.js ***!
  \***************************************************************************************/
/*! exports provided: selectable, sortable, cellActions, cellWidth, collapsible, expandedRow, headerCol, emptyTD, scopeColTransformer, emptyCol, parentId, mapProps, calculateColumns, defaultTitle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/angle-up-icon.js":
/*!*******************************************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/angle-up-icon.js ***!
  \*******************************************************************************************************************/
/*! exports provided: default */
...
var AngleUpIcon = Object(_createIcon__WEBPACK_IMPORTED_MODULE_0__["default"])({
  name: 'AngleUpIcon',
  height: 512,
  width: 320,
...
/* harmony default export */ __webpack_exports__["default"] = (AngleUpIcon);

/***/ }),

/***/ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/sort-icon.js":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/sort-icon.js ***!
  \***************************************************************************************************************/
/*! exports provided: default */
...
var SortIcon = Object(_createIcon__WEBPACK_IMPORTED_MODULE_0__["default"])({
  name: 'SortIcon',
  height: 512,
  width: 320,
...
/***/ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/StyleSheet.js":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/StyleSheet.js ***!
  \***********************************************************************************************************/
...
/* harmony import */ var emotion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! emotion */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/node_modules/emotion/dist/index.esm.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/utils.js");
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _StyleSheet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./StyleSheet */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/StyleSheet.js");
...
/***/ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/utils.js":
/*!******************************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/dist/esm/utils.js ***!
  \******************************************************************************************************/
...
/* harmony import */ var emotion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! emotion */ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/node_modules/emotion/dist/index.esm.js");
...
/***/ "./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/node_modules/emotion/dist/index.esm.js":
/*!***************************************************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-styles/node_modules/emotion/dist/index.esm.js ***!
  \***************************************************************************************************************************/
...
/***/ "./src/PresentationalComponents/Reboot/Reboot.js":
/*!*******************************************************!*\
  !*** ./src/PresentationalComponents/Reboot/Reboot.js ***!
  \*******************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./reboot.scss */ "./src/PresentationalComponents/Reboot/reboot.scss");
...
var Reboot = function Reboot(_ref) {
    var red = _ref.red,
        className = _ref.className,
        props = (0, _objectWithoutProperties3.default)(_ref, ['red', 'className']);


    var rebootIconClasses = (0, _classnames2.default)('ins-c-reboot', (0, _defineProperty3.default)({}, 'ins-m-red', red), className);

    return _react2.default.createElement(
        'span',
        (0, _extends3.default)({ className: rebootIconClasses }, props),
        _react2.default.createElement(_reactIcons.RebootingIcon, null),
        _react2.default.createElement(
            'span',
            null,
            'Reboot Required'
...
/***/ "./src/PresentationalComponents/Reboot/index.js":
/*!******************************************************!*\
  !*** ./src/PresentationalComponents/Reboot/index.js ***!
  \******************************************************/
/*! no static exports found */
...
var _Reboot = __webpack_require__(/*! ./Reboot.js */ "./src/PresentationalComponents/Reboot/Reboot.js");
...
/***/ "./src/PresentationalComponents/Reboot/reboot.scss":
/*!*********************************************************!*\
  !*** ./src/PresentationalComponents/Reboot/reboot.scss ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/PresentationalComponents/Wizard/Wizard.js":
/*!*******************************************************!*\
  !*** ./src/PresentationalComponents/Wizard/Wizard.js ***!
  \*******************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./wizard.scss */ "./src/PresentationalComponents/Wizard/wizard.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Wizard = function (_Component) {
    (0, _inherits3.default)(Wizard, _Component);
    ...
    function Wizard() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Wizard.__proto__ || Object.getPrototypeOf(Wizard)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            currentStep: 0
    ...
    (0, _createClass3.default)(Wizard, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                props = (0, _objectWithoutProperties3.default)(_props, ['isLarge', 'title', 'className', 'isOpen', 'isValidated', 'confirmAction']);


            var wizardClasses = (0, _classnames2.default)('ins-c-wizard', className);

            var renderModalActions = [_react2.default.createElement(
                _reactCore.Button,
                { key: 'cancel', action: 'cancel', variant: 'secondary', onClick: function onClick() {
            ...
            this.state.currentStep !== 0 && _react2.default.createElement(
                _reactCore.Button,
                { key: 'back', action: 'back', variant: 'secondary', onClick: this.handlePreviousModalStep },
                ' Back '
            ),
            // Conditionally render 'confirm' button if on last page
            this.state.currentStep < this.props.content.length - 1 ? _react2.default.createElement(
                _reactCore.Button,
                {
                    key: 'Next',
                    action: 'next',
...
Wizard.propTypes = {
    ...
    className: _propTypes2.default.string,
    confirmAction: _propTypes2.default.string,
...
/***/ "./src/PresentationalComponents/Wizard/index.js":
/*!******************************************************!*\
  !*** ./src/PresentationalComponents/Wizard/index.js ***!
  \******************************************************/
/*! no static exports found */
...
var _Wizard = __webpack_require__(/*! ./Wizard */ "./src/PresentationalComponents/Wizard/Wizard.js");
...
/***/ "./src/PresentationalComponents/Wizard/wizard.scss":
/*!*********************************************************!*\
  !*** ./src/PresentationalComponents/Wizard/wizard.scss ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/SmartComponents/Remediations/RemediationWizard.js":
/*!***************************************************************!*\
  !*** ./src/SmartComponents/Remediations/RemediationWizard.js ***!
  \***************************************************************/
/*! no static exports found */
...
var _transform3 = __webpack_require__(/*! lodash/transform */ "./node_modules/lodash/transform.js");

var _transform4 = _interopRequireDefault(_transform3);

var _remediations = __webpack_require__(/*! ../../api/remediations */ "./src/api/remediations.js");

var api = _interopRequireWildcard(_remediations);

var _Wizard = __webpack_require__(/*! ../../PresentationalComponents/Wizard */ "./src/PresentationalComponents/Wizard/index.js");

var _Deferred = __webpack_require__(/*! ../../Utilities/Deferred */ "./src/Utilities/Deferred.js");

var _Deferred2 = _interopRequireDefault(_Deferred);

var _utils = __webpack_require__(/*! ./utils */ "./src/SmartComponents/Remediations/utils.js");

var _ExistingOrNew = __webpack_require__(/*! ./steps/ExistingOrNew */ "./src/SmartComponents/Remediations/steps/ExistingOrNew.js");

var _ExistingOrNew2 = _interopRequireDefault(_ExistingOrNew);

var _ResolutionModeStep = __webpack_require__(/*! ./steps/ResolutionModeStep */ "./src/SmartComponents/Remediations/steps/ResolutionModeStep.js");

var _ResolutionModeStep2 = _interopRequireDefault(_ResolutionModeStep);

var _IssueResolutionStep = __webpack_require__(/*! ./steps/IssueResolutionStep */ "./src/SmartComponents/Remediations/steps/IssueResolutionStep.js");

var _IssueResolutionStep2 = _interopRequireDefault(_IssueResolutionStep);

var _SummaryStep = __webpack_require__(/*! ./steps/SummaryStep */ "./src/SmartComponents/Remediations/steps/SummaryStep.js");

var _SummaryStep2 = _interopRequireDefault(_SummaryStep);

var _LoadingStep = __webpack_require__(/*! ./steps/LoadingStep */ "./src/SmartComponents/Remediations/steps/LoadingStep.js");

var _LoadingStep2 = _interopRequireDefault(_LoadingStep);

var _ErrorStep = __webpack_require__(/*! ./steps/ErrorStep */ "./src/SmartComponents/Remediations/steps/ErrorStep.js");

var _ErrorStep2 = _interopRequireDefault(_ErrorStep);

__webpack_require__(/*! ./RemediationWizard.scss */ "./src/SmartComponents/Remediations/RemediationWizard.scss");
...
var RemediationWizard = function (_Component) {
    (0, _inherits3.default)(RemediationWizard, _Component);

    function RemediationWizard(props) {
        var _this2 = this;

        (0, _classCallCheck3.default)(this, RemediationWizard);

        var _this = (0, _possibleConstructorReturn3.default)(this, (RemediationWizard.__proto__ || Object.getPrototypeOf(RemediationWizard)).call(this, props));

        _this.setOpen = function (open) {
            _this.setState({ open: open });
        };

        _this.openWizard = function (data, basePath) {
            var deferred = new _Deferred2.default();
            var issuesById = (0, _keyBy2.default)(data.issues, function (issue) {
                return issue.id;
            });
        ...
        _this.loadRemediations = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 2:
                            _ref2 = _context.sent;
                            existingRemediations = _ref2.remediations;

                            _this.setState({ existingRemediations: existingRemediations });
        ...
        _this.loadResolutions = function () {
            var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(issues) {
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 3:
                                ...
                                _transform = (0, _transform4.default)(result, function (_ref4, value, key) {
                                ...
                                }, [[], []]), _transform2 = (0, _slicedToArray3.default)(_transform, 2), resolutions = _transform2[0], errors = _transform2[1];


                                _this.setState({ resolutions: resolutions, errors: errors });
                                _context2.next = 11;
                                break;
                            ...
                            case 8:
                                ...
                                _this.setState({ errors: ['Error obtaining resolution information. Please try again later.'] });
        ...
        _this.closeWizard = function (submitted) {
            ...
            if (submitted) {
                ...
                (isNewSwitch ? _this.createRemediation : _this.updateRemediation)({ issues: issues, systems: systems }, _this.resolver(open.deferred));
            } else {
        ...
        _this.createRemediation = function (add, resolver) {
            var name = _this.state.name || 'Unnamed Playbook';

            return api.createRemediation({ name: name, add: add, auto_reboot: _this.state.autoRebootSwitch }, _this.state.open.basePath).then(function (_ref7) {
                var id = _ref7.id;
                return resolver(id, name, true);
            });
        };

        _this.updateRemediation = function (add, resolver) {
            var _this$state$selectedR = _this.state.selectedRemediation,
                id = _this$state$selectedR.id,
                name = _this$state$selectedR.name;


            return api.patchRemediation(id, { add: add, auto_reboot: _this.state.autoRebootSwitch }, _this.state.open.basePath).then(function () {
                return resolver(id, name, false);
            });
        };

        _this.resolver = function (deferred) {
            return function (id, name, isNewSwitch) {
                deferred.resolve({
                    remediation: { id: id, name: name },
        ...
        _this.getMultiResolutionIssues = function () {
        ...
        _this.onIsNewSwitch = function (isNewSwitch) {
            return _this.setState({
        ...
        _this.onRemediationSelected = function (id) {
            _this.setState({ selectedRemediationId: id, selectedRemediation: false });
            if (id) {
                api.getRemediation(id).then(function (remediation) {
                    if (remediation.id === _this.state.selectedRemediationId) {
                        _this.setState({ selectedRemediation: remediation });
                    }
                });
            }
        };

        _this.onManualResolutionSwitch = function (manualResolutionSelection) {
            return _this.setState({ manualResolutionSelection: manualResolutionSelection });
        };

        _this.onAutoRebootSwitch = function (autoRebootSwitch) {
            return _this.setState({ autoRebootSwitch: autoRebootSwitch });
        };

        _this.onResolutionSwitch = function (issueId, resolutionId) {
            return _this.setState({
                selectedResolutions: (0, _extends4.default)({}, _this.state.selectedResolutions, (0, _defineProperty3.default)({}, issueId, resolutionId))
            });
        };

        _this.onValidChange = function (valid) {
            return _this.setState({ valid: valid });
        };
        ...
        _this.buildSteps = function () {
            ...
            var steps = [_react2.default.createElement(_ExistingOrNew2.default, {
            ...
            if (!_this.resolutionsLoaded() || !_this.selectedRemediationLoaded()) {
                steps.push(_react2.default.createElement(_LoadingStep2.default, { key: 'LoadingStep', onValidChange: _this.onValidChange }));
                return steps;
            }

            // no valid resolutions
            if (_this.state.errors.length) {
                steps.push(_react2.default.createElement(_ErrorStep2.default, { key: 'ErrorStep', errors: _this.state.errors, onValidChange: _this.onValidChange }));
                return steps;
            }
            ...
            if (multiResolutionIssues.length) {
                steps.push(_react2.default.createElement(_ResolutionModeStep2.default, {
            ...
            if (_this.state.manualResolutionSelection) {
                steps.push.apply(steps, (0, _toConsumableArray3.default)(multiResolutionIssues.map(function (issue) {
                    return _react2.default.createElement(_IssueResolutionStep2.default, { key: issue.id, issue: issue, state: _this.state, onResolutionSwitch: _this.onResolutionSwitch });
                })));
            }

            steps.push(_react2.default.createElement(_SummaryStep2.default, {
                key: 'SummaryStep',
                state: _this.state,
                getResolution: _this.getResolution,
    ...
    (0, _createClass3.default)(RemediationWizard, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_Wizard.Wizard, {
                isLarge: true,
...
exports.default = RemediationWizard;

/***/ }),

/***/ "./src/SmartComponents/Remediations/RemediationWizard.scss":
/*!*****************************************************************!*\
  !*** ./src/SmartComponents/Remediations/RemediationWizard.scss ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./src/SmartComponents/Remediations/index.js":
/*!***************************************************!*\
  !*** ./src/SmartComponents/Remediations/index.js ***!
  \***************************************************/
/*! no static exports found */
...
exports.RemediationWizard = undefined;
exports.openWizard = openWizard;

var _validator = __webpack_require__(/*! ./validator */ "./src/SmartComponents/Remediations/validator.js");

var _validator2 = _interopRequireDefault(_validator);

var _RemediationWizard = __webpack_require__(/*! ./RemediationWizard */ "./src/SmartComponents/Remediations/RemediationWizard.js");

var _RemediationWizard2 = _interopRequireDefault(_RemediationWizard);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.RemediationWizard = _RemediationWizard2.default;
...
/***/ "./src/SmartComponents/Remediations/steps/ErrorStep.js":
/*!*************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/ErrorStep.js ***!
  \*************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./ErrorStep.scss */ "./src/SmartComponents/Remediations/steps/ErrorStep.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ErrorStep = function (_PureComponent) {
    (0, _inherits3.default)(ErrorStep, _PureComponent);

    function ErrorStep() {
        (0, _classCallCheck3.default)(this, ErrorStep);
        return (0, _possibleConstructorReturn3.default)(this, (ErrorStep.__proto__ || Object.getPrototypeOf(ErrorStep)).apply(this, arguments));
    }

    (0, _createClass3.default)(ErrorStep, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
...
ErrorStep.propTypes = {
    ...
    onValidChange: _propTypes2.default.func.isRequired
};
...
/***/ "./src/SmartComponents/Remediations/steps/ErrorStep.scss":
/*!***************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/ErrorStep.scss ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/SmartComponents/Remediations/steps/ExistingOrNew.js":
/*!*****************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/ExistingOrNew.js ***!
  \*****************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./ExistingOrNew.scss */ "./src/SmartComponents/Remediations/steps/ExistingOrNew.scss");
...
function ExistingOrNewStep(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'ins-c-existing-or-new__existing' },
                ...
                existingRemediations === false && _react2.default.createElement(_Skeleton.Skeleton, { size: _Skeleton.SkeletonSize.xs }),
                existingRemediations && _react2.default.createElement(
                    ...
                    existingRemediations.length ? existingRemediations.map(function (_ref) {
                        var id = _ref.id,
                            name = _ref.name;
                        return _react2.default.createElement(_reactCore.FormSelectOption, { key: id, value: id, label: name });
                    }) : _react2.default.createElement(_reactCore.FormSelectOption, { key: 'empty', value: 'empty', label: 'No exising Playbooks' })
                )
            ),
            _react2.default.createElement(_reactCore.Radio, {
                label: 'New Playbook',
...
ExistingOrNewStep.displayName = 'ExistingOrNewStep';
ExistingOrNewStep.propTypes = {
    state: _propTypes2.default.object.isRequired,
    onNameChange: _propTypes2.default.func.isRequired,
    onIsNewSwitch: _propTypes2.default.func.isRequired,
    onRemediationSelected: _propTypes2.default.func.isRequired
};

exports.default = ExistingOrNewStep;

/***/ }),

/***/ "./src/SmartComponents/Remediations/steps/ExistingOrNew.scss":
/*!*******************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/ExistingOrNew.scss ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/SmartComponents/Remediations/steps/IssueResolutionStep.js":
/*!***********************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/IssueResolutionStep.js ***!
  \***********************************************************************/
/*! no static exports found */
...
var _Reboot = __webpack_require__(/*! ../../../PresentationalComponents/Reboot */ "./src/PresentationalComponents/Reboot/index.js");

var _Battery = __webpack_require__(/*! ../../../PresentationalComponents/Battery */ "./src/PresentationalComponents/Battery/index.js");

__webpack_require__(/*! ./IssueResolutionStep.scss */ "./src/SmartComponents/Remediations/steps/IssueResolutionStep.scss");
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'h2',
                null,
                'Please review the available resolution steps and make your selection:'
            )
        ),
        _react2.default.createElement(
            _reactCore.StackItem,
            ...
            _react2.default.createElement(
                _reactCore.Form,
                null,
                props.issue.resolutions.map(function (resolution, i) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'ins-c-resolution-option', key: resolution.id },
                        _react2.default.createElement(_reactCore.Radio, {
                            label: _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    resolution.needs_reboot && _react2.default.createElement(
                                        _reactCore.StackItem,
                                        null,
                                        _react2.default.createElement(_Reboot.Reboot, { red: true })
                                    )
                                )
                            ),
...
IssueResolutionStep.displayName = 'IssueResolutionStep';
IssueResolutionStep.propTypes = {
    issue: _propTypes2.default.object.isRequired,
    state: _propTypes2.default.object.isRequired,
    onResolutionSwitch: _propTypes2.default.func.isRequired
};

exports.default = IssueResolutionStep;

/***/ }),

/***/ "./src/SmartComponents/Remediations/steps/IssueResolutionStep.scss":
/*!*************************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/IssueResolutionStep.scss ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./src/SmartComponents/Remediations/steps/IssueTable.js":
/*!**************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/IssueTable.js ***!
  \**************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./IssueTable.scss */ "./src/SmartComponents/Remediations/steps/IssueTable.scss");
...
function buildRows(issues, state, getResolution) {
    return issues.map(function (issue) {
        ...
        return {
            cells: [state.issuesById[issue.id].description, resolution.description, resolution.needs_reboot ? 'true' : 'false', getSystemCount(issue, state), issueType(issue.id)]
        };
    });
}
...
var IssueTable = function (_React$Component) {
    (0, _inherits3.default)(IssueTable, _React$Component);

    function IssueTable(props) {
        (0, _classCallCheck3.default)(this, IssueTable);

        var _this = (0, _possibleConstructorReturn3.default)(this, (IssueTable.__proto__ || Object.getPrototypeOf(IssueTable)).call(this, props));

        _this.onSort = function (event, sortBy, sortDir) {
            return _this.setState({ sortBy: sortBy, sortDir: sortDir });
        };
    ...
    (0, _createClass3.default)(IssueTable, [{
        key: 'render',
        value: function render() {
            ...
            var sorted = (0, _orderBy2.default)(rows, function (r) {
                return r.cells[sortBy];
            }, [this.state.sortDir]);
...
IssueTable.propTypes = {
    ...
    getResolution: _propTypes2.default.func.isRequired,
    state: _propTypes2.default.object.isRequired
};
...
/***/ "./src/SmartComponents/Remediations/steps/IssueTable.scss":
/*!****************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/IssueTable.scss ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "./src/SmartComponents/Remediations/steps/LoadingStep.js":
/*!***************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/LoadingStep.js ***!
  \***************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./LoadingStep.scss */ "./src/SmartComponents/Remediations/steps/LoadingStep.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var LoadingStep = function (_PureComponent) {
    (0, _inherits3.default)(LoadingStep, _PureComponent);

    function LoadingStep() {
        (0, _classCallCheck3.default)(this, LoadingStep);
        return (0, _possibleConstructorReturn3.default)(this, (LoadingStep.__proto__ || Object.getPrototypeOf(LoadingStep)).apply(this, arguments));
    }

    (0, _createClass3.default)(LoadingStep, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.props.onValidChange(false);
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                _reactCore.Stack,
                { gutter: 'sm', className: 'ins-c-remediations-loading-step' },
                _react2.default.createElement(
                    _reactCore.StackItem,
                    null,
                    _react2.default.createElement(
                        'h1',
                        null,
                        _react2.default.createElement(_Skeleton.Skeleton, { size: _Skeleton.SkeletonSize.sm })
                    )
                ),
                _react2.default.createElement(
                    _reactCore.StackItem,
                    null,
                    _react2.default.createElement(_Skeleton.Skeleton, { size: _Skeleton.SkeletonSize.lg, className: 'ins-c-remediations-loading-step-main' })
                ),
                _react2.default.createElement(
                    _reactCore.StackItem,
                    null,
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _reactCore.StackItem,
                            null,
                            _react2.default.createElement(_Skeleton.Skeleton, { size: _Skeleton.SkeletonSize.xs })
                        )
                    )
                )
            );
...
/***/ "./src/SmartComponents/Remediations/steps/LoadingStep.scss":
/*!*****************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/LoadingStep.scss ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./src/SmartComponents/Remediations/steps/ResolutionModeStep.js":
/*!**********************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/ResolutionModeStep.js ***!
  \**********************************************************************/
/*! no static exports found */
...
var _IssueTable = __webpack_require__(/*! ./IssueTable */ "./src/SmartComponents/Remediations/steps/IssueTable.js");
...
function ResolutionModeStep(props) {
    ...
    var LABEL_MANUAL = 'Review and/or change resolution steps for ' + these(tweakableCount) + ' ' + tweakableCount + ' ' + actions(tweakableCount);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                ' ',
                actions(issueCount),
                ' to be added to your Playbook.\xA0',
                tweakableCount,
                ' out of ',
                issueCount,
                ' ',
                actions(issueCount),
                ' ',
                allows(tweakableCount),
                '\xA0 you to choose from multiple resolution steps.'
            )
        ),
        _react2.default.createElement(
            _reactCore.StackItem,
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(_IssueTable2.default, { issues: props.multiResolutionIssues, state: props.state, getResolution: props.getResolution }),
                _react2.default.createElement(_reactCore.Radio, {
...
ResolutionModeStep.displayName = 'ResolutionModeStep';
ResolutionModeStep.propTypes = {
    multiResolutionIssues: _propTypes2.default.array.isRequired,
    state: _propTypes2.default.object.isRequired,
    getResolution: _propTypes2.default.func.isRequired,
    onManualResolutionSwitch: _propTypes2.default.func.isRequired
};

exports.default = ResolutionModeStep;

/***/ }),

/***/ "./src/SmartComponents/Remediations/steps/SummaryStep.js":
/*!***************************************************************!*\
  !*** ./src/SmartComponents/Remediations/steps/SummaryStep.js ***!
  \***************************************************************/
/*! no static exports found */
...
function SummaryStep(props) {
    var _props$state = props.state,
        autoRebootSwitch = _props$state.autoRebootSwitch,
        autoRebootSwitchDisabled = _props$state.autoRebootSwitchDisabled;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            _reactCore.StackItem,
            null,
            _react2.default.createElement(_IssueTable2.default, { issues: props.state.open.data.issues, state: props.state, getResolution: props.getResolution })
        ),
        _react2.default.createElement(
            _reactCore.StackItem,
            null,
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    rebootNeeded ? _react2.default.createElement(
                        'h1',
                        null,
                        ...
                        'h1',
                        null,
                        'The remediation does not require reboot'
                    )
                ),
                _react2.default.createElement(
                    _reactCore.StackItem,
                    null,
                    _react2.default.createElement(_reactCore.Switch, {
                        id: 'autoReboot',
...
SummaryStep.propTypes = {
    state: _propTypes2.default.object.isRequired,
    getResolution: _propTypes2.default.func.isRequired,
    onAutoRebootSwitch: _propTypes2.default.func.isRequired
};
...
/***/ "./src/SmartComponents/Remediations/utils.js":
/*!***************************************************!*\
  !*** ./src/SmartComponents/Remediations/utils.js ***!
  \***************************************************/
/*! no static exports found */
...
function remediationUrl(id) {
    return (0, _urijs2.default)(document.baseURI).segment('platform').segment('remediations').segment(id).toString();
}

/***/ }),

/***/ "./src/SmartComponents/Remediations/validator.js":
/*!*******************************************************!*\
  !*** ./src/SmartComponents/Remediations/validator.js ***!
  \*******************************************************/
/*! no static exports found */
...
function checkAllowedKeys(reference) {
    ...
    Object.keys(reference).forEach(function (key) {
        return assert(keys.includes(key), 'Unexpected key: ' + key + ' Expected one of: ' + keys);
    });
}
...
function checkRequiredKeys(reference) {
    ...
    keys.forEach(function (key) {
        return assert(reference.hasOwnProperty(key), 'Required key missing: ' + key);
    });
}
...
function validate(data) {
    assert((typeof data === 'undefined' ? 'undefined' : (0, _typeof3.default)(data)) === 'object' && data !== null);
    ...
    data.issues.forEach(function (issue) {
        assert((typeof issue === 'undefined' ? 'undefined' : (0, _typeof3.default)(issue)) === 'object' && issue !== null, 'Issue must be an object');
...
var API_BASE = '/r/insights/platform/remediations/v1';

function checkResponse(r) {
    if (!r.ok) {
        var error = new Error('Unexpected response code ' + r.status);
...
function createRemediation(data) {
    ...
    var uri = new _urijs2.default(API_BASE).segment('remediations').toString();
    return fetch(uri, {
        headers: headers,
        method: 'POST',
        credentials: 'include',
...
function patchRemediation(id, data) {
    ...
    var uri = new _urijs2.default(API_BASE).segment('remediations').segment(id).toString();
    return fetch(uri, {
        headers: headers,
        credentials: 'include',
        method: 'PATCH',
...
function getResolutionsBatch(issues) {
    ...
    var uri = new _urijs2.default(API_BASE).segment('resolutions').toString();
    return fetch(uri, {
        headers: headers,
        credentials: 'include',
        method: 'POST',
...
},{"@patternfly/react-core":"Tk4w","@patternfly/react-icons":"k73M","classnames":"kpqe","react":"ccIB","process":"rH1J","buffer":"8fe9"}]},{},[], null)
//# sourceMappingURL=/insightsbeta/static/chrome/js/Remediations.8ff5425a.map
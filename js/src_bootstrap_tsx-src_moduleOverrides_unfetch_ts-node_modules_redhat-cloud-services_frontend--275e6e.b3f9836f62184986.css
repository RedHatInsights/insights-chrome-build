...
.chr-c-alert .pf-c-button.pf-m-plain {
...
.chr-c-masthead .pf-c-toolbar__item .pf-c-notification-badge.pf-m-unread {
  --pf-c-notification-badge--after--BackgroundColor: var(--pf-global--palette--red-100);
}
.chr-c-masthead .pf-c-toolbar__item .pf-c-notification-badge.pf-m-unread:hover {
  --pf-c-notification-badge--after--BackgroundColor: var(--pf-global--palette--red-200);
}
/*!************************************************************************************************************************************************************************************************************************************!*\
...
.chr-c-search__menu .pf-c-menu__group-title {
  padding-bottom: var(--pf-global--spacer--md);
}
.chr-c-search__menu .pf-c-menu__group-title:empty {
  display: none;
}
...
.chr-c-breadcrumbs .pf-c-masthead__toggle button {
  padding-top: 0;
}
...
.chr-c-all-services .chr-c-all-services-filter .pf-c-text-input-group__icon {
  display: none;
}

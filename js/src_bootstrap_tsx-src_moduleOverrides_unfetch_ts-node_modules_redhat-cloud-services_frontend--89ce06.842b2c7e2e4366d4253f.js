(self["webpackChunkinsights_chrome"] = self["webpackChunkinsights_chrome"] || []).push([["src_bootstrap_tsx-src_moduleOverrides_unfetch_ts-node_modules_redhat-cloud-services_frontend--89ce06"],{
...
/* harmony import */ var _jwt_jwt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../jwt/jwt */ "./src/jwt/jwt.ts");
...
function bouncer() {
    if (!_jwt_jwt__WEBPACK_IMPORTED_MODULE_1__.isAuthenticated()) {
        js_cookie__WEBPACK_IMPORTED_MODULE_2__.default.remove(_utils_consts__WEBPACK_IMPORTED_MODULE_3__.defaultAuthOptions.cookieName);
...
function crossAccountBouncer() {
    const requestCookie = js_cookie__WEBPACK_IMPORTED_MODULE_2__.default.get(_utils_consts__WEBPACK_IMPORTED_MODULE_3__.CROSS_ACCESS_ACCOUNT_NUMBER);
    if (requestCookie) {
    ...
    js_cookie__WEBPACK_IMPORTED_MODULE_2__.default.remove(_utils_consts__WEBPACK_IMPORTED_MODULE_3__.CROSS_ACCESS_ACCOUNT_NUMBER);
    js_cookie__WEBPACK_IMPORTED_MODULE_2__.default.remove(_utils_consts__WEBPACK_IMPORTED_MODULE_3__.CROSS_ACCESS_ORG_ID);
...
/* harmony import */ var _chrome_create_chrome__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./chrome/create-chrome */ "./src/chrome/create-chrome.ts");
/* harmony import */ var _analytics_analyticsObserver__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./analytics/analyticsObserver */ "./src/analytics/analyticsObserver.ts");
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils/common */ "./src/utils/common.ts");
/* harmony import */ var _locales_data_json__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./locales/data.json */ "./src/locales/data.json");
/* harmony import */ var _components_ErrorComponents_ErrorBoundary__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/ErrorComponents/ErrorBoundary */ "./src/components/ErrorComponents/ErrorBoundary.tsx");
/* harmony import */ var _components_LibJWTContext__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/LibJWTContext */ "./src/components/LibJWTContext/index.ts");
...
const libjwtSetup = (chromeConfig, setReadyState) => {
    ...
    libjwt.initPromise.then(() => {
        return libjwt.jwt
            ...
            .catch(_utils_common__WEBPACK_IMPORTED_MODULE_12__.noop);
    });
    return libjwt;
};
const App = () => {
    ...
    const [jwtState, setJwtState] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
    const [libjwt, setLibjwt] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)();
    const store = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useStore)();
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        (0,_utils_common__WEBPACK_IMPORTED_MODULE_12__.loadFedModules)().then(({ data }) => {
            const { chrome: chromeConfig } = data;
            dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_5__.loadModulesSchema)(data));
            ...
            window.insights = (0,_chrome_create_chrome__WEBPACK_IMPORTED_MODULE_10__.default)(libjwt, window.insights, data, store);
            setLibjwt(libjwt);
        });
        if (typeof window._satellite !== 'undefined' && typeof window._satellite.pageBottom === 'function') {
            window._satellite.pageBottom();
            (0,_analytics_analyticsObserver__WEBPACK_IMPORTED_MODULE_11__.default)();
        }
        (0,_utils_common__WEBPACK_IMPORTED_MODULE_12__.trustarcScriptSetup)();
    }, []);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const title = typeof documentTitle === 'string' ? `${documentTitle} | ` : '';
        document.title = `${title}console.redhat.com`;
    }, [documentTitle]);
    return modules && scalprumConfig && jwtState && libjwt ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_LibJWTContext__WEBPACK_IMPORTED_MODULE_15__.default.Provider, { value: libjwt },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_RootApp__WEBPACK_IMPORTED_MODULE_4__.default, { config: scalprumConfig }),
        ' ')) : null;
};
react_dom__WEBPACK_IMPORTED_MODULE_1___default().render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_16__.default, { locale: language, messages: _locales_data_json__WEBPACK_IMPORTED_MODULE_13__[language], onError: (error) => {
        if (((0,_utils_common__WEBPACK_IMPORTED_MODULE_12__.getEnv)() === 'stage' && !window.location.origin.includes('foo')) ||
            localStorage.getItem('chrome:intl:debug') === 'true' ||
            !(error.code === react_intl__WEBPACK_IMPORTED_MODULE_17__.IntlErrorCode.MISSING_TRANSLATION)) {
            console.error(error);
        }
    } },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_redux__WEBPACK_IMPORTED_MODULE_2__.Provider, { store: (0,_redux_redux_config__WEBPACK_IMPORTED_MODULE_3__.spinUpStore)()?.store },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ErrorComponents_ErrorBoundary__WEBPACK_IMPORTED_MODULE_14__.default, null,
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _utils_iqeEnablement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/iqeEnablement */ "./src/utils/iqeEnablement.ts");
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./entry */ "./src/chrome/entry.ts");
/* harmony import */ var _jwt_initialize_jwt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../jwt/initialize-jwt */ "./src/jwt/initialize-jwt.ts");
/* harmony import */ var _auth_fetchPermissions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth/fetchPermissions */ "./src/auth/fetchPermissions.ts");
...
const createChromeInstance = (jwt, insights, globalConfig, store) => {
    ...
    _utils_iqeEnablement__WEBPACK_IMPORTED_MODULE_0__.default.init(store);
    const jwtResolver = (0,_jwt_initialize_jwt__WEBPACK_IMPORTED_MODULE_2__.default)(libjwt, chromeInstance);
    const init = () => {
        /**
    ...
    const fetchPermissions = bufferAsyncFunction((0,_auth_fetchPermissions__WEBPACK_IMPORTED_MODULE_3__.createFetchPermissionsWatcher)());
...
/* harmony import */ var _utils_iqeEnablement__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/iqeEnablement */ "./src/utils/iqeEnablement.ts");
/* harmony import */ var _utils_consts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/consts */ "./src/utils/consts.ts");
...
/* harmony import */ var _utils_createCase__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/createCase */ "./src/utils/createCase.ts");
/* harmony import */ var _redux_action_types__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../redux/action-types */ "./src/redux/action-types.ts");
/* harmony import */ var _components_GlobalFilter_globalFilterApi__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/GlobalFilter/globalFilterApi */ "./src/components/GlobalFilter/globalFilterApi.ts");
/* harmony import */ var _utils_debugFunctions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/debugFunctions */ "./src/utils/debugFunctions.ts");
...
function chromeInit() {
    const { store, actions, middlewareListener } = (0,_redux_redux_config__WEBPACK_IMPORTED_MODULE_1__.spinUpStore)();
    // public API actions
    ...
    return {
        ...
        identifyApp: (_data, appTitle, noSuffix) => {
            (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.updateDocumentTitle)(appTitle, noSuffix);
            return Promise.resolve();
        },
        mapGlobalFilter: _components_GlobalFilter_globalFilterApi__WEBPACK_IMPORTED_MODULE_10__.flatTags,
        ...
        updateDocumentTitle: _utils_common__WEBPACK_IMPORTED_MODULE_6__.updateDocumentTitle,
        $internal: { store },
    };
}
function bootstrap(libjwt, initFunc, getUser, globalConfig) {
    const { store } = (0,_redux_redux_config__WEBPACK_IMPORTED_MODULE_1__.spinUpStore)();
    return {
        chrome: {
            auth: {
                ...
                getUser,
                qe: {
                    ..._utils_iqeEnablement__WEBPACK_IMPORTED_MODULE_2__.default,
                    init: () => _utils_iqeEnablement__WEBPACK_IMPORTED_MODULE_2__.default.init(store),
                },
                logout: (bounce) => libjwt.jwt.logoutAllTabs(bounce),
                login: () => libjwt.jwt.login(),
            },
            isProd: () => (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.isProd)(),
            isBeta: _utils_common__WEBPACK_IMPORTED_MODULE_6__.isBeta,
            ...
            getBundle: () => (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.getUrl)('bundle'),
            getApp: () => (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.getUrl)('app'),
            getEnvironment: () => (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.getEnv)(),
            getEnvironmentDetails: () => (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.getEnvDetails)(),
            createCase: (fields) => window.insights.chrome.auth.getUser().then((user) => (0,_utils_createCase__WEBPACK_IMPORTED_MODULE_8__.createSupportCase)(user.identity, libjwt, fields)),
            visibilityFunctions: _utils_consts__WEBPACK_IMPORTED_MODULE_3__.visibilityFunctions,
            init: initFunc,
            isChrome2: true,
            enable: _utils_debugFunctions__WEBPACK_IMPORTED_MODULE_11__.default,
            globalConfig,
        },
        experimental: {},
    };
...
/* harmony import */ var _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/loading-fallback */ "./src/utils/loading-fallback.tsx");
...
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../redux/actions */ "./src/redux/actions.ts");
/* harmony import */ var _ErrorComponents_DefaultErrorComponent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../ErrorComponents/DefaultErrorComponent */ "./src/components/ErrorComponents/DefaultErrorComponent.tsx");
/* harmony import */ var _analytics__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../analytics */ "./src/analytics/index.ts");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _patternfly_quickstarts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @patternfly/quickstarts */ "webpack/sharing/consume/default/@patternfly/quickstarts/@patternfly/quickstarts");
/* harmony import */ var _patternfly_quickstarts__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_patternfly_quickstarts__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _ErrorComponents_GatewayErrorComponent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../ErrorComponents/GatewayErrorComponent */ "./src/components/ErrorComponents/GatewayErrorComponent.tsx");
...
const ChromeRoute = (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(({ scope, module, scopeClass, ...props }) => {
    const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useDispatch)();
    const { setActiveHelpTopicByName } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_patternfly_quickstarts__WEBPACK_IMPORTED_MODULE_9__.HelpTopicContext);
    const user = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useSelector)(({ chrome: { user } }) => user);
    const gatewayError = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useSelector)(({ chrome: { gatewayError } }) => gatewayError);
    /**
     * If default title was not set, use module scope (appId)
     */
    const defaultTitle = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useSelector)(({ chrome: { modules } }) => modules?.[scope]?.defaultDocumentTitle || scope);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.batch)(() => {
            dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_5__.changeActiveModule)(scope));
            /**
             * Default document title update. If application won't update its title chrome sets a title using module config
             */
            dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_5__.updateDocumentTitle)(defaultTitle));
        });
        /**
         * update pendo metadata on application change
         */
        try {
            window?.pendo?.updateOptions((0,_analytics__WEBPACK_IMPORTED_MODULE_7__.getPendoConf)(user));
        }
        catch (error) {
        ...
        return () => {
             ...
             */
            dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_5__.toggleGlobalFilter)(false));
        };
    }, [scope]);
    if (gatewayError) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ErrorComponents_GatewayErrorComponent__WEBPACK_IMPORTED_MODULE_10__.default, { error: gatewayError });
    }
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Route, { key: props.path, ...props },
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: classnames__WEBPACK_IMPORTED_MODULE_8___default()(scopeClass, scope) },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_scalprum_react_core__WEBPACK_IMPORTED_MODULE_0__.ScalprumComponent, { ErrorComponent: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ErrorComponents_DefaultErrorComponent__WEBPACK_IMPORTED_MODULE_6__.default, null), appName: scope, fallback: _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_3__.default, LoadingComponent: () => _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_3__.default, scope: scope, module: module }))));
}, 
...
const Feedback = ({ user, onCloseModal, onSubmit }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "chr-c-feedback-content" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextVariants.h1 }, intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.shareYourFeedback))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Form, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.FormGroup, { label: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.enterFeedback), fieldId: "horizontal-form-exp" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.FormGroup, { className: "pf-u-mt-20" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Checkbox, { id: "feedback-checkbox", isChecked: checked, onChange: () => setChecked(!checked), label: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.researchOpportunities), description: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.learnAboutResearchOpportunities) }))),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "chr-c-feedback-buttons" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { ouiaId: "submit-feedback", key: "confirm", variant: "primary", onClick: handleModalSubmission }, intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.submitFeedback)),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { ouiaId: "cancel-feedback", key: "cancel", variant: "link", onClick: onCloseModal }, intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.cancel)))));
};
...
/* harmony import */ var _Feedback__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Feedback */ "./src/components/Feedback/Feedback.tsx");
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../redux/actions */ "./src/redux/actions.ts");
...
/* harmony import */ var _Feedback_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Feedback.scss */ "./src/components/Feedback/Feedback.scss");
                ...
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "chr-c-feedback-content" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "chr-c-feedback-cards" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Card, { isSelectableRaised: true, isCompact: true, onClick: () => setModalPage('feedbackOne') },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardBody, null, `${intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.tellAboutExperience)} ${intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.orShareIdeas)}`)),
...
const FeedbackSuccess = ({ onCloseModal }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "chr-c-feedback-success-content" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextVariants.h1 }, intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.feedbackSent)),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, null, intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_2__.default.thankYouForFeedback))),
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "webpack/sharing/consume/default/react-redux/react-redux");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _redhat_cloud_services_frontend_components_FilterHooks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components/FilterHooks */ "./node_modules/@redhat-cloud-services/frontend-components/esm/FilterHooks/tagFilterHook.js");
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../redux/actions */ "./src/redux/actions.ts");
...
const useLoadTags = (hasAccess = false) => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((activeTags, search) => {
        (0,_filterApi__WEBPACK_IMPORTED_MODULE_6__.storeFilter)(activeTags, hasAccess && !isDisabled, history);
...
const GlobalFilter = ({ hasAccess }) => {
    ...
    const isDisabled = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useSelector)(({ globalFilter: { globalFilterHidden }, chrome: { appId } }) => globalFilterHidden || !appId);
    const { filter, chips, selectedTags, setValue, filterTagsBy } = (0,_redhat_cloud_services_frontend_components_FilterHooks__WEBPACK_IMPORTED_MODULE_7__.useTagsFilter)([workloads, ...sid, ...tags], isLoaded, total - count, (_e, closeFn) => {
        setIsOpen(() => true);
        closeFn && closeFn();
...
GlobalFilter.propTypes = {
    hasAccess: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().bool),
};
const GlobalFilterWrapper = () => {
    ...
    return userLoaded ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(GlobalFilter, { hasAccess: hasAccess }) : null;
};
...
/* harmony import */ var _redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../redux/globalFilterReducers */ "./src/redux/globalFilterReducers.ts");
...
const generateFilter = () => {
    ...
    if ((0,_utils_common__WEBPACK_IMPORTED_MODULE_4__.getUrl)('bundle') === 'ansible') {
...
/* harmony import */ var _redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../redux/globalFilterReducers */ "./src/redux/globalFilterReducers.ts");
/* eslint-disable camelcase */




const tags = new _redhat_cloud_services_host_inventory_client__WEBPACK_IMPORTED_MODULE_1__.TagsApi(undefined, _globalFilterApi__WEBPACK_IMPORTED_MODULE_0__.INVENTORY_API_BASE, _redhat_cloud_services_frontend_components_utilities_interceptors__WEBPACK_IMPORTED_MODULE_3__.default);
const sap = new _redhat_cloud_services_host_inventory_client__WEBPACK_IMPORTED_MODULE_1__.SapSystemApi(undefined, _globalFilterApi__WEBPACK_IMPORTED_MODULE_0__.INVENTORY_API_BASE, _redhat_cloud_services_frontend_components_utilities_interceptors__WEBPACK_IMPORTED_MODULE_3__.default);
const system = new _redhat_cloud_services_host_inventory_client__WEBPACK_IMPORTED_MODULE_1__.HostsApi(undefined, _globalFilterApi__WEBPACK_IMPORTED_MODULE_0__.INVENTORY_API_BASE, _redhat_cloud_services_frontend_components_utilities_interceptors__WEBPACK_IMPORTED_MODULE_3__.default);
/**
...
const FeedbackRoute = ({ user }) => {
    const path = localStorage.getItem('chrome:experimental:feedback') === 'true'
        ? '*'
        : ['/insights', '/settings', '/openshift', '/application-services', '/ansible', '/edge'];
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_12__.Route, { path: path },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Feedback__WEBPACK_IMPORTED_MODULE_7__.default, { user: user })));
};
const Header = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.MastheadMain, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.MastheadBrand, { component: (props) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink_ChromeLink__WEBPACK_IMPORTED_MODULE_11__.default, { ...props, appId: "landing", href: "/" }) },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.MastheadContent, null,
            user?.identity?.account_number && react_dom__WEBPACK_IMPORTED_MODULE_1___default().createPortal(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FeedbackRoute, { user: user }), document.body),
...
const RootApp = (props) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Router, { history: _utils_chromeHistory__WEBPACK_IMPORTED_MODULE_3__.default },
...
/* harmony import */ var _layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../layouts/DefaultLayout */ "./src/layouts/DefaultLayout.tsx");
/* harmony import */ var _Navigation_Loader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Navigation/Loader */ "./src/components/Navigation/Loader.tsx");
/* harmony import */ var _Feedback__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Feedback */ "./src/components/Feedback/index.ts");
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../redux/actions */ "./src/redux/actions.ts");
...
/* harmony import */ var _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../utils/isAnsibleTrialFlagActive */ "./src/utils/isAnsibleTrialFlagActive.ts");
...
const Navigation = (0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-router_esm_react-router_js"), __webpack_require__.e("src_components_Navigation_componentMapper_ts"), __webpack_require__.e("src_components_Navigation_index_tsx")]).then(__webpack_require__.bind(__webpack_require__, /*! ../Navigation */ "./src/components/Navigation/index.tsx")));
const LandingNav = (0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-router_esm_react-router_js"), __webpack_require__.e("src_components_Navigation_componentMapper_ts"), __webpack_require__.e("src_components_LandingNav_index_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../LandingNav */ "./src/components/LandingNav/index.ts")));
...
const loaderWrapper = (Component, props = {}) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Navigation_Loader__WEBPACK_IMPORTED_MODULE_6__.default, null) },
...
const ScalprumRoot = ({ config, helpTopicsAPI, quickstartsAPI, ...props }) => {
    const { setActiveHelpTopicByName, helpTopics, activeHelpTopic } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_patternfly_quickstarts__WEBPACK_IMPORTED_MODULE_4__.HelpTopicContext);
    ...
    const globalFilterRemoved = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)(({ globalFilter: { globalFilterRemoved } }) => globalFilterRemoved);
    const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useDispatch)();
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const unregister = history.listen(_utils_historyListener__WEBPACK_IMPORTED_MODULE_9__.default);
        return () => {
    ...
    const scalprumProviderProps = {
        config,
        api: {
            chrome: {
                ...window.insights.chrome,
                experimentalApi: true,
                isFedramp: (0,_utils_common__WEBPACK_IMPORTED_MODULE_10__.isFedRamp)(),
                usePendoFeedback: _Feedback__WEBPACK_IMPORTED_MODULE_7__.usePendoFeedback,
                segment: {
                    setPageMetadata,
                },
                toggleFeedbackModal: (...args) => dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_8__.toggleFeedbackModal)(...args)),
                ...
                clearAnsibleTrialFlag: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_13__.clearAnsibleTrialFlag,
                isAnsibleTrialFlagActive: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_13__.isAnsibleTrialFlagActive,
                setAnsibleTrialFlag: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_13__.setAnsibleTrialFlag,
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_scalprum_react_core__WEBPACK_IMPORTED_MODULE_1__.ScalprumProvider, { ...scalprumProviderProps },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Switch, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { exact: true, path: "/" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_5__.default, { Sidebar: loaderWrapper(LandingNav), ...props, globalFilterRemoved: globalFilterRemoved })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { exact: true, path: "/connect/products" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_12__.default },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ProductSelection, null))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/connect" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_5__.default, { ...props, globalFilterRemoved: globalFilterRemoved })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/security" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_5__.default, { ...props, globalFilterRemoved: globalFilterRemoved })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_5__.default, { Sidebar: loaderWrapper(Navigation), ...props, globalFilterRemoved: globalFilterRemoved })))));
};
...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-router-dom */ "webpack/sharing/consume/default/react-router-dom/react-router-dom");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_router_dom__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _ChromeRoute_ChromeRoute__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ChromeRoute/ChromeRoute */ "./src/components/ChromeRoute/ChromeRoute.tsx");
...
/* harmony import */ var _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils/loading-fallback */ "./src/utils/loading-fallback.tsx");
...
const Routes = ({ routesProps }) => {
    ...
    if ((0,_utils_common__WEBPACK_IMPORTED_MODULE_5__.isFedRamp)()) {
        list = list.filter((list) => list.isFedramp);
    }
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Switch, null,
        showBundleCatalog && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Route, { exact: true, path: "/([^\\/]+)/quickstarts" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_6__.default },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(QuickstartCatalogRoute, null)))),
        redirects.map(({ path, to }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Route, { key: path, exact: true, path: path },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Redirect, { to: to })))),
        list.map((app) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeRoute_ChromeRoute__WEBPACK_IMPORTED_MODULE_3__.default, { key: app.path, ...routesProps, ...app }))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Route, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_NotFoundRoute__WEBPACK_IMPORTED_MODULE_4__.default, null))));
};
...
const doOffline = (key, val, configSsoUrl) => {
    ...
    Promise.resolve((0,_url__WEBPACK_IMPORTED_MODULE_4__.default)(_utils_consts__WEBPACK_IMPORTED_MODULE_7__.DEFAULT_SSO_ROUTES, configSsoUrl)).then(async (ssoUrl) => {
        const options = {
...
const init = (options, configSsoUrl) => {
    ...
    return Promise.resolve((0,_url__WEBPACK_IMPORTED_MODULE_4__.default)(options.routes ? options.routes : _utils_consts__WEBPACK_IMPORTED_MODULE_7__.DEFAULT_SSO_ROUTES, configSsoUrl)).then((ssoUrl) => {
...
// Keycloak server URL
const getUrl = (ssoUrl) => {
    return (0,_url__WEBPACK_IMPORTED_MODULE_4__.default)(_utils_consts__WEBPACK_IMPORTED_MODULE_7__.DEFAULT_SSO_ROUTES, ssoUrl);
};
...
async function getOfflineToken(realm, clientId, configSsoUrl) {
    ...
    const ssoUrl = await (0,_url__WEBPACK_IMPORTED_MODULE_1__.default)(_utils_consts__WEBPACK_IMPORTED_MODULE_0__.DEFAULT_SSO_ROUTES, configSsoUrl);
...
/* harmony import */ var _components_Header_Header__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/Header/Header */ "./src/components/Header/Header.tsx");
/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! js-cookie */ "./node_modules/js-cookie/dist/js.cookie.mjs");
...
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../redux/actions */ "./src/redux/actions.ts");
/* harmony import */ var _components_Routes_Routes__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/Routes/Routes */ "./src/components/Routes/Routes.tsx");
/* harmony import */ var _utils_useOuiaTags__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/useOuiaTags */ "./src/utils/useOuiaTags.ts");
/* harmony import */ var _components_Stratosphere_RedirectBanner__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/Stratosphere/RedirectBanner */ "./src/components/Stratosphere/RedirectBanner.tsx");
...
/* harmony import */ var _components_Navigation_Navigation_scss__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../components/Navigation/Navigation.scss */ "./src/components/Navigation/Navigation.scss");
/* harmony import */ var _DefaultLayout_scss__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./DefaultLayout.scss */ "./src/layouts/DefaultLayout.scss");
...
const ShieldedRoot = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ hideNav = false, isGlobalFilterEnabled = false, initialized = false, Sidebar }) => {
    const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useDispatch)();
    ...
    const selectedAccountNumber = js_cookie__WEBPACK_IMPORTED_MODULE_8__.default.get(_utils_consts__WEBPACK_IMPORTED_MODULE_15__.CROSS_ACCESS_ACCOUNT_NUMBER);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.Page, { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ 'chr-c-page__hasBanner': hasBanner, 'chr-c-page__account-banner': selectedAccountNumber }), onPageResize: null, header: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.Masthead, { className: "chr-c-masthead" },
            !hideNav && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.MastheadToggle, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.PageToggleButton, { variant: "plain", "aria-label": "Global navigation", isNavOpen: isNavOpen, onNavToggle: () => {
                        ...
                        dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_10__.onToggle)());
                    } },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Header_Header__WEBPACK_IMPORTED_MODULE_7__.Header, null)), sidebar: hideNav ? undefined : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.PageSidebar, { isNavOpen: isNavOpen, id: "chr-c-sidebar", nav: Sidebar }) },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('chr-render') },
            isGlobalFilterEnabled && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_GlobalFilter_GlobalFilter__WEBPACK_IMPORTED_MODULE_3__.default, { key: (0,_utils_common__WEBPACK_IMPORTED_MODULE_16__.getUrl)('bundle') }),
            selectedAccountNumber && react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "chr-viewing-as" }, intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_14__.default.viewingAsAccount, { selectedAccountNumber })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Stratosphere_RedirectBanner__WEBPACK_IMPORTED_MODULE_13__.default, null),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Routes_Routes__WEBPACK_IMPORTED_MODULE_11__.default, { routesProps: { scopeClass: 'chr-scope__default-layout' } }))));
}, (prevProps, nextProps) => lodash_isEqual__WEBPACK_IMPORTED_MODULE_9___default()(prevProps, nextProps));
ShieldedRoot.displayName = 'ShieldedRoot';
const isGlobalFilterAllowed = () => {
    if ((0,_utils_common__WEBPACK_IMPORTED_MODULE_16__.getUrl)('bundle') === 'insights') {
        return true;
    }
    return (0,_utils_common__WEBPACK_IMPORTED_MODULE_16__.getUrl)('bundle') === 'ansible' && ['inventory', 'drift', 'advisor'].includes((0,_utils_common__WEBPACK_IMPORTED_MODULE_16__.getUrl)('app'));
};
const RootApp = ({ globalFilterHidden, Sidebar, globalFilterRemoved }) => {
    const ouiaTags = (0,_utils_useOuiaTags__WEBPACK_IMPORTED_MODULE_12__.default)();
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: "chrome-app-render-root", ...ouiaTags },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ShieldedRoot, { isGlobalFilterEnabled: isGlobalFilterEnabled, hideNav: hideNav, initialized: initialized, Sidebar: Sidebar })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RootApp);
...
const history = (0,history__WEBPACK_IMPORTED_MODULE_1__.createBrowserHistory)({
    basename: (0,_common__WEBPACK_IMPORTED_MODULE_0__.isBeta)() ? '/beta' : '/',
});
...
function getEnv() {
    return Object.entries(_utils_consts__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_SSO_ROUTES).find(([, { url }]) => url.includes(location.hostname))?.[0] || 'qa';
}
function getEnvDetails() {
    return Object.entries(_utils_consts__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_SSO_ROUTES).find(([, { url }]) => url.includes(location.hostname))?.[1];
}
function isProd() {
...
const computeFedrampResult = (isFedrampEnv, linkHref = '', { modules, isFedramp } = { modules: [] }) => {
    ...
    const configs = modules
        ...
        const match = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.matchPath)(linkHref, {
            path: route.pathname,
        });
        return match !== null;
    })

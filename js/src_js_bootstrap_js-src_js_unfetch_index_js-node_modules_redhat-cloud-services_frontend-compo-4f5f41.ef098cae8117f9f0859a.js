...
var Activation = function Activation(_ref) {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_3__.TextContent, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_3__.Text, null, "Red Hat will be in touch within 1 business day to confirm your subscription benefits are ready to be activated.")));
};
...
var ErrorComponent = function ErrorComponent(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__.Bullseye, {
    ...
    component: function component(props) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_Sidenav_Navigation_ChromeLink__WEBPACK_IMPORTED_MODULE_7__.default, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__.default)({}, props, {
        appId: "landing",
        href: "/"
      }), "Return to home page");
    },
...
var Header = function Header() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_7__.MastheadMain, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_7__.MastheadBrand, {
    component: function component(props) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_Sidenav_Navigation_ChromeLink__WEBPACK_IMPORTED_MODULE_14__.default, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__.default)({}, props, {
        appId: "landing",
        href: "/"
      }));
    }
    ...
    value: function render() {
      ...
      var dropdownItems = this.props.dropdownItems.map(function (_ref) {
        ...
        return !isHidden ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_9___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_10__.DropdownItem, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__.default)({
          ...
          ouiaId: title,
          disabled: isDisabled,
          component: appId ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_9___default().createElement(_Sidenav_Navigation_ChromeLink__WEBPACK_IMPORTED_MODULE_12__.default, {
            href: url,
            target: target,
            rel: rel,
...
function buildItems(username, isOrgAdmin) {
  ...
  return [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_8__.DropdownItem, {
    ...
    component: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement(_Sidenav_Navigation_ChromeLink__WEBPACK_IMPORTED_MODULE_13__.default, {
...
var loaderWrapper = function loaderWrapper(Component) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().createElement(react__WEBPACK_IMPORTED_MODULE_6__.Suspense, {
    fallback: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().createElement(_Sidenav_Navigation_Loader__WEBPACK_IMPORTED_MODULE_13__.default, null)
...
var libjwtSetup = function libjwtSetup(chromeConfig) {
...
var App = function App() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    (0,_utils_ts__WEBPACK_IMPORTED_MODULE_13__.loadFedModules)().then(function (_ref4) {
      ...
      var libjwt = libjwtSetup(chromeConfig);
      libjwt.initPromise.then(function () {
        return setJwtState(true);
      });
      window.insights = (0,_chrome_create_chrome__WEBPACK_IMPORTED_MODULE_11__.default)(libjwt, window.insights, data);
    });
...
var createChromeInstance = function createChromeInstance(jwt, insights, globalConfig) {
  var libjwt = jwt;
  var chromeInstance = {
    cache: undefined
  };
  ...
  var chromeFunctions = (0,_entry__WEBPACK_IMPORTED_MODULE_4__.bootstrap)(libjwt, init, getUser, globalConfig);
    ...
    chrome: {
      auth: {
        ...
        doOffline: function doOffline() {
          var _globalConfig$chrome;

          return libjwt.jwt.doOffline(_consts__WEBPACK_IMPORTED_MODULE_6__.default.noAuthParam, _consts__WEBPACK_IMPORTED_MODULE_6__.default.offlineToken, globalConfig === null || globalConfig === void 0 ? void 0 : (_globalConfig$chrome = globalConfig.chrome) === null || _globalConfig$chrome === void 0 ? void 0 : _globalConfig$chrome.ssoUrl);
        },
...
/* harmony import */ var _redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../redux/globalFilterReducers */ "./src/js/redux/globalFilterReducers.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils */ "./src/js/utils.ts");
...
const workloads = [
    {
        ...
        tags: [
            ...
            {
                tag: { key: _redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.AAP_KEY },
            },
            {
                tag: { key: _redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.MSSQL_KEY },
            },
        ],
        type: 'checkbox',
    },
...
const generateFilter = async () => {
    ...
    if ((0,_utils__WEBPACK_IMPORTED_MODULE_5__.getUrl)('bundle') === 'ansible') {
        searchParams.set('workloads', _redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.AAP_KEY);
    }
    const currToken = (0,_jwt_jwt__WEBPACK_IMPORTED_MODULE_0__.decodeToken)(await window.insights.chrome.auth.getToken())?.session_state;
    let data;
    try {
        data = JSON.parse(localStorage.getItem(`${_jwt_jwt__WEBPACK_IMPORTED_MODULE_0__.GLOBAL_FILTER_KEY}/${currToken}`) || '{}');
    }
    catch (e) {
        data = {};
    }
    let { Workloads, [_redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.SID_KEY]: SIDs, ...tags } = data;
    if (searchParams.get('workloads')) {
        const { tag } = workloads[0].tags.find(({ tag: { key } }) => key === searchParams.get('workloads')) || {};
        Workloads = tag?.key
            ? {
                [tag?.key]: {
                    group: lodash_omit__WEBPACK_IMPORTED_MODULE_1___default()(workloads[0], 'tags'),
                    isSelected: true,
                    item: { tagKey: tag?.key },
                },
            }
    ...
    if (typeof searchParams.get('SIDs') === 'string') {
        SIDs = createTagsFilter(searchParams
            .get('SIDs')
            ?.split(',')
            .map((sid) => `${_redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.SID_KEY}/${sid}`))?.[_redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.SID_KEY];
    }
    return [
        {
            Workloads,
            ...(SIDs && { [_redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.SID_KEY]: SIDs }),
            ...tags,
        },
        currToken,
    ];
...
const flatTags = lodash_memoize__WEBPACK_IMPORTED_MODULE_3___default()((filter = {}, encode = false, format = false) => {
    const { Workloads, [_redux_globalFilterReducers__WEBPACK_IMPORTED_MODULE_4__.SID_KEY]: SID, ...tags } = filter;
    const mappedTags = lodash_flatMap__WEBPACK_IMPORTED_MODULE_2___default()(Object.entries({ ...tags, ...(!format && { Workloads }) } || {}), ([namespace, item]) => Object.entries(item || {})
...
const useDynamicModule = (appId) => {
    ...
    const { modules, activeModule } = (0,react_redux__WEBPACK_IMPORTED_MODULE_3__.useSelector)(({ chrome: { modules = {}, activeModule } }) => ({
        modules,
        activeModule,
    }));
...
const LinkWrapper = ({ href, isBeta, onLinkClick, className, currAppId, appId, children, tabIndex }) => {
    ...
    const quickStartHighlightId = href
        ...
        .join('_');
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.NavLink, { tabIndex: tabIndex, ref: linkRef, "data-testid": "router-link", onClick: onClick, to: href, className: className, "data-quickstart-id": quickStartHighlightId }, children));
};
...
RefreshLink.propTypes = {
    ...
    isExternal: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
    onLinkClick: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
    isBeta: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
    currAppId: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().any),
};
const ChromeLink = ({ appId, children, ...rest }) => {
    ...
    const currAppId = (0,react_redux__WEBPACK_IMPORTED_MODULE_3__.useSelector)(({ chrome }) => chrome?.appId);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?474c");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _segment_analytics_next__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @segment/analytics-next */ "./node_modules/@segment/analytics-next/dist/pkg/browser.js");
...
const SegmentProvider = ({ activeModule, children }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (activeModule && user) {
            ...
            const newKey = getAPIKey((0,_utils__WEBPACK_IMPORTED_MODULE_1__.isProd)() ? 'prod' : 'dev', activeModule, moduleAPIKey);
            console.log({ newKey });
            ...
            if (!analytics.current) {
                analytics.current = _segment_analytics_next__WEBPACK_IMPORTED_MODULE_4__.AnalyticsBrowser.load({ writeKey: newKey }, { initialPageview: false });
...
const storeInitialHash = (payload) => ({
    type: _action_types__WEBPACK_IMPORTED_MODULE_0__.STORE_INITIAL_HASH,
    payload,
});
...
const reducers = {
    ...
    [_action_types__WEBPACK_IMPORTED_MODULE_2__.STORE_INITIAL_HASH]: _reducers__WEBPACK_IMPORTED_MODULE_0__.storeInitialHashReducer,
...
function storeInitialHashReducer(state, { payload }) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((user) => {
    ...
    if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.isProd)()) {
        initSentry();
        sentryTags(user);
    }
    else {

...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?88de");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _segment_analytics_next__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @segment/analytics-next */ "./node_modules/@segment/analytics-next/dist/pkg/browser/index.js");
...
/* harmony import */ var _SegmentContext__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./SegmentContext */ "./src/analytics/SegmentContext.ts");
...
const DEV_ENV = localStorage.getItem('chrome:analytics:dev') === 'true' || !(0,_utils_common__WEBPACK_IMPORTED_MODULE_2__.isProd)();
...
const getPageEventOptions = () => {
    ...
    const trackingContext = [
        { name: 'tactic_id_external', value: search.get('sc_cid') || js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].get('rh_omni_tc') },
        { name: 'tactic_id_internal', value: search.get('intcmp') || js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].get('rh_omni_itc') },
        { name: 'tactic_id_personalization', value: search.get('percmp') || js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].get('rh_omni_pc') },
    ...
    return [
        {
            ...
            isBeta: (0,_utils_common__WEBPACK_IMPORTED_MODULE_2__.isBeta)(),
...
const getIdentityTrais = (user, pathname, activeModule = '') => {
    ...
    return {
        ...
        currentBundle: (0,_utils_common__WEBPACK_IMPORTED_MODULE_2__.getUrl)('bundle'),
        currentApp: activeModule,
        isBeta: (0,_utils_common__WEBPACK_IMPORTED_MODULE_2__.isBeta)(),
        ...(!(0,_utils_common__WEBPACK_IMPORTED_MODULE_2__.isProd)() && user.identity.user
            ? {
...
const SegmentProvider = ({ activeModule, children }) => {
    ...
    const fedRampEnv = (0,_utils_common__WEBPACK_IMPORTED_MODULE_2__.isFedRamp)();
    ...
    const moduleAPIKey = (0,react_redux__WEBPACK_IMPORTED_MODULE_3__.useSelector)(({ chrome: { modules } }) => activeModule && modules?.[activeModule]?.analytics?.APIKey);
    const { pathname } = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_4__.useLocation)();
    if (!analytics.current) {
        analytics.current = new _segment_analytics_next__WEBPACK_IMPORTED_MODULE_6__.AnalyticsBrowser();
    }
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (!isDisabled && activeModule && user) {
            ...
            if (!initialized.current && analytics.current) {
                ...
                analytics.current = _segment_analytics_next__WEBPACK_IMPORTED_MODULE_6__.AnalyticsBrowser.load({ writeKey: newKey }, { initialPageview: false, disableClientPersistence: true, integrations: { All: !fedRampEnv } });
                window.segment = analytics.current;
                analytics.current.identify(user.identity.internal?.account_id, identityTraits, identityOptions);
                analytics.current.group(user.identity.internal?.org_id, groupTraits);
            }
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_SegmentContext__WEBPACK_IMPORTED_MODULE_5__["default"].Provider, { value: {
            ready: true,
...
function getPendoConf(data) {
    ...
    return {
        visitor: {
            ...
            ...(!(0,_utils_common__WEBPACK_IMPORTED_MODULE_0__.isProd)()
                ? {
...
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! react-intl */ "./node_modules/react-intl/lib/src/components/provider.js");
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! react-intl */ "./node_modules/@formatjs/intl/lib/src/error.js");
...
/* harmony import */ var _components_AppPlaceholder__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/AppPlaceholder */ "./src/components/AppPlaceholder/index.tsx");
...
const App = () => {
    ...
    return isReady && modules && scalprumConfig && libJwt ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_LibJWTContext__WEBPACK_IMPORTED_MODULE_14__["default"].Provider, { value: libJwt },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_RootApp__WEBPACK_IMPORTED_MODULE_4__["default"], { config: scalprumConfig }))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_AppPlaceholder__WEBPACK_IMPORTED_MODULE_17__["default"], null));
};
react_dom__WEBPACK_IMPORTED_MODULE_1___default().render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_18__["default"], { locale: language, messages: _locales_data_json__WEBPACK_IMPORTED_MODULE_12__[language], onError: (error) => {
        if (((0,_utils_common__WEBPACK_IMPORTED_MODULE_11__.getEnv)() === 'stage' && !window.location.origin.includes('foo')) ||
            ...
            !(error.code === react_intl__WEBPACK_IMPORTED_MODULE_19__.IntlErrorCode.MISSING_TRANSLATION)) {
            console.error(error);
        }
    } },
...
const AllServicesLink = ({ href, title, isExternal }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextVariants.p, className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('chr-c-favorite-trigger', {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_4__["default"], { appId: appId, isExternal: isExternal, href: href },
            title,
            isExternal && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { className: "pf-u-ml-sm chr-c-icon-external-link", isInline: true },
        ...
        !isExternal && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { onClick: () => handleFavouriteToggle(href, isFavorite), "aria-label": `${isFavorite ? 'Unfavorite' : 'Favorite'} ${title}`, className: "pf-u-ml-sm chr-c-icon-star", isInline: true },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_8__["default"], null)))));
};
...
/***/ "./src/components/AllServicesDropdown/AllServicesDropdown.tsx":
/*!********************************************************************!*\
  !*** ./src/components/AllServicesDropdown/AllServicesDropdown.tsx ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-core */ "webpack/sharing/consume/default/@patternfly/react-core/@patternfly/react-core");
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _AllServicesDropdown_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AllServicesDropdown.scss */ "./src/components/AllServicesDropdown/AllServicesDropdown.scss");
/* harmony import */ var _AllServicesMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AllServicesMenu */ "./src/components/AllServicesDropdown/AllServicesMenu.tsx");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-router-dom */ "webpack/sharing/consume/default/react-router-dom/react-router-dom");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_router_dom__WEBPACK_IMPORTED_MODULE_4__);
...
const AllServicesDropdown = () => {
    ...
    const toggle = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.MenuToggle, { className: "pf-m-full-height chr-c-link-service-toggle", ref: toggleRef, onClick: onToggleClick, isExpanded: isOpen }, "Services"));
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Popper, { trigger: toggle, appendTo: document.body, isVisible: isOpen, popper: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AllServicesMenu__WEBPACK_IMPORTED_MODULE_3__["default"], { menuRef: menuRef, setIsOpen: setIsOpen, isOpen: isOpen }) }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AllServicesDropdown);


/***/ }),

/***/ "./src/components/AllServicesDropdown/AllServicesGallery.tsx":
/*!*******************************************************************!*\
  !*** ./src/components/AllServicesDropdown/AllServicesGallery.tsx ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-core */ "webpack/sharing/consume/default/@patternfly/react-core/@patternfly/react-core");
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _AllServices_AllServicesSection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../AllServices/AllServicesSection */ "./src/components/AllServices/AllServicesSection.tsx");
...
const AllServicesGallery = ({ selectedService }) => {
    const sections = [];
    const links = [];
    selectedService.links.forEach((link) => {
        if ((0,_AllServices_AllServicesSection__WEBPACK_IMPORTED_MODULE_2__.isAllServicesGroup)(link)) {
            sections.push(link);
        }
        else {
            links.push(link);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Gallery, { hasGutter: true }, links.map((link, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AllServicesGalleryLink__WEBPACK_IMPORTED_MODULE_3__["default"], { key: index, ...link })))),
        sections.map((section, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AllServicesGallerySection__WEBPACK_IMPORTED_MODULE_4__["default"], { key: index, ...section })))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AllServicesGallery);


/***/ }),

/***/ "./src/components/AllServicesDropdown/AllServicesGalleryLink.tsx":
/*!***********************************************************************!*\
  !*** ./src/components/AllServicesDropdown/AllServicesGalleryLink.tsx ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _ChromeLink__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ChromeLink */ "./src/components/ChromeLink/index.ts");
...
const AllServicesGalleryLink = ({ href, title, description, isExternal }) => {
    const getBundle = (href) => _hooks_useBundle__WEBPACK_IMPORTED_MODULE_4__.bundleMapping[href.split('/')[1]];
    const { favoritePage, unfavoritePage, favoritePages } = (0,_redhat_cloud_services_chrome__WEBPACK_IMPORTED_MODULE_2__.useFavoritePages)();
    const handleFavouriteToggle = (pathname, favorite) => {
        if (favorite) {
            unfavoritePage(pathname);
        }
    ...
    const isFavorite = !!favoritePages.find(({ pathname, favorite }) => pathname === href && favorite);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_3__["default"], { isExternal: isExternal, href: href, className: "chr-c-favorite-service__tile" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Card, { className: "chr-c-link-service-card", isFlat: true, isSelectableRaised: true },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardBody, { className: "pf-u-p-md" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Split, null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.SplitItem, { className: "pf-m-fill" }, title),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.SplitItem, null, isExternal ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_external_link_alt_icon__WEBPACK_IMPORTED_MODULE_6__["default"], null))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { variant: "plain", className: "pf-u-p-0", onClick: (e) => {
                            e.stopPropagation();
                            e.preventDefault();
                            handleFavouriteToggle(href, isFavorite);
                        }, icon: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('chr-c-icon-service-card', {
                                favorite: isFavorite,
                            }) },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_7__["default"], null)) })))),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: "small" }, getBundle(href)),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: "small", className: "pf-u-color-100" }, description ?? ''))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AllServicesGalleryLink);


/***/ }),

/***/ "./src/components/AllServicesDropdown/AllServicesGallerySection.tsx":
/*!**************************************************************************!*\
  !*** ./src/components/AllServicesDropdown/AllServicesGallerySection.tsx ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?88de");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _AllServicesGalleryLink__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AllServicesGalleryLink */ "./src/components/AllServicesDropdown/AllServicesGalleryLink.tsx");



const AllServicesGallerySection = ({ title, links }) => {
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "pf-u-mb-lg" },
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Title, { className: "pf-u-mb-md", headingLevel: "h3" }, title),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Gallery, { hasGutter: true }, links.map((link, index) => (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_AllServicesGalleryLink__WEBPACK_IMPORTED_MODULE_2__["default"], { ...link, key: index })))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AllServicesGallerySection);


/***/ }),

/***/ "./src/components/AllServicesDropdown/AllServicesMenu.tsx":
/*!****************************************************************!*\
  !*** ./src/components/AllServicesDropdown/AllServicesMenu.tsx ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _patternfly_react_icons_dist_js_icons_book_open_icon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/book-open-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/book-open-icon.js");
/* harmony import */ var _patternfly_react_icons_dist_js_icons_times_icon__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/times-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/times-icon.js");
/* harmony import */ var _hooks_useAllServices__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../hooks/useAllServices */ "./src/hooks/useAllServices.ts");
/* harmony import */ var _AllServices_AllServicesIcons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../AllServices/AllServicesIcons */ "./src/components/AllServices/AllServicesIcons.ts");
/* harmony import */ var _FavoriteServices_ServicesGallery__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../FavoriteServices/ServicesGallery */ "./src/components/FavoriteServices/ServicesGallery.tsx");
/* harmony import */ var _hooks_useFavoritedServices__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../hooks/useFavoritedServices */ "./src/hooks/useFavoritedServices.ts");
/* harmony import */ var _AllServicesTabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./AllServicesTabs */ "./src/components/AllServicesDropdown/AllServicesTabs.tsx");
/* harmony import */ var _AllServicesGallery__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./AllServicesGallery */ "./src/components/AllServicesDropdown/AllServicesGallery.tsx");
...
const AllServicesMenu = ({ setIsOpen, isOpen, menuRef }) => {
    const { linkSections } = (0,_hooks_useAllServices__WEBPACK_IMPORTED_MODULE_3__["default"])();
    const [activeTabKey, setActiveTabKey] = react__WEBPACK_IMPORTED_MODULE_0___default().useState(FAVORITE_TAB_ID);
    const [isExpanded, setIsExpanded] = react__WEBPACK_IMPORTED_MODULE_0___default().useState(false);
    const [selectedService, setSelectedService] = react__WEBPACK_IMPORTED_MODULE_0___default().useState(linkSections[0]);
    const favoritedServices = (0,_hooks_useFavoritedServices__WEBPACK_IMPORTED_MODULE_6__["default"])();
    // Toggle currently active tab
    const handleTabClick = (event, tabIndex) => {
        setActiveTabKey(tabIndex);
    };
    const onTabClick = (section, index) => {
    ...
    const convertTitleIcon = (icon) => {
        const TitleIcon = _AllServices_AllServicesIcons__WEBPACK_IMPORTED_MODULE_4__["default"][icon];
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TitleIcon, null);
    };
    const tabContentRef = react__WEBPACK_IMPORTED_MODULE_0___default().createRef();
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: menuRef, className: "pf-c-dropdown chr-c-page__services-nav-dropdown-menu", "data-testid": "chr-c__find-app-service" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Backdrop, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Panel, { variant: "raised", className: "pf-c-dropdown__menu pf-u-p-0 pf-u-w-100 chr-c-panel-services-nav " },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PanelMain, null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Sidebar, { className: "pf-u-pt-md pf-u-pt-0-on-md" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.SidebarPanel, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AllServicesTabs__WEBPACK_IMPORTED_MODULE_7__["default"], { activeTabKey: activeTabKey, handleTabClick: handleTabClick, isExpanded: isExpanded, onToggle: onToggle, linkSections: linkSections, tabContentRef: tabContentRef, onTabClick: onTabClick }),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Divider, { inset: { default: 'insetNone' }, className: "pf-u-pt-md pf-u-pb-sm" }),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, { className: "pf-u-pb-md pf-u-text-align-center" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextVariants.p },
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_2__["default"], { href: "/allservices" },
                                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { className: "pf-u-mr-sm", isInline: true },
                                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_book_open_icon__WEBPACK_IMPORTED_MODULE_9__["default"], null)),
                                        "Browse all services")))),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.SidebarContent, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Card, { isPlain: true },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardHeader, null,
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Title, { headingLevel: "h2" },
                                        convertTitleIcon(selectedService.icon),
                                        " \u00A0",
                                        activeTabKey === FAVORITE_TAB_ID ? 'Favorites' : selectedService.title),
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardActions, null,
                                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { variant: "plain", "aria-label": "Close menu", onClick: () => setIsOpen(!isOpen) },
                                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_times_icon__WEBPACK_IMPORTED_MODULE_10__["default"], null)))),
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardBody, null,
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TabContent, { eventKey: activeTabKey, id: TAB_CONTENT_ID, ref: tabContentRef, "aria-label": selectedService.description }, activeTabKey === FAVORITE_TAB_ID ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FavoriteServices_ServicesGallery__WEBPACK_IMPORTED_MODULE_5__["default"], { favoritedServices: favoritedServices })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AllServicesGallery__WEBPACK_IMPORTED_MODULE_8__["default"], { selectedService: selectedService }))))))))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AllServicesMenu);


/***/ }),

/***/ "./src/components/AllServicesDropdown/AllServicesTabs.tsx":
/*!****************************************************************!*\
  !*** ./src/components/AllServicesDropdown/AllServicesTabs.tsx ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./common */ "./src/components/AllServicesDropdown/common.ts");




const AllServicesTabs = ({ activeTabKey, handleTabClick, isExpanded, onToggle, linkSections, tabContentRef, onTabClick }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Tabs, { inset: {
            default: 'insetNone',
        }, activeKey: activeTabKey, onSelect: handleTabClick, isVertical: true, expandable: {
            default: 'expandable',
            md: 'nonExpandable',
        }, isExpanded: isExpanded, onToggle: onToggle, toggleText: "Containers", "aria-label": "Tabs in the vertical expandable example", role: "region", className: "pf-u-pl-md" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Tab, { eventKey: _common__WEBPACK_IMPORTED_MODULE_2__.FAVORITE_TAB_ID, title: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TabTitleText, null,
                "My favorite services",
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { className: "pf-u-ml-md", status: "warning" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_3__["default"], { size: "sm", className: "chr-c-icon-service-tab" }))) }),
        linkSections.map((section, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Tab, { key: index, eventKey: index, title: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TabTitleText, null, section.title), tabContentId: _common__WEBPACK_IMPORTED_MODULE_2__.TAB_CONTENT_ID, tabContentRef: tabContentRef, onClick: () => onTabClick(section, index) })))));
};
...
/***/ "./src/components/AllServicesDropdown/common.ts":
/*!******************************************************!*\
  !*** ./src/components/AllServicesDropdown/common.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FAVORITE_TAB_ID": () => (/* binding */ FAVORITE_TAB_ID),
/* harmony export */   "TAB_CONTENT_ID": () => (/* binding */ TAB_CONTENT_ID)
/* harmony export */ });
const TAB_CONTENT_ID = 'refTab1Section';
const FAVORITE_TAB_ID = 'favorites';
...
/***/ "./src/components/AppPlaceholder/index.tsx":
/*!*************************************************!*\
  !*** ./src/components/AppPlaceholder/index.tsx ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _ChromeLink__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ChromeLink */ "./src/components/ChromeLink/index.ts");
/* harmony import */ var _Footer_Footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Footer/Footer */ "./src/components/Footer/Footer.tsx");
/* harmony import */ var _Header_Logo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Header/Logo */ "./src/components/Header/Logo.tsx");
...
const AppPlaceholder = () => {
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.MemoryRouter, null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Page, { header: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Masthead, { className: "chr-c-masthead" },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.MastheadMain, null,
                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.MastheadBrand, { component: (props) => react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_3__["default"], { ...props, appId: "landing", href: "/" }) },
                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_Header_Logo__WEBPACK_IMPORTED_MODULE_5__["default"], null)))), sidebar: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.PageSidebar, { nav: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_Navigation_Loader__WEBPACK_IMPORTED_MODULE_6__["default"], null) }) },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "chr-render" },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_Footer_Footer__WEBPACK_IMPORTED_MODULE_4__["default"], { cookieElement: null, setCookieElement: () => undefined })))));
};
...
const ChromeRoute = (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(({ scope, module, scopeClass, path }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { role: "main", className: classnames__WEBPACK_IMPORTED_MODULE_7___default()(scopeClass, scope) },
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?88de");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _sentry_react__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @sentry/react */ "./node_modules/@sentry/core/esm/exports.js");
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-core */ "webpack/sharing/consume/default/@patternfly/react-core/@patternfly/react-core");
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _ErrorComponent_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ErrorComponent.scss */ "./src/components/ErrorComponents/ErrorComponent.scss");
...
const DefaultErrorComponent = (props) => {
    ...
    const activeModule = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useSelector)(({ chrome: { activeModule } }) => activeModule);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const sentryId = _sentry_react__WEBPACK_IMPORTED_MODULE_7__.captureException(new Error('Unhandled UI runtime error'), {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
        ...
        if (activeModule && props.error?.cause?.name == 'ChunkLoadError') {
            const moduleStorageKey = `${_utils_common__WEBPACK_IMPORTED_MODULE_2__.chunkLoadErrorRefreshKey}-${activeModule}`;
...
const EmptyState = () => (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
    react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.StackItem, { className: "chr-l-stack__item-centered pf-u-mt-xl" },
...
const ServiceTile = ({ name, pathname, description = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit,', isExternal }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_2__["default"], { isExternal: isExternal, href: pathname, className: "chr-c-favorite-service__tile" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Card, { isFlat: true, isFullHeight: true, isSelectableRaised: true },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardBody, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Split, null,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.SplitItem, null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { onClick: (e) => {
                            ...
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { onMouseEnter: () => setMouseOver(true), onMouseLeave: () => setMouseOver(false), status: "warning", className: "pf-u-ml-sm" }, mouseOver ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_half_alt_icon__WEBPACK_IMPORTED_MODULE_6__["default"], null) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_7__["default"], null))))),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, null,
...
/***/ "./src/components/FavoriteServices/ServicesGallery.tsx":
/*!*************************************************************!*\
  !*** ./src/components/FavoriteServices/ServicesGallery.tsx ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-core */ "webpack/sharing/consume/default/@patternfly/react-core/@patternfly/react-core");
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ServiceTile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ServiceTile */ "./src/components/FavoriteServices/ServiceTile.tsx");
/* harmony import */ var _ChromeLink__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ChromeLink */ "./src/components/ChromeLink/index.ts");




const FavoriteServicesGallery = ({ favoritedServices }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Gallery, { hasGutter: true },
        favoritedServices.map((props, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ServiceTile__WEBPACK_IMPORTED_MODULE_2__["default"], { ...props, key: index }))),
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardBody, { className: "pf-u-pt-lg" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, null,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: "p" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_3__["default"], { href: "/allservices" }, "View all services")))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FavoriteServicesGallery);
...
const FeatureFlagsProvider = ({ children }) => {
    ...
    unleashClient = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => new _unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_1__.UnleashClient({
        ...config,
        context: {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_1__.FlagProvider, { unleashClient: unleashClient }, children);
};
...
async function getAllWorkloads({ activeTags, registeredWith } = {}, pagination = {}) {
    ...
    const [SAP, AAP, MSSQL] = await Promise.all([
        ...
        undefined, undefined, undefined, undefined, selectedTags, registeredWith ? [registeredWith] : undefined, undefined, undefined, {
...
/* harmony import */ var _AllServicesDropdown_AllServicesDropdown__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../AllServicesDropdown/AllServicesDropdown */ "./src/components/AllServicesDropdown/AllServicesDropdown.tsx");
/* harmony import */ var _unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @unleash/proxy-client-react */ "webpack/sharing/consume/default/@unleash/proxy-client-react/@unleash/proxy-client-react");
...
const Header = () => {
    ...
    const navDropdownEnabled = (0,_unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_20__.useFlag)('platform.chrome.navigation-dropdown');
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__.ToolbarContent, null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__.ToolbarGroup, { variant: "filter-group" },
                        user && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__.ToolbarItem, null, (0,_utils_common__WEBPACK_IMPORTED_MODULE_17__.isProd)() && !(0,_utils_common__WEBPACK_IMPORTED_MODULE_17__.isBeta)() ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AppFilter__WEBPACK_IMPORTED_MODULE_5__["default"], null)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
                            navDropdownEnabled ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AllServicesDropdown_AllServicesDropdown__WEBPACK_IMPORTED_MODULE_19__["default"], null) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ServicesLink__WEBPACK_IMPORTED_MODULE_6__["default"], null),
...
const Tools = () => {
    ...
    const BetaSwitcher = () => {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Switch, { id: "reversed-switch", label: "Beta on", labelOff: "Beta off", "aria-label": "Beta switcher", isChecked: (0,_utils_common__WEBPACK_IMPORTED_MODULE_7__.isBeta)(), onChange: () => (window.location.href = switchRelease((0,_utils_common__WEBPACK_IMPORTED_MODULE_7__.isBeta)(), window.location.pathname)), isReversed: true, className: "chr-c-beta-switcher" }));
    };
    const ThemeToggle = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.ToolbarGroup, { className: "pf-m-icon-button-group pf-m-align-right pf-m-spacer-none pf-m-spacer-md-on-md pf-u-mr-0", alignment: { default: 'alignRight' }, spaceItems: { default: 'spaceItemsNone' }, "widget-type": "InsightsToolbar" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.ToolbarItem, { className: "pf-m-hidden pf-m-visible-on-lg" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(BetaSwitcher, null)),
...
const RootApp = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)((props) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        if (activeModule) {
            let timeout;
            const moduleStorageKey = `${_utils_common__WEBPACK_IMPORTED_MODULE_15__.chunkLoadErrorRefreshKey}-${activeModule}`;
...
/* harmony import */ var _unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @unleash/proxy-client-react */ "webpack/sharing/consume/default/@unleash/proxy-client-react/@unleash/proxy-client-react");
/* harmony import */ var _unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(_unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_22__);
...
const ScalprumRoot = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ config, helpTopicsAPI, quickstartsAPI, ...props }) => {
    ...
    const navDropdownEnabled = (0,_unleash_proxy_client_react__WEBPACK_IMPORTED_MODULE_22__.useFlag)('platform.chrome.navigation-dropdown');
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_scalprum_react_core__WEBPACK_IMPORTED_MODULE_1__.ScalprumProvider, { ...scalprumProviderProps },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Routes, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { index: true, path: "/", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_7__["default"], { Sidebar: navDropdownEnabled ? undefined : _LandingNav__WEBPACK_IMPORTED_MODULE_16__["default"], Footer: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Footer_Footer__WEBPACK_IMPORTED_MODULE_19__["default"], { setCookieElement: setCookieElement, cookieElement: cookieElement }), ...props }) }),
...
const isProdEnv = (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.isProd)();
...
const useBundleVisitDetection = () => {
    ...
    const { markVisited, visitedBundles, initialized } = (0,_redhat_cloud_services_chrome__WEBPACK_IMPORTED_MODULE_2__.useVisitedBundles)();
...
const useFavoritedServices = () => {
    const { favoritePages } = (0,_redhat_cloud_services_chrome__WEBPACK_IMPORTED_MODULE_0__.useFavoritePages)();
    const { servicesLinks } = (0,_useAllServices__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
const useUserProfile = () => {
    const getCurrentProfile = () => localStorage.getItem(_utils_common__WEBPACK_IMPORTED_MODULE_3__.LOGIN_TYPE_STORAGE_KEY);
...
function setCookie(token) {
    ...
    if (token && token.length > 10) {
        ...
        if (cookieName) {
            ...
            setCookieWrapper(`${cookieName}=${token};` + `path=/api/remediations/v1;` + `secure=true;` + `expires=${getCookieExpires(decodeToken(token).exp)}`);
...
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _patternfly_react_icons_dist_js_icons_filter_icon__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/filter-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/filter-icon.js");
/* harmony import */ var _patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/star-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/star-icon.js");
...
/* harmony import */ var _hooks_useAllServices__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../hooks/useAllServices */ "./src/hooks/useAllServices.ts");
/* harmony import */ var _locales_Messages__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../locales/Messages */ "./src/locales/Messages.ts");
...
const AllServices = ({ Footer }) => {
    const { linkSections, error, ready, filterValue, setFilterValue } = (0,_hooks_useAllServices__WEBPACK_IMPORTED_MODULE_6__["default"])();
    const intl = (0,react_intl__WEBPACK_IMPORTED_MODULE_8__["default"])();
    if (error) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: "chrome-app-render-root" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Page, { className: "chr-c-all-services", onPageResize: null, header: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Masthead, { className: "chr-c-masthead" },
            ...
            !ready ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Bullseye, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Spinner, { size: "xl" }))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageGroup, { stickyOnBreakpoint: { default: 'top' } },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants.light, className: "pf-u-px-xl-on-md" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, { className: "pf-u-mt-sm" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: "p" },
                                "Every service available on Hybrid Cloud Console appears below. Hover on a service to select it as a favorite.",
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { status: "warning", size: "md", className: "pf-u-pl-sm", isInline: true },
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_9__["default"], null)))),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Icon, { className: "chr-c-icon-filter" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_filter_icon__WEBPACK_IMPORTED_MODULE_10__["default"], null)),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.SearchInput, { className: "chr-c-all-services-filter pf-u-mt-md pf-u-mb-sm", "data-ouia-component-id": "app-filter-search", placeholder: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__["default"].findAppOrService), value: filterValue, onChange: (val) => setFilterValue(val), onClear: (e) => {
                                setFilterValue('');
                                e.stopPropagation();
                            } }))),
...
/* harmony import */ var _components_FavoriteServices_ServicesGallery__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/FavoriteServices/ServicesGallery */ "./src/components/FavoriteServices/ServicesGallery.tsx");
/* harmony import */ var _hooks_useFavoritedServices__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../hooks/useFavoritedServices */ "./src/hooks/useFavoritedServices.ts");
...
const FavoritedServices = ({ Footer }) => {
    ...
    const favoritedServices = (0,_hooks_useFavoritedServices__WEBPACK_IMPORTED_MODULE_9__["default"])();
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: "chrome-app-render-root" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Page, { className: "chr-c-favoritedservices", onPageResize: null, header: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Masthead, { className: "chr-c-masthead" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants.light, className: "pf-u-px-2xl-on-md pf-m-fill" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Stack, { className: "pf-u-background-color-100" },
                    ...
                    favoritePages.length === 1 ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FavoriteServices_EmptyState__WEBPACK_IMPORTED_MODULE_7__["default"], null)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.StackItem, { className: "pf-u-pt-xl" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FavoriteServices_ServicesGallery__WEBPACK_IMPORTED_MODULE_8__["default"], { favoritedServices: favoritedServices }))))),
            Footer)));
};

...
/* harmony import */ var _redhat_cloud_services_frontend_components_FilterHooks__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components/FilterHooks */ "./node_modules/@redhat-cloud-services/frontend-components/esm/FilterHooks/tagFilterHook.js");
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../redux/actions */ "./src/js/redux/actions.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./constants */ "./src/js/App/GlobalFilter/constants.ts");
...
/* harmony import */ var _GlobalFilterMenu__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./GlobalFilterMenu */ "./src/js/App/GlobalFilter/GlobalFilterMenu.tsx");
/* harmony import */ var _filterApi__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./filterApi */ "./src/js/App/GlobalFilter/filterApi.ts");
...
var useLoadTags = function useLoadTags(hasAccess) {
  ...
  var registeredWith = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useSelector)(function (_ref) {
    var scope = _ref.globalFilter.scope;
    return scope;
  });
  var isDisabled = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useSelector)(function (_ref2) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)(function (activeTags, search) {
    (0,_filterApi__WEBPACK_IMPORTED_MODULE_11__.storeFilter)(activeTags, hasAccess && !isDisabled, history);
    (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.batch)(function () {
      ...
      dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_7__.fetchAllSIDs)({
        registeredWith: registeredWith,
        activeTags: activeTags,
        search: search
      }));
      dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_7__.fetchAllWorkloads)({
        registeredWith: registeredWith,
        activeTags: activeTags,
        search: search
      }));
...
var GlobalFilter = function GlobalFilter(_ref3) {
  ...
  var dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useDispatch)();
  var isLoaded = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useSelector)(function (_ref4) {
  ...
  var _useSelector = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useSelector)(function (_ref5) {
  ...
  var isDisabled = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useSelector)(function (_ref6) {
    var globalFilterHidden = _ref6.globalFilter.globalFilterHidden,
        appId = _ref6.chrome.appId;
    return globalFilterHidden || !appId;
  });

  var _useTagsFilter = (0,_redhat_cloud_services_frontend_components_FilterHooks__WEBPACK_IMPORTED_MODULE_12__.useTagsFilter)([workloads].concat((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(sid), (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(tags)), isLoaded, total - count, function (_e, closeFn) {
    setIsOpen(function () {
      return true;
    });
    closeFn && closeFn();
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(function () {
    setValue(function () {
      return (0,_constants__WEBPACK_IMPORTED_MODULE_8__.generateFilter)();
    });
  }, []);
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(function () {
    if (hasAccess && !isDisabled) {
      loadTags(selectedTags, filterTagsBy, true);
      dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_7__.globalFilterChange)(selectedTags));
    }
  }, [selectedTags, filterTagsBy, hasAccess, isDisabled]);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_GlobalFilterMenu__WEBPACK_IMPORTED_MODULE_10__.GlobalFilterDropdown, {
    allowed: hasAccess,
...
GlobalFilter.propTypes = {
  hasAccess: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool)
};
...
var GlobalFilterWrapper = function GlobalFilterWrapper() {
  ...
  var userLoaded = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useSelector)(function (_ref10) {
...
var ScalprumRoot = function ScalprumRoot(_ref2) {
  ...
  var globalFilterRemoved = (0,react_redux__WEBPACK_IMPORTED_MODULE_9__.useSelector)(function (_ref3) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__.Split, { id: "global-filter", hasGutter: true, className: "chr-c-global-filter" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__.SplitItem, null, userLoaded && allowed !== undefined ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(GroupFilterWrapper, { content: !allowed || isDisabled
                    ...
                    : '', position: "right" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_redhat_cloud_services_frontend_components_ConditionalFilter__WEBPACK_IMPORTED_MODULE_9__.default, { className: "chr-c-menu-global-filter__select", selected: selectedTags, groups: filter.groups?.map((group) => ({
                        ...group,
        ...
        isOpen && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_TagsModal__WEBPACK_IMPORTED_MODULE_6__.default, { isOpen: isOpen, filterTagsBy: filterTagsBy, selectedTags: selectedTags, toggleModal: (isSubmit) => {
                ...
                setValue(() => [...(selected || []), ...(sidSelected || [])].reduce((acc, { key, value, namespace }) => (0,_constants__WEBPACK_IMPORTED_MODULE_5__.updateSelected)(acc, namespace, `${key}${value ? `=${value}` : ''}`, value, true, {
                    item: { tagKey: key },
                }), selectedTags));
            } })),
...
const useRow = (resource, loaded, idMapper, cellsMapper, selected) => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
        if (loaded) {
            return lodash_flatMap__WEBPACK_IMPORTED_MODULE_5___default()(resource, ({ tags }) => tags?.map(({ tag }) => ({
                id: idMapper(tag),
...
const useDebounce = (callback, perPage, activeTags) => {
    const registeredWith = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)(({ globalFilter: { scope } }) => scope || undefined);
    const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useDispatch)();
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default()((search) => {
        dispatch(callback({
            registeredWith,
            activeTags,
            search,
...
const TagsModal = ({ isOpen, filterTagsBy, onApplyTags, toggleModal, selectedTags }) => {
    ...
    const debounceGetTags = useDebounce(_redux_actions__WEBPACK_IMPORTED_MODULE_3__.fetchAllTags, tagsPerPage, selectedTags);
    const debounceGetSIDs = useDebounce(_redux_actions__WEBPACK_IMPORTED_MODULE_3__.fetchAllSIDs, sidPerPage, selectedTags);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_redhat_cloud_services_frontend_components_TagModal__WEBPACK_IMPORTED_MODULE_8__.default, { tabNames: ['tags', 'SAP IDs (SID)'], tableProps: {
            canSelectAll: false,
        }, pagination: [tagsPagination, sidPagination], rows: [tagsRows, sidRows], loaded: [tagsLoaded, sidLoaded], width: "50%", isOpen: isOpen, toggleModal: (_e, isSubmit) => {
            setSidsSelected([]);
            setTagsSelected([]);
            setFilterBy('');
            setFilterSIDsBy('');

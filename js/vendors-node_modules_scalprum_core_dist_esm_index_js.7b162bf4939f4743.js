...
/* harmony export */   "getPendingInjection": () => (/* binding */ getPendingInjection),
...
var setPendingInjection = function (id, injectionLock) {
    window[GLOBAL_NAMESPACE].pendingInjections[id] = injectionLock;
};
var getPendingInjection = function (id) {
...
var getPendingPrefetch = function (id) {
    var _a;
    return (_a = window[GLOBAL_NAMESPACE].pendingPrefetch) === null || _a === void 0 ? void 0 : _a[id];
};
...
var preloadModule = function (scope, module, processor, skipCache) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            cachedModule = getCachedModule(scope, module, skipCache).cachedModule;
            modulePromise = getPendingLoading(scope, module);
            if (!modulePromise && Object.keys(cachedModule || {}).length == 0 && manifestLocation) {
                modulePromise = processManifest(manifestLocation, scope, processor).then(function () { return asyncLoader(scope, module); });
            }
...
var injectScript = function (scope, scriptLocation) {
    var _a;
    var s = undefined;
    if (!shouldInjectScript(scriptLocation)) {
        return Promise.resolve([scope, (_a = document.querySelectorAll("script[src=\"" + scriptLocation + "\"]")) === null || _a === void 0 ? void 0 : _a[0]]);
    }
...
function processManifest(url, scope, processor) {
    return __awaiter(this, void 0, void 0, function () {
        var headers, response, error, _a, manifest, pendingInjection, injectionPromise;
        var _this = this;
            ...
            switch (_b.label) {
                ...
                case 8:
                    ...
                    injectionPromise = Promise.all(Object.entries(manifest)
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, injectScript(scope, scriptLocation)];
                                case 1:
                                    data = _a.sent();
...
function asyncLoader(scope, module) {
    return __awaiter(this, void 0, void 0, function () {
        var container, factory, moduleFactory, factoryCache;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    ...
                    factoryCache = {
                        init: container.init,
                        modules: __assign(__assign({}, window[GLOBAL_NAMESPACE].factories[scope].modules), (_a = {}, _a[module] = __assign({}, moduleFactory), _a)),
                        expiration: new Date(),
                    };

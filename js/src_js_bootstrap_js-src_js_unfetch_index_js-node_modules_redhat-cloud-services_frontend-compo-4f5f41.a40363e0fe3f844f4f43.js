...
const Activation = ({ user, request }) => {
    ...
    const isAvailable = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getEnv)() === 'prod';
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_2__.Modal, { isOpen: isModalOpen, onClose: onModalClose, title: intl.formatMessage(_Messages__WEBPACK_IMPORTED_MODULE_5__.default.activationTitle), variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_2__.ModalVariant.medium },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_2__.TextContent, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_2__.Text, null, intl.formatMessage(_Messages__WEBPACK_IMPORTED_MODULE_5__.default.activationDescription)))));
};
Activation.propTypes = {
    user: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
    request: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),
};

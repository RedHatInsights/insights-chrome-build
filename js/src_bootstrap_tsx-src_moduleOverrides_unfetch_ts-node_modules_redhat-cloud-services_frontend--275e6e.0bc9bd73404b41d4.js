...
const AllServicesLink = ({ href, title, isExternal }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { className: "chr-c-allservices__link-wrapper", component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextVariants.p },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_4__["default"], { appId: appId, isExternal: isExternal, href: href },
            title,
            isExternal && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_external_link_alt_icon__WEBPACK_IMPORTED_MODULE_7__["default"], null)),
        !isExternal && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { onClick: () => handleFavouriteToggle(href, isFavorite), variant: "plain", "aria-label": `${isFavorite ? 'Unfavorite' : 'Favorite'} ${title}`, className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('pf-u-ml-sm', 'pf-u-p-0', 'chr-c-allservices__favourite', {
                ...
                }) }, isFavorite ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_8__["default"], { color: "var(--pf-global--palette--gold-200)" }) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_half_alt_icon__WEBPACK_IMPORTED_MODULE_9__["default"], { color: "var(--pf-global--palette--gold-200)" }))))));
};
...
const LinkWrapper = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ href, isBeta, onLinkClick, className, currAppId, appId, children, tabIndex }) => {
    ...
    const onClick = (event) => {
        if (defaultTitle || appId) {
            (0,_utils_common__WEBPACK_IMPORTED_MODULE_6__.updateDocumentTitle)(defaultTitle || appId);
        }

...
var getUserIdentity = function () { return (0,_utils_fetch__WEBPACK_IMPORTED_MODULE_4__.get)(_utils_fetch__WEBPACK_IMPORTED_MODULE_4__.IDENTITY_URL); };
var useLastPageVisitedUploader = function (providerState) {
    var inactiveDuration = 1000 * 20;
    var batchUpdateInterval = 1000 * 60 * 3;
    var inactiveTimeout = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(undefined);
    var postBatchData = function (recentPages) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0,_utils_fetch__WEBPACK_IMPORTED_MODULE_4__.post)(_utils_fetch__WEBPACK_IMPORTED_MODULE_4__.LAST_VISITED_URL, {
                            pages: recentPages,
                        })];
                case 1:
                    _a.sent();
...
var useLastVisitedLocalStorage = function (providerState) {
    ...
    var lastVisitedLocal = localStorage.getItem(LAST_VISITED_FLAG);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        var getInitialPages = function () { return __awaiter(void 0, void 0, void 0, function () {
            var firstPages, lastVisited, error_2;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        if (!!lastVisitedLocal) return [3, 2];
                        return [4, (0,_utils_fetch__WEBPACK_IMPORTED_MODULE_4__.get)(_utils_fetch__WEBPACK_IMPORTED_MODULE_4__.LAST_VISITED_URL)];
                    case 1:
                        firstPages = _b.sent();
                        if (firstPages) {
                        ...
                        return [3, 3];
                    case 2:
                        lastVisited = JSON.parse((_a = localStorage.getItem(LAST_VISITED_FLAG)) !== null && _a !== void 0 ? _a : '[]');
                    ...
                    case 4:
                        error_2 = _b.sent();
                        console.error('Unable to parse last visited pages from localStorage!', error_2);
                        providerState.setLastVisited([]);
                        localStorage.setItem(LAST_VISITED_FLAG, JSON.stringify([]));
                        return [3, 5];
                    case 5: return [2];
...
var ChromeProvider = function (_a) {
    ...
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_ChromeContext__WEBPACK_IMPORTED_MODULE_6__["default"].Provider, { value: providerState.current, children: children });
};

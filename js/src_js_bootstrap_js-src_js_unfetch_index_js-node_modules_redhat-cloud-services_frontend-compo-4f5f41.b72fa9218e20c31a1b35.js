...
var libjwtSetup = function libjwtSetup() {
  var libjwt = (0,_auth__WEBPACK_IMPORTED_MODULE_9__.default)();
...
const getAPIKey = (env = 'dev', module) => ({
    prod: {
...
const SegmentProvider = ({ activeModule, children }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (activeModule && user) {
            ...
            const newKey = getAPIKey((0,_utils__WEBPACK_IMPORTED_MODULE_1__.isProd)() ? 'prod' : 'dev', activeModule);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
    ...
    const promise = _jwt_jwt__WEBPACK_IMPORTED_MODULE_1__.init(options).then(bouncer);
    return {
        getOfflineToken: () => (0,_jwt_insights_offline__WEBPACK_IMPORTED_MODULE_0__.getOfflineToken)(options.realm, options.clientId),

...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react-dom"), require("redux"), require("classnames"), require("react-router-dom"), require("patternfly-react"), require("@patternfly/react-core"), require("react-redux"), require("react"), require("@patternfly/react-icons"));
	else if(typeof define === 'function' && define.amd)
		define("InsightsComponentsRegistery-components/Vulnerabilities", ["react-dom", "redux", "classnames", "react-router-dom", "patternfly-react", "@patternfly/react-core", "react-redux", "react", "@patternfly/react-icons"], factory);
	else if(typeof exports === 'object')
		exports["InsightsComponentsRegistery-components/Vulnerabilities"] = factory(require("react-dom"), require("redux"), require("classnames"), require("react-router-dom"), require("patternfly-react"), require("@patternfly/react-core"), require("react-redux"), require("react"), require("@patternfly/react-icons"));
	else
		root["InsightsComponentsRegistery-components/Vulnerabilities"] = factory(root["ReactDOM"], root["Redux"], root["classnames"], root["ReactRouterDOM"], root["PFReact"], root["PFReactCore"], root["ReactRedux"], root["React"], root["PFReactIcons"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_react_dom__, __WEBPACK_EXTERNAL_MODULE_redux__, __WEBPACK_EXTERNAL_MODULE_classnames__, __WEBPACK_EXTERNAL_MODULE_react_router_dom__, __WEBPACK_EXTERNAL_MODULE_patternfly_react__, __WEBPACK_EXTERNAL_MODULE__patternfly_react_core__, __WEBPACK_EXTERNAL_MODULE_react_redux__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE__patternfly_react_icons__) {
...
var TableToolbar = function TableToolbar(_ref) {
    var results = _ref.results,
        className = _ref.className,
        children = _ref.children,
        props = (0, _objectWithoutProperties3.default)(_ref, ['results', 'className', 'children']);


    var tableToolbarClasses = (0, _classnames2.default)('ins-c-table__toolbar', className);
...
function createCveListBySystem(_ref) {
    var isLoading = _ref.isLoading,
        rest = (0, _objectWithoutProperties3.default)(_ref, ['isLoading']);
            ...
            data: data.map(function (row) {
                return {
                    ...
                    cells: [_react2.default.createElement(
                        'span',
                        { key: row.id },
                        _react2.default.createElement(_reactIcons.SecurityIcon, { size: 'md', color: colorToImpact[row.attributes.impact] })
                    ), row.attributes.synopsis, _react2.default.createElement(
                        'span',
                        { key: 'title-' + row.id, title: row.attributes.description },
                        row.attributes.description.substr(0, 199),
                        '...'
                    ), (0, _helpers.parseCvssScore)(row.attributes.cvss2_score, row.attributes.cvss3_score), new Date(row.attributes.public_date).toLocaleString()]
                };
            }),
            meta: meta,
            isLoading: isLoading
...
var header = [{ title: '', key: 'impact', transforms: [_reactTable.sortable, (0, _reactTable.cellWidth)(10)] }, { title: 'Name', key: 'synopsis', transforms: [_reactTable.sortable, (0, _reactTable.cellWidth)(10)] }, { title: 'Description', key: 'description', transforms: [(0, _reactTable.cellWidth)('max')] }, { title: 'CVSS Base Score', key: 'cvss_score', transforms: [_reactTable.sortable, (0, _reactTable.cellWidth)(10)] }, { title: 'Publish date', key: 'public_date', transforms: [_reactTable.sortable, (0, _reactTable.cellWidth)(10)] }];
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_VulnerabilitiesCves2.default, {
                        ...
                        dataMapper: _DataMapper.createCveListBySystem,
...
var VulnerabilitiesCveTable = function (_Component) {
    ...
    function VulnerabilitiesCveTable() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = VulnerabilitiesCveTable.__proto__ || Object.getPrototypeOf(VulnerabilitiesCveTable)).call.apply(_ref, [this].concat(args))), _this), _this.handleRedirect = function (key) {
            var cve = key.name.title;
            if (location.href.indexOf('vulnerability') !== -1) {
                _this.props.history.push('/cves/' + cve);
            } else {
            ...
            var loader = [].concat((0, _toConsumableArray3.default)(Array(3))).map(function () {
                return {
                    cells: [{
                        ...
                        props: { colSpan: '100%' }
                    }].concat((0, _toConsumableArray3.default)([].concat((0, _toConsumableArray3.default)(Array(header.length - 1))).map(function () {
                        return { title: ' ', props: { style: { display: 'none' } } };
                    })))
                };
            });
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactTable.Table,
                    {
                        ...
                        cells: header,
                        rows: cves.isLoading ? loader : cves.data.map(function (row) {
                            return row.cells;
                        }),
                    ...
                    _react2.default.createElement(_reactTable.TableBody, { onRowClick: function onRowClick(_event, key) {
                            return _this2.handleRedirect(key);
                        } })
                ),
...
var CVSSOptions = [{ value: 'all', label: 'All', disabled: false, from: '', to: '' }, { value: '0to3', label: 'Lower than 3', disabled: false, from: '', to: 3 }, { value: '3to7', label: '3 - 7', disabled: false, from: 3, to: 7 }, { value: '7to10', label: '7 - 10', disabled: false, from: 7, to: 10 }]; /* eslint-disable camelcase */
...
var VulnerabilitiesCveTableToolbar = function (_Component) {
    ...
    function VulnerabilitiesCveTableToolbar() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = VulnerabilitiesCveTableToolbar.__proto__ || Object.getPrototypeOf(VulnerabilitiesCveTableToolbar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            if (!_this.props.cves || _this.props.cves.loading || !_this.props.entity || !_this.props.entity.id) {
                return false;
            }

            return {
                issues: _this.props.cves.data.map(function (_ref2) {
                    var id = _ref2.id;
                    return { id: 'vulnerabilities:' + id, description: id };
                }),
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactCore.GridItem,
                        { span: 3 },
                        _react2.default.createElement(_SimpleTableFilter.SimpleTableFilter, { onFilterChange: function onFilterChange(value) {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                { label: 'CVSS Base Score', fieldId: 'cvssScore' },
                                _react2.default.createElement(
    ...
    function VulnerabilitiesCves() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = VulnerabilitiesCves.__proto__ || Object.getPrototypeOf(VulnerabilitiesCves)).call.apply(_ref, [this].concat(args))), _this), _this.apply = function () {
            ...
            payload && payload.then(function (_ref3) {
                ...
                return (0, _helpers.downloadFile)(data, undefined, format);
            });
        }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
    }
...
exports.fetchCveListBySystem = undefined;

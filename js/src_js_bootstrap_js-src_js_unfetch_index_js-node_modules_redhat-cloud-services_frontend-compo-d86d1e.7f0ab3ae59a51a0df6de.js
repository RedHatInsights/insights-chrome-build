...
/***/ "./src/js/App/QuickStart/quickstartValidation.js":
/*!*******************************************************!*\
  !*** ./src/js/App/QuickStart/quickstartValidation.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var validateQuickstart = function validateQuickstart(key, qs) {
  var _qs$metadata, _qs$spec;

  if (typeof key !== 'string') {
    throw new Error('"key" must be type of string.');
  } else if (typeof (qs === null || qs === void 0 ? void 0 : (_qs$metadata = qs.metadata) === null || _qs$metadata === void 0 ? void 0 : _qs$metadata.name) !== 'string') {
    throw new Error('"qs.metadata.name" must be type of string.');
  } else if (Array.isArray(qs === null || qs === void 0 ? void 0 : (_qs$spec = qs.spec) === null || _qs$spec === void 0 ? void 0 : _qs$spec.task)) {
...
/* harmony import */ var _QuickStart_quickstartValidation__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../QuickStart/quickstartValidation */ "./src/js/App/QuickStart/quickstartValidation.js");
...
var RootApp = function RootApp(props) {
  ...
  var addQuickstart = function addQuickstart(key, qs) {
    return (0,_QuickStart_quickstartValidation__WEBPACK_IMPORTED_MODULE_15__.default)(key, qs) ? !!dispatch(addQuickstart(key, qs)) : false;
  };
...
const reducers = {
    ...
    [_action_types__WEBPACK_IMPORTED_MODULE_2__.ADD_QUICKSTARTS_TO_APP]: _reducers__WEBPACK_IMPORTED_MODULE_0__.addQuickstartstoApp,

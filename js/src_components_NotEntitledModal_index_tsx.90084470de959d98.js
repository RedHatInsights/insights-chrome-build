...
var NotEntitledModal = function() {
    ...
    var _useLocation = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.useLocation)(), search = _useLocation.search, pathname = _useLocation.pathname;
    var params = new URLSearchParams(search);
    var notEntitled = params.has(NOT_ENTITLED_PARAM);
    var notEntitledValue = params.get(NOT_ENTITLED_PARAM);
    var entitlementData = _notEntitledData__WEBPACK_IMPORTED_MODULE_3__["default"].find(function(param) {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Modal, {
        className: "chr-c-error-modal",
        variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.ModalVariant.medium,
        "app-entitlement": entitlementData.emptyID,
        isOpen: true,
        onClose: handleModalToggle,
        "aria-label": entitlementData.emptyTitle,
        header: /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Title, {
            headingLevel: "h2",
            size: "2xl",
            className: "chr-c-error-modal__header"
        }, entitlementData.emptyTitle)
    }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Stack, {
        hasGutter: true,
    ...
    }, entitlementData.image && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement("img", {
    ...
    }, entitlementData.emptyText), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.StackItem, {
        className: "chr-c-error-modal__content--footer"
    }, ((_entitlementData_emptyAction = entitlementData.emptyAction) === null || _entitlementData_emptyAction === void 0 ? void 0 : _entitlementData_emptyAction.primary) && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Button, {
        variant: "primary",
        onClick: function() {
            var _entitlementData_emptyAction, _entitlementData_emptyAction_primary;
    ...
    }, entitlementData.emptyAction.primary.title), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement("section", {
        className: "chr-c-error-modal__content--footer-secondary"
    }, ((_entitlementData_emptyAction1 = entitlementData.emptyAction) === null || _entitlementData_emptyAction1 === void 0 ? void 0 : _entitlementData_emptyAction1.secondary) && entitlementData.emptyAction.secondary.navigate && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Button, {
        variant: "link",
        onClick: function() {
            var _entitlementData_emptyAction, _entitlementData_emptyAction_secondary;
    ...
    }, "Learn more"), ((_entitlementData_emptyAction2 = entitlementData.emptyAction) === null || _entitlementData_emptyAction2 === void 0 ? void 0 : _entitlementData_emptyAction2.secondary) && !entitlementData.emptyAction.secondary.navigate && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Button, {
        variant: "link"
    }, "Learn more"), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Button, {
        variant: "link",

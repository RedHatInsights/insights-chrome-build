...
var keycloak_js_1 = __importDefault(__webpack_require__(/*! @redhat-cloud-services/keycloak-js */ "./node_modules/@redhat-cloud-services/keycloak-js/dist/keycloak.js"));
var Priv = (function () {
    function Priv() {
        this._cookie;
        this._keycloak = {};
    ...
    Priv.prototype.setKeycloak = function (options, onTokenExpired, onAuthSuccess, onAuthRefreshSuccess) {
        this._keycloak = (0, keycloak_js_1.default)(options);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    kc = (0, keycloak_js_1.default)(options);

...
const FavoritesLink = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { className: "chr-c-button-masthead disabled", component: (props) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_2__["default"], { ...props, href: "/FavoritedServices" }), isDisabled: true },
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_scalprum_react_core__WEBPACK_IMPORTED_MODULE_1__.ScalprumProvider, { ...scalprumProviderProps },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Routes, null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/favoritedservices", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_12__["default"] },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_FavoritedServices__WEBPACK_IMPORTED_MODULE_9__["default"], null)) }),
...
/* harmony import */ var _components_ChromeLink__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/ChromeLink */ "./src/components/ChromeLink/index.ts");
/* harmony import */ var _FavoritedServices_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./FavoritedServices.scss */ "./src/layouts/FavoritedServices.scss");
...
const FavoritedServices = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: "chrome-app-render-root" },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Page, { onPageResize: null, header: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Masthead, { className: "chr-c-masthead" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Header_Header__WEBPACK_IMPORTED_MODULE_2__.Header, null)) },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "chr-render" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Stratosphere_RedirectBanner__WEBPACK_IMPORTED_MODULE_3__["default"], null),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants.light, className: "pf-m-fill" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Stack, { className: "chr-l-stack-favoritedservices pf-u-background-color-100 pf-u-pl-lg" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.StackItem, { className: "chr-l-stack__item-centered" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: "https://console.redhat.com/apps/frontend-assets/favoritedservices/favoriting-emptystate.svg", alt: "favoriting image" })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.StackItem, { className: "chr-l-stack__item-centered pf-u-mt-md" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: "h3", className: "pf-m-center" }, "No favorited services"),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: "small", className: "pf-u-mt-sm" }, "Add a service to your favorites to get started here."))),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.StackItem, { className: "chr-l-stack__item-centered pf-u-mt-md" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { variant: "primary", alt: "View all services", component: (props) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ChromeLink__WEBPACK_IMPORTED_MODULE_5__["default"], { ...props, href: "/AllServices" }) }, "View all services")))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Footer_Footer__WEBPACK_IMPORTED_MODULE_4__["default"], null)))));

            ...
            return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_3__["default"].clipboardCopy, variant === 'inline-compact' && _patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_3__["default"].modifiers.inline, isBlock && _patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_3__["default"].modifiers.block, this.state.expanded && _patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_3__["default"].modifiers.expanded, className) }, divProps, (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getOUIAProps)(ClipboardCopy.displayName, ouiaId, ouiaSafe)),
                ...
                variant !== 'inline-compact' && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_helpers_GenerateId_GenerateId__WEBPACK_IMPORTED_MODULE_5__.GenerateId, { prefix: "" }, (id) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_3__["default"].clipboardCopyGroup) },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_TextInput__WEBPACK_IMPORTED_MODULE_8__.TextInput, Object.assign({ readOnlyVariant: isReadOnly || this.state.expanded ? 'default' : undefined, onChange: this.updateText, value: this.state.text, id: `text-input-${id}`, "aria-label": textAriaLabel }, (isCode && { dir: 'ltr' }))),
...
const ClipboardCopyAction = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_3__["default"].clipboardCopyActionsItem, className) }, props), children));
};
...
const ClipboardCopyButton = (_a) => {
    var { onClick, exitDelay = 0, entryDelay = 300, maxWidth = '100px', position = 'top', 'aria-label': ariaLabel = 'Copyable input', id, textId, children, variant = 'control', onTooltipHidden = () => { } } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["onClick", "exitDelay", "entryDelay", "maxWidth", "position", 'aria-label', "id", "textId", "children", "variant", "onTooltipHidden"]);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Tooltip__WEBPACK_IMPORTED_MODULE_2__.Tooltip, { trigger: "mouseenter focus click", triggerRef: triggerRef, exitDelay: exitDelay, entryDelay: entryDelay, maxWidth: maxWidth, position: position, "aria-live": "polite", aria: "none", content: react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, children), onTooltipHidden: onTooltipHidden },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Button__WEBPACK_IMPORTED_MODULE_3__.Button, Object.assign({ type: "button", variant: variant, onClick: onClick, "aria-label": ariaLabel, id: id, "aria-labelledby": `${id} ${textId}` }, props, { ref: triggerRef }),
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?dc4e");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-styles/css/components/ClipboardCopy/clipboard-copy */ "./node_modules/@patternfly/react-styles/css/components/ClipboardCopy/clipboard-copy.js");
...
const ClipboardCopyToggle = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Button__WEBPACK_IMPORTED_MODULE_2__.Button, Object.assign({ type: "button", variant: "control", onClick: onClick, id: id, "aria-labelledby": `${id} ${textId}`, "aria-controls": `${id} ${contentId}`, "aria-expanded": isExpanded }, props),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_3__.css)(_patternfly_react_styles_css_components_ClipboardCopy_clipboard_copy__WEBPACK_IMPORTED_MODULE_4__["default"].clipboardCopyToggleIcon) },
...
__webpack_require__(/*! ./clipboard-copy.css */ "?9b31");
exports["default"] = {

...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-router-dom */ "webpack/sharing/consume/default/react-router-dom/react-router-dom");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_router_dom__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _GlobalFilterMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./GlobalFilterMenu */ "./src/components/GlobalFilter/GlobalFilterMenu.tsx");
/* harmony import */ var _filterApi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./filterApi */ "./src/components/GlobalFilter/filterApi.ts");
...
const useLoadTags = (hasAccess = false) => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((activeTags, search) => {
        (0,_filterApi__WEBPACK_IMPORTED_MODULE_5__.storeFilter)(activeTags, hasAccess && !isDisabled, navigate);
...
const GlobalFilter = ({ hasAccess }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        setValue(() => (0,_globalFilterApi__WEBPACK_IMPORTED_MODULE_6__.generateFilter)());
    }, []);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_GlobalFilterMenu__WEBPACK_IMPORTED_MODULE_4__.GlobalFilterDropdown, { allowed: hasAccess, isDisabled: isDisabled, filter: filter, chips: [...chips.filter(({ key }) => key === 'Workloads'), ...chips.filter(({ key }) => key !== 'Workloads')], setValue: setValue, selectedTags: selectedTags, isOpen: isOpen, filterTagsBy: filterTagsBy, setIsOpen: (isOpen) => setIsOpen(!!isOpen) }));
};
...
/* harmony import */ var _utils_chromeHistory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/chromeHistory */ "./src/utils/chromeHistory.ts");
/* harmony import */ var _layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../layouts/DefaultLayout */ "./src/layouts/DefaultLayout.tsx");
...
/* harmony import */ var _analytics_SegmentContext__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../analytics/SegmentContext */ "./src/analytics/SegmentContext.ts");
/* harmony import */ var _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../utils/loading-fallback */ "./src/utils/loading-fallback.tsx");
/* harmony import */ var _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../utils/isAnsibleTrialFlagActive */ "./src/utils/isAnsibleTrialFlagActive.ts");
...
const Navigation = (0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/*! import() */[__webpack_require__.e("src_components_Navigation_componentMapper_ts"), __webpack_require__.e("src_components_Navigation_index_tsx")]).then(__webpack_require__.bind(__webpack_require__, /*! ../Navigation */ "./src/components/Navigation/index.tsx")));
const LandingNav = (0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/*! import() */[__webpack_require__.e("src_components_Navigation_componentMapper_ts"), __webpack_require__.e("src_components_LandingNav_index_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../LandingNav */ "./src/components/LandingNav/index.ts")));
...
const loaderWrapper = (Component, props = {}) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Navigation_Loader__WEBPACK_IMPORTED_MODULE_7__["default"], null) },
...
const ScalprumRoot = ({ config, helpTopicsAPI, quickstartsAPI, ...props }) => {
    ...
    const { analytics } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_analytics_SegmentContext__WEBPACK_IMPORTED_MODULE_12__["default"]);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const unregister = _utils_chromeHistory__WEBPACK_IMPORTED_MODULE_5__["default"].listen(_utils_historyListener__WEBPACK_IMPORTED_MODULE_10__["default"]);
        return () => {
    ...
    const scalprumProviderProps = {
        ...
        api: {
            chrome: {
                ...
                isFedramp: (0,_utils_common__WEBPACK_IMPORTED_MODULE_11__.isFedRamp)(),
                usePendoFeedback: _Feedback__WEBPACK_IMPORTED_MODULE_8__.usePendoFeedback,
                segment: {
                    setPageMetadata,
                },
                toggleFeedbackModal: (...args) => dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_9__.toggleFeedbackModal)(...args)),
                ...
                clearAnsibleTrialFlag: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_14__.clearAnsibleTrialFlag,
                isAnsibleTrialFlagActive: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_14__.isAnsibleTrialFlagActive,
                setAnsibleTrialFlag: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_14__.setAnsibleTrialFlag,
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_scalprum_react_core__WEBPACK_IMPORTED_MODULE_1__.ScalprumProvider, { ...scalprumProviderProps },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Routes, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { index: true, path: "/", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_6__["default"], { Sidebar: loaderWrapper(LandingNav), ...props, globalFilterRemoved: globalFilterRemoved }) }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/connect/products", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_13__["default"] },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ProductSelection, null)) }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/connect/*", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_6__["default"], { ...props, globalFilterRemoved: globalFilterRemoved }) }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/security", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_6__["default"], { ...props, globalFilterRemoved: globalFilterRemoved }) }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "*", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_6__["default"], { Sidebar: loaderWrapper(Navigation), ...props, globalFilterRemoved: globalFilterRemoved }) }))));
};
...
const ShieldedRoot = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ hideNav = false, isGlobalFilterEnabled = false, initialized = false, Sidebar }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.Page, { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ 'chr-c-page__hasBanner': hasBanner, 'chr-c-page__account-banner': selectedAccountNumber }), onPageResize: null, header: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.Masthead, { className: "chr-c-masthead" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('chr-render', { 'pf-u-h-100vh': !isGlobalFilterEnabled }) },

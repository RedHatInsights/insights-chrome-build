...
/* harmony export */   TestPluginStore: () => (/* binding */ TestPluginStore),
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?1a75");
...
class PluginLoader {
    constructor(options = {}) {
        ...
        this.options = {
            ...
            transformPluginManifest: options.transformPluginManifest ?? (lodash_identity__WEBPACK_IMPORTED_MODULE_9___default()),
    ...
    async loadPluginScripts(manifest, data) {
        ...
        const [, rejectedReasons] = await settleAllPromises(manifest.loadScripts.map((scriptName) => {
            ...
            const scriptURL = resolveURL(manifest.baseURL, scriptName, (url) => {
                url.searchParams.set('cacheBuster', (0,uuid__WEBPACK_IMPORTED_MODULE_14__["default"])());
                return url;
            });
...
class PluginStore {
    ...
    async loadPlugin(manifest, forceReload) {
        ...
        const promise = (async () => {
            ...
            if (result.success) {
                ...
                consoleLogger.error(`Plugin ${pluginName} has failed to load`, ...lodash_compact__WEBPACK_IMPORTED_MODULE_5___default()([errorMessage, errorCause]));
            }
    ...
    addLoadedPlugin(manifest, entryModule) {
        const pluginName = manifest.name;
        const buildHash = manifest.buildHash ?? (0,uuid__WEBPACK_IMPORTED_MODULE_14__["default"])();
 ...
 */
const usePluginInfo = () => {
    return usePluginSubscription(eventTypes$1, getData, (lodash_isEqual__WEBPACK_IMPORTED_MODULE_6___default()));
};

...
const Footer = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.PageSection, { className: "pf-m-no-fill pf-u-mt-auto" },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("footer", { role: "contentinfo", id: "hcc-footer", className: "chr-c-footer pf-l-flex pf-m-column pf-m-row-on-lg pf-m-align-items-center-on-lg" },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { href: "https://www.redhat.com", target: "_blank", rel: "noopener noreferrer" },
                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement("img", { src: "https://console.redhat.com/apps/frontend-assets/console-logos/Logo-Red_Hat-A-Standard-RGB.svg", alt: "Red Hat logo", width: "145px", height: "613px" })),
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "\n            pf-l-flex pf-m-column\n            pf-m-row-on-lg\n            pf-m-flex-1-on-lg\n            pf-m-justify-content-flex-end-on-lg" },
                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", { className: "pf-u-color-200 pf-u-font-size-sm pf-m-spacer-xl-on-lg" }, "\u00A92023 Red Hat, Inc."),
                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement("ul", { className: "pf-u-font-size-sm pf-l-flex pf-m-column pf-m-row-on-md" },
                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", null,
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Button, { variant: "link", className: "pf-u-p-0", onClick: () => setIsModalOpen(true), isInline: true }, "Browser Support")),
                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", null,
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { href: "https://www.redhat.com/en/about/privacy-policy" }, "Privacy Policy")),
                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", null,
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { href: "https://access.redhat.com/help/terms/" }, "Terms of Use")),
                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", null,
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { href: "https://www.redhat.com/en/about/all-policies-guidelines" }, "All Policies and Guidelines")),
                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", null,
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { id: "teconsent" })))))),

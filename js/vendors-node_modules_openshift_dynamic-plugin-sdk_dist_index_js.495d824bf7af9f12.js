...
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! lodash-es */ "./node_modules/lodash-es/isEqualWith.js");
...
/**
  ...
  buildDate      : March 2, 2023
  buildTime      : 4:33:01 PM GMT+1
  gitCommit      : 9d5c5666c8a2b097be330f065abb2ac3b0e8c661
  gitBranch      : main
 */
...
const pluginRuntimeMetadataSchema = yup__WEBPACK_IMPORTED_MODULE_1__.object().required().shape({
    ...
    customProperties: yup__WEBPACK_IMPORTED_MODULE_1__.object(),
});
/**
 * Schema for `PluginManifest` objects.
 */
const pluginManifestSchema = pluginRuntimeMetadataSchema.shape({
    baseURL: yup__WEBPACK_IMPORTED_MODULE_1__.string().required(),
...
class PluginStore {
    ...
    addPlugin(manifest, entryModule) {
        ...
        const loadedExtensions = lodash_es__WEBPACK_IMPORTED_MODULE_11__["default"](manifest.extensions).map((e, index) => decodeCodeRefs({
            ...e,
            pluginName,
...
const isSameData$1 = (prevData, nextData) => lodash_es__WEBPACK_IMPORTED_MODULE_14__["default"](prevData, nextData, (a, b) => a === b);
/**
    ...
    react__WEBPACK_IMPORTED_MODULE_2__.useEffect(() => {
        ...
        settleAllPromises(extensions.map(resolveCodeRefValues)).then(([fulfilledValues, rejectedReasons]) => {
            ...
            if (rejectedReasons.length > 0) {
                ...
                const failedPluginNames = lodash_es__WEBPACK_IMPORTED_MODULE_15__["default"](rejectedReasons
...
const { safeRe: re, t } = __webpack_require__(/*! ../internal/re */ "./node_modules/@openshift/dynamic-plugin-sdk/node_modules/semver/internal/re.js")
...
const { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = __webpack_require__(/*! ../internal/constants */ "./node_modules/@openshift/dynamic-plugin-sdk/node_modules/semver/internal/constants.js")
...
const parse = __webpack_require__(/*! ./parse.js */ "./node_modules/@openshift/dynamic-plugin-sdk/node_modules/semver/functions/parse.js")
...
const {
  ...
  MAX_SAFE_BUILD_LENGTH,
  MAX_LENGTH,
} = __webpack_require__(/*! ./constants */ "./node_modules/@openshift/dynamic-plugin-sdk/node_modules/semver/internal/constants.js")

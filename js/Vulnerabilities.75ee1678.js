                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    CVSSOptions.map(function (option, index) {
                                        return _react2.default.createElement(_reactCore.SelectOption, { isDisabled: option.disabled, key: index, value: option.value, label: option.label });
                                    })
                                )
                            )
                        )
...
function parseCvssScore(cvssV2, cvssV3) {
    return cvssV3 && parseFloat(cvssV3).toFixed(2) || cvssV2 && parseFloat(cvssV2).toFixed(2) + ' (v2)' || 'N/A';
}
...
//# sourceMappingURL=/insightsbeta/static/chrome/js/Vulnerabilities.75ee1678.map
...
const FavoritesLink = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { className: "chr-c-button-masthead pf-u-px-lg-on-md disabled", component: (props) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_2__["default"], { ...props, href: "/FavoritedServices" }), isDisabled: true },
...
const AllServices = () => {
    const { linkSections, error, ready, filterValue, setFilterValue } = (0,_hooks_useAllServices__WEBPACK_IMPORTED_MODULE_8__["default"])();
    const intl = (0,react_intl__WEBPACK_IMPORTED_MODULE_10__["default"])();
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants.light, className: "pf-m-fill" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Stack, { className: "chr-l-stack-allservices pf-u-background-color-100" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.StackItem, { className: "pf-u-pl-lg pf-u-pb-md-on-md" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.SearchInput, { className: "chr-c-all-services-filter", "data-ouia-component-id": "app-filter-search", placeholder: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_9__["default"].findAppOrService), value: filterValue, onChange: (val) => setFilterValue(val), onClear: (e) => {
                                    setFilterValue('');
                                    e.stopPropagation();
                                } })),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.StackItem, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Gallery, { hasGutter: true },
                                linkSections.map((section, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_AllServices_AllServicesSection__WEBPACK_IMPORTED_MODULE_5__["default"], { key: index, ...section }))),

"use strict";
(self["webpackChunkinsights_chrome"] = self["webpackChunkinsights_chrome"] || []).push([["src_js_App_Stratosphere_ProductSelection_tsx"],{
...
/***/ "./src/js/App/Stratosphere/footer.scss":
/*!*********************************************!*\
  !*** ./src/js/App/Stratosphere/footer.scss ***!
  \*********************************************/
...
/***/ "./src/js/App/Stratosphere/product-card.scss":
/*!***************************************************!*\
  !*** ./src/js/App/Stratosphere/product-card.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/App/Stratosphere/product-selection.scss":
/*!********************************************************!*\
  !*** ./src/js/App/Stratosphere/product-selection.scss ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/App/Stratosphere/Footer.tsx":
/*!********************************************!*\
  !*** ./src/js/App/Stratosphere/Footer.tsx ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @patternfly/react-core */ "webpack/sharing/consume/default/@patternfly/react-core/@patternfly/react-core?9cbb");
...
/* harmony import */ var _footer_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./footer.scss */ "./src/js/App/Stratosphere/footer.scss");
...
/***/ "./src/js/App/Stratosphere/ProductCard.tsx":
/*!*************************************************!*\
  !*** ./src/js/App/Stratosphere/ProductCard.tsx ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _product_card_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./product-card.scss */ "./src/js/App/Stratosphere/product-card.scss");
...
const ProductCard = ({ img, description, link, order }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `chr-c-product-card__footer footer-${order}` },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Sidenav_Navigation_ChromeLink__WEBPACK_IMPORTED_MODULE_2__.default, { className: "chr-c-product-card__link", href: link.href, appId: link.appId },
                link.label,
                "\u00A0",
...
/***/ "./src/js/App/Stratosphere/ProductSelection.tsx":
/*!******************************************************!*\
  !*** ./src/js/App/Stratosphere/ProductSelection.tsx ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _products_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./products-list */ "./src/js/App/Stratosphere/products-list.ts");
/* harmony import */ var _ProductCard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ProductCard */ "./src/js/App/Stratosphere/ProductCard.tsx");
/* harmony import */ var _Header_Header__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Header/Header */ "./src/js/App/Header/Header.js");
/* harmony import */ var _Sidenav_Navigation_ChromeLink__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Sidenav/Navigation/ChromeLink */ "./src/js/App/Sidenav/Navigation/ChromeLink.tsx");
/* harmony import */ var _Footer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Footer */ "./src/js/App/Stratosphere/Footer.tsx");
/* harmony import */ var _product_selection_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./product-selection.scss */ "./src/js/App/Stratosphere/product-selection.scss");
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Bullseye, null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextContent, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, null,
                                ...
                                ' ',
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Sidenav_Navigation_ChromeLink__WEBPACK_IMPORTED_MODULE_5__.default, { href: "/insights/subscriptions/rhel", appId: "subscriptions" }, "subscriptions."))))))),
...
/***/ "./src/js/App/Stratosphere/products-list.ts":
/*!**************************************************!*\
  !*** ./src/js/App/Stratosphere/products-list.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

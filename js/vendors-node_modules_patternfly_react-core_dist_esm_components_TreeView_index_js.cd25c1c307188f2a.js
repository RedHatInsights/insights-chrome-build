...
const TreeView = (_a) => {
    var { data, isNested = false, hasCheckboxes = false, hasBadges = false, hasGuides = false, hasSelectableNodes = false, variant = 'default', defaultAllExpanded = false, allExpanded, icon, isMultiSelectable = false, expandedIcon, parentItem, onSelect, onCheck, onExpand, onCollapse, toolbar, activeItems, compareItems = (item, itemToCheck) => item.id === itemToCheck.id, className, useMemo, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledby } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["data", "isNested", "hasCheckboxes", "hasBadges", "hasGuides", "hasSelectableNodes", "variant", "defaultAllExpanded", "allExpanded", "icon", "isMultiSelectable", "expandedIcon", "parentItem", "onSelect", "onCheck", "onExpand", "onCollapse", "toolbar", "activeItems", "compareItems", "className", "useMemo", 'aria-label', 'aria-labelledby']);
    const treeViewList = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_TreeViewList__WEBPACK_IMPORTED_MODULE_2__.TreeViewList, { isNested: isNested, toolbar: toolbar, isMultiSelectable: isMultiSelectable, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby }, data.map((item) => {
        var _a, _b;
...
/* harmony import */ var _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-styles/css/components/TreeView/tree-view.mjs */ "./node_modules/@patternfly/react-styles/css/components/TreeView/tree-view.mjs");
...
const TreeViewList = (_a) => {
    var { isNested = false, isMultiSelectable = false, toolbar, children, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledby } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["isNested", "isMultiSelectable", "toolbar", "children", 'aria-label', 'aria-labelledby']);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_3__.css)(`${_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].treeView}__list`), role: isNested ? 'group' : 'tree', "aria-multiselectable": isNested ? undefined : isMultiSelectable, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby }, props), children)));
};
...
/* harmony import */ var _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @patternfly/react-styles/css/components/TreeView/tree-view.mjs */ "./node_modules/@patternfly/react-styles/css/components/TreeView/tree-view.mjs");
...
useMemo }) => {
    ...
    const renderToggle = (randomId) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ToggleComponent, Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeToggle), onClick: (evt) => {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeToggleIcon) },
    ...
    const renderCheck = (randomId) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeCheck) },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", Object.assign({ type: "checkbox", onChange: (evt) => onCheck && onCheck(evt, itemData, parentItem), onClick: (evt) => evt.stopPropagation(), ref: (elem) => elem && (elem.indeterminate = checkProps.checked === null) }, checkProps, { checked: isCheckboxChecked, id: randomId, tabIndex: -1 }))));
    const iconRendered = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeIcon) },
    ...
    const renderNodeContent = () => {
        const content = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
            isCompact && title && react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeTitle) }, title),
            isSelectable ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { tabIndex: -1, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeText), type: "button" }, name)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeText) }, name))));
        return isCompact ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeContent) }, content) : content;
    };
    const badgeRendered = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        hasBadge && children && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeCount) },
        ...
        hasBadge && !children && customBadgeContent !== undefined && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeCount) },
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", Object.assign({ id: id, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewListItem, internalIsExpanded && _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers.expanded), "aria-expanded": internalIsExpanded, role: "treeitem", tabIndex: -1 }, (hasCheckbox && { 'aria-checked': isCheckboxChecked }), (!hasCheckbox && { 'aria-selected': isSelected })),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewContent) },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_helpers_GenerateId_GenerateId__WEBPACK_IMPORTED_MODULE_5__.GenerateId, { prefix: isSelectable ? 'selectable-id' : 'checkbox-id' }, (randomId) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Component, Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNode, children && (isSelectable || hasCheckbox) && _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers.selectable, isSelected && _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].modifiers.current), onClick: (evt) => {
                    if (!hasCheckbox) {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewNodeContainer) },
                    children && renderToggle(randomId),
                    hasCheckbox && renderCheck(randomId),
                    icon && iconRendered,
                    renderNodeContent(),
                    badgeRendered)))),
            action && react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_1__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].treeViewAction) }, action)),
...
/* harmony import */ var _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-styles/css/components/TreeView/tree-view.mjs */ "./node_modules/@patternfly/react-styles/css/components/TreeView/tree-view.mjs");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers */ "./node_modules/@patternfly/react-core/dist/esm/helpers/KeyboardHandler.js");
...
class TreeViewRoot extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        ...
        this.handleKeys = (event) => {
            ...
            if (!this.treeRef.current.contains(event.target) ||
                !event.target.classList.contains(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeViewNode)) {
                return;
            }
            const activeElement = document.activeElement;
            const key = event.key;
            const treeItems = Array.from((_a = this.treeRef.current) === null || _a === void 0 ? void 0 : _a.getElementsByClassName(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeViewNode)).filter((el) => !el.classList.contains('pf-m-disabled'));
            if (key === _helpers_constants__WEBPACK_IMPORTED_MODULE_2__.KeyTypes.Space) {
                activeElement.click();
                event.preventDefault();
            }
            (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.handleArrows)(event, treeItems, (element) => activeElement === element, undefined, [], undefined, true, true);
            if (['ArrowLeft', 'ArrowRight'].includes(key)) {
                const isExpandable = (_c = (_b = activeElement === null || activeElement === void 0 ? void 0 : activeElement.firstElementChild) === null || _b === void 0 ? void 0 : _b.firstElementChild) === null || _c === void 0 ? void 0 : _c.classList.contains(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeViewNodeToggle);
        ...
        this.handleKeysCheckbox = (event) => {
            ...
            const treeNodes = Array.from((_a = this.treeRef.current) === null || _a === void 0 ? void 0 : _a.getElementsByClassName(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeViewNode));
            (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.handleArrows)(event, treeNodes, (element) => element.contains(activeElement), (element) => element.querySelector('button,input'), [], undefined, true, true);
            if (['ArrowLeft', 'ArrowRight'].includes(key)) {
                if (key === 'ArrowLeft') {
        ...
        this.variantStyleModifiers = {
            default: '',
            compact: _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.compact,
            compactNoBackground: [_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.compact, _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.noBackground]
        };
    }
    componentDidMount() {
        var _a;
        ...
        if (this.props.hasCheckboxes || this.props.hasSelectableNodes) {
            const firstToggle = this.treeRef.current.getElementsByClassName(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeViewNodeToggle)[0];
            if (firstToggle) {
            ...
            if (this.props.hasSelectableNodes) {
                const firstTextButton = this.treeRef.current.getElementsByClassName(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeViewNodeText)[0];
                if (firstTextButton) {
            ...
            ((_a = this.treeRef.current) === null || _a === void 0 ? void 0 : _a.getElementsByClassName(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeViewNode)[0]).tabIndex = 0;
        }
    }
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_6__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].treeView, hasGuides && _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.guides, this.variantStyleModifiers[variant], className), ref: this.treeRef }, props), children));
    }
}
...
/* harmony import */ var _patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @patternfly/react-styles/css/components/TreeView/tree-view.mjs */ "./node_modules/@patternfly/react-styles/css/components/TreeView/tree-view.mjs");
/* harmony import */ var _patternfly_react_styles_css_components_FormControl_form_control_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-styles/css/components/FormControl/form-control.mjs */ "./node_modules/@patternfly/react-styles/css/components/FormControl/form-control.mjs");
...
const TreeViewSearch = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_TreeView_tree_view_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].treeViewSearch, className) },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_FormControl_form_control_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].formControl, _patternfly_react_styles_css_components_FormControl_form_control_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].modifiers.icon) },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_FormControl_form_control_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].formControlUtilities) },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_FormControl_form_control_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].formControlIcon) },
...
/* harmony export */ });
/* harmony import */ var _tree_view_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tree-view.css */ "?06e5");

...
var _logoCs = _interopRequireDefault(require("../../../../static/images/logo-cs.svg"));
...
exports.default = _default;
},{"react":"ccIB","../../../../static/images/logo-cs.svg":"/fGt"}],"i1dc":[function(require,module,exports) {
"use strict";
...
var Brand = function Brand(_ref) {
  ...
  return _react.default.createElement("div", {
    className: "pf-l-page__header-brand pf-c-page__header-brand"
    ...
    className: "pf-l-page__header-brand-link pf-c-page__header-brand-link",
    href: "./"
...
exports.default = _default;
},{"react":"ccIB","@patternfly/react-core/dist/esm/components/Dropdown":"7GBR","prop-types":"3/B0","react-redux":"IZTr"}],"8L7b":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  function UserIcon() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UserIcon).apply(this, arguments));
  }

  _createClass(UserIcon, [{
    key: "render",
    value: function render() {
      var account = this.props.account; // If a user has an image, it gets returned as 140x140px
      // Check to see if the user has an image by looking at the width

      var img = new Image();
      img.src = "https://access.redhat.com/api/users/avatar/".concat(account.login, "/");
      var fallback = 'apps/chrome/assets/images/img_avatar.svg';
      return _react.default.createElement(_Avatar.Avatar, {
        src: img.width === 140 ? img.src : fallback
      });
    }
  }]);
...
var _default = (0, _reactRedux.connect)(function (_ref) {
  var login = _ref.chrome.user.login;
  return {
    account: {
      login: login
    }
...
exports.default = _default;
},{"react":"ccIB","@patternfly/react-core/dist/esm/components/Avatar":"15FK","prop-types":"3/B0","react-redux":"IZTr"}],"i78E":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  _createClass(ToolbarToggle, [{
    ...
    value: function onClick(_ev, url) {
      window.location = "".concat(document.baseURI, "/").concat(url);
    }
  }, {
    key: "render",
    value: function render() {
...
function (_Component) {
  ...
  function InsightsAbout(props) {
    ...
    _this.updateAppVersion = _this.updateAppVersion.bind(_assertThisInitialized(_this));
    return _this;
  }
    ...
    value: function componentDidMount() {
      ...
      this.state.appDetails.apps.forEach(function (app) {
        fetch(app.path).then(function (response) {
          ...
          return _this2.updateAppVersion(app, data.src_hash, data.build_id);
        });
      });
    }
  }, {
...
exports.default = _default;
},{"react":"ccIB","@patternfly/react-core":"Tk4w","../../../../static/images/logo-cs.svg":"/fGt","react-redux":"IZTr","./InsightsAbout.scss":"/LHF"}],"uZ0D":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  function Tools(props) {
    ...
    _this.onModalToggle = _this.onModalToggle.bind(_assertThisInitialized(_this));
    aboutButton.onClick = _this.onModalToggle.bind(_assertThisInitialized(_this));
    _this.state = {
      isModalOpen: false
    };
    return _this;
...
var _default = Tools;
exports.default = _default;
},{"react":"ccIB","@patternfly/react-core/dist/esm/components/Button":"CjT+","@patternfly/react-core/dist/esm/layouts/Toolbar":"f7TI","@patternfly/react-core/dist/esm/components/Dropdown":"7GBR","@patternfly/react-icons/dist/esm/icons/question-circle-icon":"wdXW","./UserToggle":"ZPuf","./UserIcon":"8L7b","./ToolbarToggle":"i78E","./InsightsAbout":"ocEB"}],"1PeJ":[function(require,module,exports) {
"use strict";
    ...
    value: function onClick(_event, item, parent) {
      ...
      if (parent && parent.active) {
        ...
        if (item.group && activeGroup === item.group) {
          ...
          var prefix = item.group || parent ? parent.id : '';
          window.location.href = "".concat(basepath).concat(prefix).concat(prefix ? '/' : '').concat(item.id);
        }
      }
    }
  }, {
          ...
          if (item.subItems) {
            return _react.default.createElement(_Nav.NavExpandable, {
              ...
              return _react.default.createElement(_NavigationItem.default, {
                ...
                key: subKey,
                title: subItem.title,
                parent: "".concat(activeLocation, "/").concat(item.id),
...
function stateToProps(_ref2) {
  var _ref2$chrome = _ref2.chrome,
      ...
      navHidden = _ref2$chrome.navHidden,
      activeLocation = _ref2$chrome.activeLocation,
      activeGroup = _ref2$chrome.activeGroup;
  return {
    settings: globalNav,
    activeApp: activeApp,
    navHidden: navHidden,
...
function (_Component) {
  ...
  _createClass(SideNav, [{
    key: "render",
    value: function render() {
      var activeTechnology = this.props.activeTechnology;
      ...
      }, activeTechnology)), _react.default.createElement(_Navigation.default, null));
    }
  }]);
...
var _default = (0, _reactRedux.connect)(function (_ref) {
  var activeTechnology = _ref.chrome.activeTechnology;
  return {
...
exports.default = _default;
},{"react":"ccIB","prop-types":"3/B0","./Navigation":"iurj","@patternfly/react-core/dist/esm/layouts/Split":"azXe","@patternfly/react-icons/dist/esm/icons/home-icon":"QV0D","react-redux":"IZTr"}],"Sz1i":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/beta/apps/chrome/js/App.f4d16d32.map
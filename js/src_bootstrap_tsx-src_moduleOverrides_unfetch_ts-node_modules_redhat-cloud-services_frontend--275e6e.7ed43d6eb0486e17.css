...
.chr-c-search__input .pf-c-text-input-group__text:hover::before, .chr-c-search__input .pf-c-text-input-group__text:hover::after {
  border-color: var(--pf-global--palette--black-600);
}
...
/*!******************************************************************************************************************************************************************************************************************************************!*\
  ...
  \******************************************************************************************************************************************************************************************************************************************/
.chr-c-search__item__description > p > span {
  color: red;
}

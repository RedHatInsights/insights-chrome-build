    ...
    (0, _createClass3.default)(LongTextTooltip, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = (0, _objectWithoutProperties3.default)(_props, ['content', 'maxLength', 'tooltipMaxWidth', 'tooltipPosition']);

            return _react2.default.createElement(
                _react2.default.Fragment,
                null,
                content.length > maxLength ? _react2.default.createElement(
                    _reactCore.Tooltip,
                    (0, _extends3.default)({
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        this.truncate(content, maxLength)
                    )
                ) : _react2.default.createElement(
                    'span',
                    null,
    ...
    (0, _createClass3.default)(Shield, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                tooltipPrefix = _props.tooltipPrefix,
                title = _props.title,
                size = _props.size,
                impact = _props.impact,
                rest = (0, _objectWithoutProperties3.default)(_props, ['tooltipPosition', 'hasTooltip', 'tooltipPrefix', 'title', 'size', 'impact']);


            return _react2.default.createElement(
                _react2.default.Fragment,
                null,
                hasTooltip === true ? _react2.default.createElement(
                    _reactCore.Tooltip,
                    (0, _extends3.default)({
                        position: tooltipPosition,
                        content: _react2.default.createElement(
                            'div',
                            null,
                            tooltipPrefix + (title || badge.title)
                        )
                    }, rest),
                    badge.icon
                ) : _react2.default.createElement(
            ...
            data: data.map(function (row) {
                return {
                    ...
                    cells: [_react2.default.createElement(
                        'span',
                        { key: row.id },
                        _react2.default.createElement(_Shield.Shield, { impact: row.attributes.impact, tooltipPosition: 'right', hasTooltip: true })
                    ), _react2.default.createElement(
                        'span',
                        { key: row.id },
                        ...
                        'span',
                        { key: row.id },
                        _react2.default.createElement(_LongTextTooltip.LongTextTooltip, { content: row.attributes.description, tooltipMaxWidth: '50vw', entryDelay: 1200, maxLength: 200 })
                    ), _react2.default.createElement(
                        'span',
                        { key: row.id },
                        (0, _helpers.parseCvssScore)(row.attributes.cvss2_score, row.attributes.cvss3_score)
                    ), _react2.default.createElement(
                        'span',
...
var BASE_ROUTE = '/api/vulnerability/';
var API_VERSION = 'v1';
...
//# sourceMappingURL=/beta/apps/chrome/js/Vulnerabilities.6befd417.map
"use strict";
(self["webpackChunkinsights_chrome"] = self["webpackChunkinsights_chrome"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_components_Label_Label_js"],{
...
/* harmony import */ var _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Label/label.mjs */ "./node_modules/@patternfly/react-styles/css/components/Label/label.mjs");
/* harmony import */ var _patternfly_react_styles_css_components_Label_label_group_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Label/label-group.mjs */ "./node_modules/@patternfly/react-styles/css/components/Label/label-group.mjs");
...
/* harmony import */ var _Tooltip__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Tooltip */ "./node_modules/@patternfly/react-core/dist/esm/components/Tooltip/Tooltip.js");
...
/* harmony import */ var _patternfly_react_tokens_dist_esm_c_label_text_MaxWidth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @patternfly/react-tokens/dist/esm/c_label__text_MaxWidth */ "./node_modules/@patternfly/react-tokens/dist/esm/c_label__text_MaxWidth.js");
...
const colorStyles = {
    blue: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.blue,
    cyan: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.cyan,
    green: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.green,
    orange: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.orange,
    purple: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.purple,
    red: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.red,
    gold: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.gold,
    grey: ''
};
const Label = (_a) => {
    var { children, className = '', color = 'grey', variant = 'filled', isCompact = false, isDisabled = false, isEditable = false, editableProps, textMaxWidth, tooltipPosition, icon, onClose, onClick: onLabelClick, onEditCancel, onEditComplete, closeBtn, closeBtnAriaLabel, closeBtnProps, href, isOverflowLabel, render } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__rest)(_a, ["children", "className", "color", "variant", "isCompact", "isDisabled", "isEditable", "editableProps", "textMaxWidth", "tooltipPosition", "icon", "onClose", "onClick", "onEditCancel", "onEditComplete", "closeBtn", "closeBtnAriaLabel", "closeBtnProps", "href", "isOverflowLabel", "render"]);
    ...
    const defaultCloseButton = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Button__WEBPACK_IMPORTED_MODULE_3__.Button, Object.assign({ type: "button", variant: "plain", onClick: onClose, "aria-label": closeBtnAriaLabel || `Close ${children}` }, (isClickableDisabled && { isDisabled: true }), closeBtnProps),
    ...
    const closeButton = react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].labelActions) }, closeBtn || defaultCloseButton);
    ...
    const content = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        icon && react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].labelIcon) }, icon),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", Object.assign({ ref: textRef, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].labelText) }, (textMaxWidth && {
            style: {
                [_patternfly_react_tokens_dist_esm_c_label_text_MaxWidth__WEBPACK_IMPORTED_MODULE_7__["default"].name]: textMaxWidth
            }
        })), children)));
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
    ...
    const labelComponentChildProps = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].labelContent) }, (isTooltipVisible && { tabIndex: 0 })), (href && { href })), (href && isDisabled && { onClick: (event) => event.preventDefault() })), (isButton && clickableLabelProps)), (isEditable && Object.assign({ ref: editableButtonRef, onClick: (e) => {
            setIsEditableActive(true);
            e.stopPropagation();
    ...
    if (render) {
        labelComponentChild = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            isTooltipVisible && react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Tooltip__WEBPACK_IMPORTED_MODULE_8__.Tooltip, { triggerRef: componentRef, content: children, position: tooltipPosition }),
            render({
                className: _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].labelContent,
                content,
                componentRef
            })));
    }
    else if (isTooltipVisible) {
        labelComponentChild = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Tooltip__WEBPACK_IMPORTED_MODULE_8__.Tooltip, { content: children, position: tooltipPosition }, labelComponentChild));
    }
    const LabelComponent = (isOverflowLabel ? 'button' : 'span');
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(LabelComponent, Object.assign({}, props, { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].label, isClickableDisabled && _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.disabled, colorStyles[color], variant === 'outline' && _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.outline, isOverflowLabel && _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.overflow, isCompact && _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.compact, isEditable && _patternfly_react_styles_css_components_Label_label_group_mjs__WEBPACK_IMPORTED_MODULE_9__["default"].modifiers.editable, isEditableActive && _patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].modifiers.editableActive, className), onClick: isOverflowLabel ? onLabelClick : undefined }, (LabelComponent === 'button' && { type: 'button' })),
        !isEditableActive && labelComponentChild,
        !isEditableActive && onClose && closeButton,
        isEditableActive && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_5__.css)(_patternfly_react_styles_css_components_Label_label_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].labelContent), type: "text", id: "editable-input", ref: editableInputRef, value: currValue, onChange: updateVal }, editableProps)))));
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   c_label__text_MaxWidth: () => (/* binding */ c_label__text_MaxWidth),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (c_label__text_MaxWidth);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _label_group_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./label-group.css */ "?3272");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _label_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./label.css */ "?02e8");

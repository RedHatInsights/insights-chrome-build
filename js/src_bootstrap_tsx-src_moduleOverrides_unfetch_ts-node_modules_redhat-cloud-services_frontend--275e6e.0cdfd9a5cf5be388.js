...
const AllServicesGroup = ({ title, links }) => {
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Text, { component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.TextVariants.p, className: "subtitle" }, title),
...
/* harmony import */ var _redhat_cloud_services_chrome_useFavoritePages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @redhat-cloud-services/chrome/useFavoritePages */ "./node_modules/@redhat-cloud-services/chrome/esm/useFavoritePages/useFavoritePages.js");
/* harmony import */ var _patternfly_react_icons_dist_js_icons_star_half_alt_icon__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/star-half-alt-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/star-half-alt-icon.js");
/* harmony import */ var _patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/star-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/star-icon.js");
...
const AllServicesLink = ({ href, title, isExternal }) => {
    const { favoritePage, unfavoritePage, favoritePages } = (0,_redhat_cloud_services_chrome_useFavoritePages__WEBPACK_IMPORTED_MODULE_4__["default"])();
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { className: "chr-c-allservices__link-wrapper", component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.TextVariants.p },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ChromeLink__WEBPACK_IMPORTED_MODULE_3__["default"], { isExternal: isExternal, href: href },
            title,
            isExternal && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_external_link_alt_icon__WEBPACK_IMPORTED_MODULE_5__["default"], null)),
        !isExternal && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { onClick: () => handleFavouriteToggle(href, isFavorite), variant: "plain", "aria-label": `${isFavorite ? 'Unfavorite' : 'Favorite'} ${title}`, className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('pf-u-ml-sm', 'pf-u-p-0', 'chr-c-allservices__favourite', {
                    'chr-c-allservices__favourite_not': !isFavorite,
                }) }, isFavorite ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_icon__WEBPACK_IMPORTED_MODULE_6__["default"], { color: "var(--pf-global--palette--gold-200)" }) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_star_half_alt_icon__WEBPACK_IMPORTED_MODULE_7__["default"], { color: "var(--pf-global--palette--gold-200)" }))))));
};
...
const AllServicesSection = ({ icon, title, description, links }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Card, { isPlain: true },
        ...
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.CardBody, null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.TextContent, null,
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.Text, { component: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_0__.TextVariants.p }, description),
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?88de");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _redhat_cloud_services_chrome_useLastVisited__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @redhat-cloud-services/chrome/useLastVisited */ "./node_modules/@redhat-cloud-services/chrome/esm/useLastVisited/useLastVisited.js");
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @patternfly/react-core */ "webpack/sharing/consume/default/@patternfly/react-core/@patternfly/react-core");
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__);
...
const FeedbackModal = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ user }) => {
    ...
    const lastVisited = (0,_redhat_cloud_services_chrome_useLastVisited__WEBPACK_IMPORTED_MODULE_11__["default"])();
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Card, { isSelectableRaised: true, isCompact: true, onClick: () => {
                            ...
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.CardTitle, { className: "chr-c-feedback-card-title" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, null,
                                    ...
                                    " ",
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons__WEBPACK_IMPORTED_MODULE_12__.ExternalLinkAltIcon, null))),
            ...
            case 'reportBugOne':
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FeedbackForm__WEBPACK_IMPORTED_MODULE_4__["default"], { user: user, onCloseModal: handleCloseModal, onSubmit: () => setModalPage('bugReportSuccess'), onClickBack: () => setModalPage('feedbackHome'), handleFeedbackError: () => setModalPage('feedbackError'), modalTitle: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__["default"].reportABug), modalDescription: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, null,
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, { component: "a", href: "https://access.redhat.com/support/cases/#/case/new/open-case?caseCreate=true", target: "_blank" },
                            intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__["default"].openSupportCase),
                            " ",
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons__WEBPACK_IMPORTED_MODULE_12__.ExternalLinkAltIcon, null))), feedbackType: "Bug", checkboxDescription: `${intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__["default"].learnAboutResearchOpportunities)} ${intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__["default"].weNeverSharePersonalInformation)}`, submitTitle: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__["default"].submitFeedback) }));
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Button, { ouiaId: "feedback-button", className: "chr-c-button-feedback", onClick: () => {
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons__WEBPACK_IMPORTED_MODULE_13__.OutlinedCommentsIcon, null),
...
/* harmony import */ var _redhat_cloud_services_chrome_ChromeProvider__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @redhat-cloud-services/chrome/ChromeProvider */ "./node_modules/@redhat-cloud-services/chrome/esm/ChromeProvider/ChromeProvider.js");
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_analytics_SegmentProvider__WEBPACK_IMPORTED_MODULE_13__["default"], { activeModule: activeModule },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FeatureFlags__WEBPACK_IMPORTED_MODULE_4__.FeatureFlagsProvider, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IDPChecker_IDPChecker__WEBPACK_IMPORTED_MODULE_5__["default"], null,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_redhat_cloud_services_chrome_ChromeProvider__WEBPACK_IMPORTED_MODULE_15__["default"], null,
...
const useAllServices = () => {
    ...
    const linkSections = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
        ...
        const matchedLinks = availableLinks.reduce((acc, item) => {
            const match = linksToMatch.find((link) => (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.matchPath)(item.href, link) || (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.matchPath)(`${item.href}/*`, link));
            if (match) {
        ...
        return _components_AllServices_allServicesLinks__WEBPACK_IMPORTED_MODULE_3__["default"].reduce((acc, curr) => {
            const sectionLinks = curr.links.filter((item) => (0,_components_AllServices_AllServicesSection__WEBPACK_IMPORTED_MODULE_4__.isAllServicesGroup)(item)
...
/* harmony import */ var _components_AllServices_AllServicesSection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/AllServices/AllServicesSection */ "./src/components/AllServices/AllServicesSection.tsx");
...
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/common */ "./src/utils/common.ts");
/* harmony import */ var _hooks_useAllServices__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../hooks/useAllServices */ "./src/hooks/useAllServices.ts");
...
const AllServices = () => {
    const { linkSections, error, ready } = (0,_hooks_useAllServices__WEBPACK_IMPORTED_MODULE_8__["default"])();
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        (0,_utils_common__WEBPACK_IMPORTED_MODULE_7__.updateDocumentTitle)('All services');
    }, []);
    if (!ready) {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants.light, className: "pf-m-fill" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Stack, { className: "chr-l-stack-allservices pf-u-background-color-100" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.StackItem, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Gallery, { hasGutter: true }, linkSections.map((section, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_AllServices_AllServicesSection__WEBPACK_IMPORTED_MODULE_5__["default"], { key: index, ...section }))))))),

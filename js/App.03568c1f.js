...
},{"react":"ccIB"}],"fjhx":[function(require,module,exports) {
module.exports = "/insightsbeta/static/chrome/js/logo.59f3ab68.svg";
...
exports.default = _default;
},{"react":"ccIB","./logo.svg":"fjhx"}],"i1dc":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"react":"ccIB","@patternfly/react-core/dist/esm/components/Dropdown":"7GBR","prop-types":"3/B0"}],"ocEB":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  _createClass(InsightsAbout, [{
    ...
    value: function componentDidMount() {
      ...
      this.state.appDetails.apps.forEach(function (app) {
        fetch(app.path).then(function (response) {
          ...
          return updateAppVersion(appDetails, app, data.travis.build_number);
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactCore.AboutModal, {
      ...
      }, _react.default.createElement("p", null, "Please include these details when opening a support case against Insights"), _react.default.createElement(_reactCore.TextContent, null, _react.default.createElement(_reactCore.TextList, {
        component: "dl"
        ...
        return _this2.getItem(app.name + ' Version', app.version);
      }))));
    }
  }]);
...
exports.default = _default;
},{"react":"ccIB","@patternfly/react-core":"Tk4w","./logo.svg":"fjhx","react-redux":"IZTr"}],"uZ0D":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Tools, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "pf-u-sr-only pf-u-visible-on-lg"
      }, _react.default.createElement(_UserToggle.default, null))), _react.default.createElement(_InsightsAbout.default, {
...
var _default = Tools;
exports.default = _default;
},{"react":"ccIB","@patternfly/react-core/dist/esm/components/Button":"CjT+","@patternfly/react-core/dist/esm/layouts/Toolbar":"f7TI","@patternfly/react-core/dist/esm/components/Dropdown":"7GBR","@patternfly/react-icons/dist/esm/icons/question-circle-icon":"wdXW","@patternfly/react-icons/dist/esm/icons/cog-icon":"EIB9","./UserToggle":"ZPuf","./ToolbarToggle":"i78E","./InsightsAbout":"ocEB"}],"1PeJ":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/insightsbeta/static/chrome/js/App.81cee860.map
...
},{"./setPrototypeOf":"+Omx"}],"ZPuf":[function(require,module,exports) {
"use strict";
...
function buildItems(username, isOrgAdmin) {
  ...
  }, "My profile"), _react.default.createElement(_react.default.Fragment, {
...
},{}],"i78E":[function(require,module,exports) {
"use strict";
  ...
  (0, _createClass2.default)(Navigation, [{
    ...
    value: function onClick(_event, item, parent) {
      ...
      if (parent && parent.active) {
        ...
        if (!item.reload) {
          isMetaKey ? window.open("".concat(basepath).concat(activeLocation, "/").concat(item.reload)) : onNavigate && onNavigate(item);
        } else {
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Footer":"rwWu","./Header/index":"1PeJ","./Sidenav/index":"nuDN"}],"4IsA":[function(require,module,exports) {
var bundleURL = null;
...
//# sourceMappingURL=/apps/chrome/js/App.1dddfb27.js.map
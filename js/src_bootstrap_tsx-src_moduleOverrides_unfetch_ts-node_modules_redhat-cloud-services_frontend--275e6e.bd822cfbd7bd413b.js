...
const SegmentProvider = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ activeModule, children }) => {
...
/* harmony import */ var _Navigation_Loader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Navigation/Loader */ "./src/components/Navigation/Loader.tsx");
...
/* harmony import */ var _utils_historyListener__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../utils/historyListener */ "./src/utils/historyListener.ts");
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../utils/common */ "./src/utils/common.ts");
...
/* harmony import */ var _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../utils/isAnsibleTrialFlagActive */ "./src/utils/isAnsibleTrialFlagActive.ts");
...
const loaderWrapper = (Component, props = {}) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Navigation_Loader__WEBPACK_IMPORTED_MODULE_8__["default"], null) },
...
const ScalprumRoot = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ config, helpTopicsAPI, quickstartsAPI, ...props }) => {
    ...
    const { analytics } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_analytics_SegmentContext__WEBPACK_IMPORTED_MODULE_13__["default"]);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const unregister = _utils_chromeHistory__WEBPACK_IMPORTED_MODULE_6__["default"].listen(_utils_historyListener__WEBPACK_IMPORTED_MODULE_11__["default"]);
        return () => {
    ...
    const scalprumProviderProps = {
        ...
        api: {
            chrome: {
                ...
                isFedramp: (0,_utils_common__WEBPACK_IMPORTED_MODULE_12__.isFedRamp)(),
                usePendoFeedback: _Feedback__WEBPACK_IMPORTED_MODULE_9__.usePendoFeedback,
                segment: {
                    setPageMetadata,
                },
                toggleFeedbackModal: (...args) => dispatch((0,_redux_actions__WEBPACK_IMPORTED_MODULE_10__.toggleFeedbackModal)(...args)),
                ...
                clearAnsibleTrialFlag: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_15__.clearAnsibleTrialFlag,
                isAnsibleTrialFlagActive: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_15__.isAnsibleTrialFlagActive,
                setAnsibleTrialFlag: _utils_isAnsibleTrialFlagActive__WEBPACK_IMPORTED_MODULE_15__.setAnsibleTrialFlag,
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_scalprum_react_core__WEBPACK_IMPORTED_MODULE_1__.ScalprumProvider, { ...scalprumProviderProps },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Routes, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { index: true, path: "/", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_7__["default"], { Sidebar: loaderWrapper(LandingNav), ...props }) }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/connect/products", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, { fallback: _utils_loading_fallback__WEBPACK_IMPORTED_MODULE_14__["default"] },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ProductSelection, null)) }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/connect/*", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_7__["default"], { ...props }) }),
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "*", element: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts_DefaultLayout__WEBPACK_IMPORTED_MODULE_7__["default"], { Sidebar: loaderWrapper(Navigation), ...props }) }))));
}, 
...
/* harmony import */ var _patternfly_react_icons_dist_js_icons_bars_icon__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/bars-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/bars-icon.js");
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! react-intl */ "./node_modules/react-intl/lib/src/components/useIntl.js");
...
const DefaultLayout = ({ hasBanner, selectedAccountNumber, hideNav, isNavOpen, setIsNavOpen, Sidebar }) => {
    const intl = (0,react_intl__WEBPACK_IMPORTED_MODULE_18__["default"])();
    const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useDispatch)();
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.Page, { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ 'chr-c-page__hasBanner': hasBanner, 'chr-c-page__account-banner': selectedAccountNumber }), onPageResize: null, header: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.Masthead, { className: "chr-c-masthead" },
            !hideNav && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.MastheadToggle, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.PageToggleButton, { variant: "plain", "aria-label": "Global navigation", isNavOpen: isNavOpen, onNavToggle: () => {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_icons_dist_js_icons_bars_icon__WEBPACK_IMPORTED_MODULE_19__["default"], null)))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Header_Header__WEBPACK_IMPORTED_MODULE_6__.Header, null)), sidebar: hideNav ? undefined : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_5__.PageSidebar, { isNavOpen: isNavOpen, id: "chr-c-sidebar", nav: Sidebar }) },

...
/* harmony import */ var _ChromeContext__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ChromeContext */ "./node_modules/@redhat-cloud-services/chrome/esm/ChromeContext/ChromeContext.js");
/* harmony import */ var _chromeState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chromeState */ "./node_modules/@redhat-cloud-services/chrome/esm/ChromeProvider/chromeState.js");
/* harmony import */ var _utils_fetch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/fetch */ "./node_modules/@redhat-cloud-services/chrome/esm/utils/fetch.js");
...
var getUserIdentity = function () { return (0,_utils_fetch__WEBPACK_IMPORTED_MODULE_3__.get)(_utils_fetch__WEBPACK_IMPORTED_MODULE_3__.IDENTITY_URL); };
var useLastPageVisitedUploader = function (providerState, bundle) {
    if (bundle === void 0) { bundle = ''; }
    var pathname = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.useLocation)().pathname;
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        (0,_utils_fetch__WEBPACK_IMPORTED_MODULE_3__.post)(_utils_fetch__WEBPACK_IMPORTED_MODULE_3__.LAST_VISITED_URL, {
            pathname: pathname,
            title: document.title,
            bundle: bundle,
        })
            .then(function (data) { return providerState.setLastVisited(data); })
            .catch(function (error) { return console.error('Unable to update last visited pages!', error); });
    }, [pathname]);
};
var ChromeProvider = function (_a) {
    ...
    if (!providerState.current) {
        providerState.current = (0,_chromeState__WEBPACK_IMPORTED_MODULE_4__["default"])();
    }
    ...
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_ChromeContext__WEBPACK_IMPORTED_MODULE_5__["default"].Provider, __assign({ value: providerState.current }, { children: children }));
};

...
.ins-c-conditional-filter input {
  outline: none;
}
...
.chr-c-search__input .pf-c-input-group {
...
@media (min-width: 768px) {
  ...
  .chr-c-panel-services-nav .pf-c-sidebar__content {
    height: 80vh;
    overflow: auto;
  }
  ...
  .chr-c-panel-services-nav .pf-c-sidebar__panel .chr-l-flex__item-tabs {
    overflow: auto;
    padding-bottom: var(--pf-global--spacer--2xl);
  }
  .chr-c-panel-services-nav .pf-c-sidebar__panel .pf-c-tabs {
  ...
  .chr-c-panel-services-nav .pf-c-sidebar__panel .pf-c-tabs .pf-c-tabs__item:hover button, .chr-c-panel-services-nav .pf-c-sidebar__panel .pf-c-tabs .pf-c-tabs__item:focus button {
    color: var(--pf-global--primary-color--200);
  }
  .chr-c-panel-services-nav .pf-c-sidebar__panel .pf-c-tabs .pf-c-tabs__item.pf-m-current {
    --pf-c-tabs__link--BackgroundColor: var(--pf-global--BackgroundColor--100);
  }
  .chr-c-panel-services-nav .pf-c-sidebar .pf-c-card {

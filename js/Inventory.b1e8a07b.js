            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        _react2.default.createElement(_Pagination2.default, { totalItems: items && items.length })
                    )
                )
            );
        }
...
function getEntities(items, _ref3) {
    ...
    return insights.chrome.auth.getUser().then(function () {
        return fetch('' + base + (items.length !== 0 ? '/' + items : '') + query, { credentials: 'include' }).then(function (r) {
            if (r.ok) {
...
//# sourceMappingURL=/insightsbeta/static/chrome/js/Inventory.b1e8a07b.map
"use strict";
(self["webpackChunkinsights_chrome"] = self["webpackChunkinsights_chrome"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_components_Modal_Modal_js"],{
...
/* harmony import */ var _patternfly_react_styles_css_components_Backdrop_backdrop_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Backdrop/backdrop.mjs */ "./node_modules/@patternfly/react-styles/css/components/Backdrop/backdrop.mjs");
...
const Backdrop = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({}, props, { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_Backdrop_backdrop_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].backdrop, className) }), children));
};
...
/* harmony import */ var _patternfly_react_styles_css_components_Backdrop_backdrop_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @patternfly/react-styles/css/components/Backdrop/backdrop.mjs */ "./node_modules/@patternfly/react-styles/css/components/Backdrop/backdrop.mjs");
...
class Modal extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor(props) {
        ...
        this.handleEscKeyClick = (event) => {
            ...
            if (event.key === _helpers__WEBPACK_IMPORTED_MODULE_2__.KeyTypes.Escape && this.props.isOpen) {
    ...
    componentDidMount() {
        ...
        if (this.props.isOpen) {
            target.classList.add((0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_4__.css)(_patternfly_react_styles_css_components_Backdrop_backdrop_mjs__WEBPACK_IMPORTED_MODULE_5__["default"].backdropOpen));
        }
        else {
            target.classList.remove((0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_4__.css)(_patternfly_react_styles_css_components_Backdrop_backdrop_mjs__WEBPACK_IMPORTED_MODULE_5__["default"].backdropOpen));
        }
    ...
    render() {
        ...
        appendTo, 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        onEscapePress, 'aria-labelledby': ariaLabelledby, 'aria-label': ariaLabel, 'aria-describedby': ariaDescribedby, bodyAriaLabel, bodyAriaRole, title, titleIconVariant, titleLabel, ouiaId, ouiaSafe, position, elementToFocus } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__rest)(_a, ["appendTo", "onEscapePress", 'aria-labelledby', 'aria-label', 'aria-describedby', "bodyAriaLabel", "bodyAriaRole", "title", "titleIconVariant", "titleLabel", "ouiaId", "ouiaSafe", "position", "elementToFocus"]);
...
/* harmony import */ var _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-styles/css/components/ModalBox/modal-box.mjs */ "./node_modules/@patternfly/react-styles/css/components/ModalBox/modal-box.mjs");
...
const ModalBox = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({}, props, { role: "dialog", "aria-label": ariaLabel || null, "aria-labelledby": ariaLabelledby || null, "aria-describedby": ariaDescribedby, "aria-modal": "true", className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_3__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].modalBox, className, position === 'top' && _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].modifiers.alignTop, variant === 'large' && _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].modifiers.lg, variant === 'small' && _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].modifiers.sm, variant === 'medium' && _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_4__["default"].modifiers.md), style: style }), children));
};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @patternfly/react-styles */ "./node_modules/@patternfly/react-styles/dist/esm/index.js");
/* harmony import */ var _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @patternfly/react-styles/css/components/ModalBox/modal-box.mjs */ "./node_modules/@patternfly/react-styles/css/components/ModalBox/modal-box.mjs");
...
const ModalBoxBody = (_a) => {
    var { children = null, className = '' } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["children", "className"]);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({}, props, { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modalBoxBody, className) }), children));
};
...
const ModalBoxCloseButton = (_a) => {
    var { className, onClose = () => undefined, 'aria-label': ariaLabel = 'Close', ouiaId } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["className", "onClose", 'aria-label', "ouiaId"]);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modalBoxClose, className) },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Button__WEBPACK_IMPORTED_MODULE_4__.Button, Object.assign({ variant: "plain", onClick: (event) => onClose(event), "aria-label": ariaLabel }, (ouiaId && { ouiaId: `${ouiaId}-${ModalBoxCloseButton.displayName}` }), props),
...
const ModalBoxDescription = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", Object.assign({}, props, { id: id, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modalBoxDescription, className) }), children));
};
...
const ModalBoxFooter = (_a) => {
    var { children = null, className = '' } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["children", "className"]);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("footer", Object.assign({}, props, { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modalBoxFooter, className) }), children));
};
...
const ModalBoxHeader = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("header", Object.assign({ className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modalBoxHeader, help && _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modifiers.help, className) }, props),
        help && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_2__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modalBoxHeaderMain) }, children),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: `${_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_3__["default"].modalBoxHeader}-help` }, help))),
        !help && children));
};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react/react?1a75");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @patternfly/react-styles/css/components/ModalBox/modal-box.mjs */ "./node_modules/@patternfly/react-styles/css/components/ModalBox/modal-box.mjs");
...
const ModalBoxTitle = (_a) => {
    ...
    const [hasTooltip, setHasTooltip] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false);
    const h1 = react__WEBPACK_IMPORTED_MODULE_0__.useRef(null);
    ...
    const variantIcons = {
        ...
        custom: react__WEBPACK_IMPORTED_MODULE_0__.createElement(_patternfly_react_icons_dist_esm_icons_bell_icon__WEBPACK_IMPORTED_MODULE_7__["default"], null)
    };
    ...
    const content = (react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", Object.assign({ id: id, ref: h1, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_9__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_10__["default"].modalBoxTitle, titleIconVariant && _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_10__["default"].modifiers.icon, className) }, props),
        titleIconVariant && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_9__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_10__["default"].modalBoxTitleIcon) }, isVariantIcon(titleIconVariant) ? variantIcons[titleIconVariant] : react__WEBPACK_IMPORTED_MODULE_0__.createElement(CustomIcon, null))),
        label && react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "pf-v5-screen-reader" }, label),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_9__.css)(_patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_10__["default"].modalBoxTitleText) }, title)));
    return hasTooltip ? react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Tooltip__WEBPACK_IMPORTED_MODULE_11__.Tooltip, { content: title }, content) : content;
};
...
/* harmony import */ var _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @patternfly/react-styles/css/components/ModalBox/modal-box.mjs */ "./node_modules/@patternfly/react-styles/css/components/ModalBox/modal-box.mjs");
/* harmony import */ var _patternfly_react_styles_css_layouts_Bullseye_bullseye_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @patternfly/react-styles/css/layouts/Bullseye/bullseye.mjs */ "./node_modules/@patternfly/react-styles/css/layouts/Bullseye/bullseye.mjs");
...
const ModalContent = (_a) => {
    var { children, className = '', isOpen = false, header = null, help = null, description = null, title = '', titleIconVariant = null, titleLabel = '', 'aria-label': ariaLabel = '', 'aria-describedby': ariaDescribedby, 'aria-labelledby': ariaLabelledby, bodyAriaLabel, bodyAriaRole, showClose = true, footer = null, actions = [], onClose = () => undefined, variant = 'default', position, positionOffset, width, maxWidth, boxId, labelId, descriptorId, disableFocusTrap = false, hasNoBodyWrapper = false, ouiaId, ouiaSafe = true, elementToFocus } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["children", "className", "isOpen", "header", "help", "description", "title", "titleIconVariant", "titleLabel", 'aria-label', 'aria-describedby', 'aria-labelledby', "bodyAriaLabel", "bodyAriaRole", "showClose", "footer", "actions", "onClose", "variant", "position", "positionOffset", "width", "maxWidth", "boxId", "labelId", "descriptorId", "disableFocusTrap", "hasNoBodyWrapper", "ouiaId", "ouiaSafe", "elementToFocus"]);
    if (!isOpen) {
        return null;
    }
    ...
    const modalBody = hasNoBodyWrapper ? (children) : (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ModalBoxBody__WEBPACK_IMPORTED_MODULE_6__.ModalBoxBody, Object.assign({ "aria-label": bodyAriaLabel, role: bodyAriaRole || defaultModalBodyAriaRole }, props, { id: id }), children));
    ...
    const modalBox = (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ModalBox__WEBPACK_IMPORTED_MODULE_7__.ModalBox, Object.assign({ id: boxId, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_8__.css)(className, (0,_ModalBoxTitle__WEBPACK_IMPORTED_MODULE_3__.isVariantIcon)(titleIconVariant) && _patternfly_react_styles_css_components_ModalBox_modal_box_mjs__WEBPACK_IMPORTED_MODULE_9__["default"].modifiers[titleIconVariant]), variant: variant, position: position, positionOffset: positionOffset, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledbyFormatted(), "aria-describedby": ariaDescribedby || (hasNoBodyWrapper ? null : descriptorId) }, (0,_helpers__WEBPACK_IMPORTED_MODULE_10__.getOUIAProps)(ModalContent.displayName, ouiaId, ouiaSafe), { style: Object.assign(Object.assign({}, (width && { '--pf-v5-c-modal-box--Width': typeof width !== 'number' ? width : `${width}px` })), (maxWidth && {
            '--pf-v5-c-modal-box--MaxWidth': typeof maxWidth !== 'number' ? maxWidth : `${maxWidth}px`
        })) }),
        showClose && react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ModalBoxCloseButton__WEBPACK_IMPORTED_MODULE_11__.ModalBoxCloseButton, { onClose: (event) => onClose(event), ouiaId: ouiaId }),
        modalBoxHeader,
        modalBody,
        modalBoxFooter));
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Backdrop_Backdrop__WEBPACK_IMPORTED_MODULE_12__.Backdrop, null,
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_helpers__WEBPACK_IMPORTED_MODULE_13__.FocusTrap, { active: !disableFocusTrap, focusTrapOptions: {
                clickOutsideDeactivates: true,
                tabbableOptions: { displayCheck: 'none' },
                // FocusTrap's initialFocus can accept false as a value to prevent initial focus.
                // We want to prevent this in case false is ever passed in.
                initialFocus: elementToFocus || undefined
            }, className: (0,_patternfly_react_styles__WEBPACK_IMPORTED_MODULE_8__.css)(_patternfly_react_styles_css_layouts_Bullseye_bullseye_mjs__WEBPACK_IMPORTED_MODULE_14__["default"].bullseye) }, modalBox)));
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _backdrop_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./backdrop.css */ "?8afc");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _modal_box_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modal-box.css */ "?806e");

...
var DefaultErrorComponent = function () {
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Error while loading component!");
};
...
var DefaultErrorComponent = function () { return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Error while loading component!"); };
var LoadModule = function (_a) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        if (!cachedModule) {
            if (scriptLocation) {
                (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.injectScript)(appName, scriptLocation)
                    .then(function () {
                    isMounted.current && setComponent(function () { return react__WEBPACK_IMPORTED_MODULE_0___default().lazy((0,_async_loader__WEBPACK_IMPORTED_MODULE_3__.loadComponent)(scope, module, ErrorComponent)); });
                })
                    .catch(function () {
                ...
                (0,_scalprum_core__WEBPACK_IMPORTED_MODULE_1__.processManifest)(manifestLocation, appName, scope, processor)
                    .then(function () {
                    isMounted.current && setComponent(function () { return react__WEBPACK_IMPORTED_MODULE_0___default().lazy((0,_async_loader__WEBPACK_IMPORTED_MODULE_3__.loadComponent)(scope, module, ErrorComponent)); });
                })
                    .catch(function () {
...
var BaseScalprumComponent = (function (_super) {
    ...
    BaseScalprumComponent.prototype.render = function () {
        var _a = this.props, _b = _a.ErrorComponent, ErrorComponent = _b === void 0 ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(DefaultErrorComponent, null) : _b, props = __rest(_a, ["ErrorComponent"]);
        if (this.state.repairAttempt && !this.selfRepairAttempt) {
            this.selfRepairAttempt = true;
            return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(LoadModule, __assign({}, props, { skipCache: true, ErrorComponent: function () { return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, ErrorComponent); } }));
        }
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(LoadModule, __assign({}, props, { ErrorComponent: function () { return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, ErrorComponent); } }));
    };
    BaseScalprumComponent.defaultProps = {
        ErrorComponent: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(DefaultErrorComponent, null),
    };

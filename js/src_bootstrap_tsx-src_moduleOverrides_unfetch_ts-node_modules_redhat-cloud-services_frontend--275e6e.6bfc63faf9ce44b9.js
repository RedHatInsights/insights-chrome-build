...
const SegmentProvider = ({ activeModule, children }) => {
    ...
    if (!analytics.current) {
        analytics.current = analytics.current = _segment_analytics_next__WEBPACK_IMPORTED_MODULE_5__.AnalyticsBrowser.load({ writeKey: getAPIKey(DEV_ENV ? 'dev' : 'prod', activeModule, moduleAPIKey) }, { initialPageview: false, integrations: { All: !fedRampEnv } });
    }
...
async function getAllWorkloads({ activeTags, registeredWith } = {}, pagination = {}) {
    ...
    const [SAP, AAP, MSSQL] = await Promise.all([
        ...
        system.apiHostGetHostList(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, ['fresh', 'stale'], selectedTags, registeredWith ? [registeredWith] : undefined, undefined, undefined, {
...
function logout(bounce) {
    ...
    (0,_utils_common__WEBPACK_IMPORTED_MODULE_3__.deleteLocalStorageItems)(keys);
    // Redirect to logout
    if (bounce) {

...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@patternfly/react-icons"), require("@patternfly/react-core"), require("classnames"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define("InsightsComponentsRegistery-components/Remediations", ["@patternfly/react-icons", "@patternfly/react-core", "classnames", "react"], factory);
	else if(typeof exports === 'object')
		exports["InsightsComponentsRegistery-components/Remediations"] = factory(require("@patternfly/react-icons"), require("@patternfly/react-core"), require("classnames"), require("react"));
	else
		root["InsightsComponentsRegistery-components/Remediations"] = factory(root["PFReactIcons"], root["PFReactCore"], root["classnames"], root["React"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__patternfly_react_icons__, __WEBPACK_EXTERNAL_MODULE__patternfly_react_core__, __WEBPACK_EXTERNAL_MODULE_classnames__, __WEBPACK_EXTERNAL_MODULE_react__) {
    ...
    (0, _createClass3.default)(Wizard, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                props = (0, _objectWithoutProperties3.default)(_props, ['isLarge', 'title', 'className', 'isOpen']);
            ...
            this.state.currentStep < this.props.content.length - 1 ? _react2.default.createElement(
                _reactCore.Button,
                { key: 'Next', action: 'next', variant: 'primary', onClick: this.handleNextModalStep },
                ' Next '
            ) : _react2.default.createElement(
                _reactCore.Button,
                { key: 'confirm', action: 'confirm', variant: 'primary', onClick: function onClick() {
...
var mountedInstance = false; /*global RELEASE:true*/
...
function createNotification(id, name, isNewSwitch) {
    ...
    var isBeta = window.location.pathname.includes('insightsbeta');
    var url = '/insights' + (isBeta ? 'beta' : '') + '/platform/remediations/' + encodeURIComponent(id);
...
var RemediationWizard = function (_Component) {
    ...
    function RemediationWizard(props) {
        ...
        _this.createRemediation = function (add, resolver) {
            var name = _this.state.name || 'Unnamed remediation';
        ...
        _this.buildSteps = function () {
            ...
            if (!_this.resolutionsLoaded() || !_this.selectedRemediationLoaded()) {
                steps.push(_react2.default.createElement(_LoadingStep2.default, { key: 'LoadingStep' }));
                return steps;
            }

            // no valid resolutions
            if (_this.state.errors.length) {
                steps.push(_react2.default.createElement(_ErrorStep2.default, { key: 'ErrorStep', errors: _this.state.errors }));
                return steps;
            }
...
function openWizard(data, basePath) {
    ...
    data.issues.forEach(function (issue) {
        return issue.description = issue.description || issue.id;
    });
...
function ExistingOrNewStep(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'h1',
            { className: 'ins-m-text__bold' },
            'Do you want to modify an existing Remediation or create a new one?'
        ),
        _react2.default.createElement(
            _reactCore.Form,
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    !existingRemediations && _react2.default.createElement(_reactCore.SelectOption, { key: 'loading', value: 'loading', label: 'Loading\u2026' }),
                    existingRemediations && !existingRemediations.length && _react2.default.createElement(_reactCore.SelectOption, { key: 'empty', value: 'empty', label: 'No exising Remediations' }),
                    existingRemediations && existingRemediations.map(function (_ref) {
                        var id = _ref.id,
                            name = _ref.name;
                        return _react2.default.createElement(_reactCore.SelectOption, { key: id, value: id, label: name });
                    })
                )
            ),
            _react2.default.createElement(_reactCore.Radio, {
                            ...
                            label: _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        _reactCore.StackItem,
                                        null,
                                        _react2.default.createElement(_Battery.Battery, { label: 'Risk of Change', severity: resolution.resolution_risk })
                                    ),
...
function buildRows(issues, state, getResolution) {
    return issues.map(function (issue) {
        ...
        return {
            cells: [state.issuesById[issue.id].description, issueType(issue.id), resolution.description, resolution.needs_reboot ? 'true' : 'false', getSystemCount(issue, state)]
        };
    });
}
...
function IssueTable(props) {
    var rows = buildRows(props.issues, props.state, props.getResolution);
...
function LoadingStep(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactIcons.SyncAltIcon, null)
    );
}
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                ' ',
                actions(issueCount),
                ' to be added to your remediation.\xA0',
                tweakableCount,
                ' out of ',
                issueCount,
                ' ',
...
},{"@patternfly/react-icons":"k73M","@patternfly/react-core":"Tk4w","classnames":"kpqe","react":"ccIB","process":"rH1J"}]},{},[], null)
//# sourceMappingURL=/insightsbeta/static/chrome/js/Remediations.02d6b02a.map
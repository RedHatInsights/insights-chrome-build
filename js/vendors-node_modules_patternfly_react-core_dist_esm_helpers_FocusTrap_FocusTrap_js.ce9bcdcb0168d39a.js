"use strict";
(self["webpackChunkinsights_chrome"] = self["webpackChunkinsights_chrome"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_helpers_FocusTrap_FocusTrap_js"],{
...
/* harmony import */ var _useUnmountEffect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../useUnmountEffect */ "./node_modules/@patternfly/react-core/dist/esm/helpers/useUnmountEffect.js");




const FocusTrap = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function FocusTrap(_a, forwardedRef) {
    var { active = true, paused = false, focusTrapOptions = {}, preventScrollOnDeactivate = false } = _a, props = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["active", "paused", "focusTrapOptions", "preventScrollOnDeactivate"]);
    // Fall back to internal ref if no forwarded ref is provided.
    const ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useImperativeHandle)(forwardedRef, () => ref.current);
    // Create focus trap instance after rendering DOM.
    const focusTrapRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const focusTrap = (0,focus_trap__WEBPACK_IMPORTED_MODULE_2__.createFocusTrap)(ref.current, Object.assign(Object.assign({}, focusTrapOptions), { returnFocusOnDeactivate: false }));
    ...
    const previousElementRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(typeof document !== 'undefined' ? document.activeElement : null);
    // Restore focus to the previously active element on unmount.
    (0,_useUnmountEffect__WEBPACK_IMPORTED_MODULE_3__.useUnmountEffect)(() => {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", Object.assign({ ref: ref }, props));
});
...
function useUnmountEffect(effect) {
    ...
    const effectRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(effect);

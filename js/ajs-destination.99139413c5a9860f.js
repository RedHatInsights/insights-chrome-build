...
/* harmony import */ var _core_context__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../core/context */ "./node_modules/@segment/analytics-core/dist/esm/context/index.js");
/* harmony import */ var _core_environment__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../core/environment */ "./node_modules/@segment/analytics-next/dist/pkg/core/environment/index.js");
...
/* harmony import */ var _lib_is_plan_event_enabled__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../lib/is-plan-event-enabled */ "./node_modules/@segment/analytics-next/dist/pkg/lib/is-plan-event-enabled.js");
...
/* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../middleware */ "./node_modules/@segment/analytics-next/dist/pkg/plugins/middleware/index.js");
...
/* harmony import */ var _segment_analytics_core__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @segment/analytics-core */ "./node_modules/@segment/analytics-core/dist/esm/validation/helpers.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./utils */ "./node_modules/@segment/analytics-next/dist/pkg/plugins/ajs-destination/utils.js");
/* harmony import */ var _core_stats_metric_helpers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../core/stats/metric-helpers */ "./node_modules/@segment/analytics-next/dist/pkg/core/stats/metric-helpers.js");
            ...
            return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__generator)(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        try {
                            (0,_core_stats_metric_helpers__WEBPACK_IMPORTED_MODULE_9__.recordIntegrationMetric)(ctx, {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (plan && ev && this.name !== 'Segment.io') {
                            planEvent = plan[ev];
                            if (!(0,_lib_is_plan_event_enabled__WEBPACK_IMPORTED_MODULE_10__.isPlanEventEnabled)(plan, planEvent)) {
                                ...
                                ctx.cancel(new _core_context__WEBPACK_IMPORTED_MODULE_11__.ContextCancelation({
                                    retry: false,
                        ...
                        return [4 /*yield*/, (0,_middleware__WEBPACK_IMPORTED_MODULE_12__.applyDestinationMiddleware)(this.name, ctx.event, this.middleware)];
                    case 1:
...
function ajsDestinations(writeKey, settings, globalIntegrations, options, routingMiddleware, legacyIntegrationSources) {
    ...
    if ((0,_core_environment__WEBPACK_IMPORTED_MODULE_13__.isServer)()) {
        return [];
    }
    if (settings.plan) {
    ...
    var installableIntegrations = new Set((0,tslib__WEBPACK_IMPORTED_MODULE_1__.__spreadArray)((0,tslib__WEBPACK_IMPORTED_MODULE_1__.__spreadArray)([], Object.keys(remoteIntegrationsConfig).filter(function (name) {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_15__.isInstallableIntegration)(name, remoteIntegrationsConfig[name]);
    }), true), Object.keys(adhocIntegrationSources || {}).filter(function (name) {
        return (0,_segment_analytics_core__WEBPACK_IMPORTED_MODULE_16__.isPlainObject)(remoteIntegrationsConfig[name]) ||
            (0,_segment_analytics_core__WEBPACK_IMPORTED_MODULE_16__.isPlainObject)(localIntegrationsConfig === null || localIntegrationsConfig === void 0 ? void 0 : localIntegrationsConfig[name]);
    }), true));
    return Array.from(installableIntegrations)
        .filter(function (name) { return !(0,_utils__WEBPACK_IMPORTED_MODULE_15__.isDisabledIntegration)(name, globalIntegrations); })
        .map(function (name) {

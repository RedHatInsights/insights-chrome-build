...
const FeedbackForm = ({ user, onCloseModal, onSubmit, onClickBack, handleFeedbackError, modalTitle, modalDescription, textareaLabel, feedbackType, checkboxDescription, textAreaHidden = false, }) => {
    const intl = (0,react_intl__WEBPACK_IMPORTED_MODULE_5__.default)();
...
const FeedbackModal = ({ user }) => {
    ...
    const ModalDescription = ({ modalPage }) => {
        switch (modalPage) {
            ...
            case 'feedbackOne':
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FeedbackForm__WEBPACK_IMPORTED_MODULE_4__.default, { user: user, onCloseModal: handleCloseModal, onSubmit: () => setModalPage('feedbackSuccess'), onClickBack: () => setModalPage('feedbackHome'), handleFeedbackError: () => setModalPage('feedbackError'), modalTitle: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.shareYourFeedback), textareaLabel: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.enterFeedback), feedbackType: "Feedback", checkboxDescription: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.learnAboutResearchOpportunities) }));
            case 'reportBugOne':
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FeedbackForm__WEBPACK_IMPORTED_MODULE_4__.default, { user: user, onCloseModal: handleCloseModal, onSubmit: () => setModalPage('feedbackSuccess'), onClickBack: () => setModalPage('feedbackHome'), handleFeedbackError: () => setModalPage('feedbackError'), modalTitle: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.reportABug), modalDescription: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, null,
            ...
            case 'informDirection':
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FeedbackForm__WEBPACK_IMPORTED_MODULE_4__.default, { user: user, onCloseModal: handleCloseModal, onSubmit: handleCloseModal, onClickBack: () => setModalPage('feedbackHome'), handleFeedbackError: () => setModalPage('feedbackError'), modalTitle: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.informRedhatDirection), modalDescription: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Text, null,
                        ...
                        intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.directInfluence)), feedbackType: "[Research Opportunities]", textAreaHidden: true, checkboxDescription: intl.formatMessage(_locales_Messages__WEBPACK_IMPORTED_MODULE_7__.default.weNeverSharePersonalInformation) }));
